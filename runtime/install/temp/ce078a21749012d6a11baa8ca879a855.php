<?php /*a:2:{s:47:"F:\ls\v4.1.2\app\install\view\index\step-1.html";i:1614516116;s:39:"F:\ls\v4.1.2\app\install\view\base.html";i:1614516116;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use('form', function () {
		...
		form.on('submit(go)', function (data) {
			...
			if (readpact == 1) {
				window.location.href = '<?php echo htmlentities($root_url); ?>/install.php/index/index?step=2';
			} else {
