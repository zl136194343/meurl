<?php /*a:2:{s:47:"F:\ls\v4.1.2\app\install\view\index\step-3.html";i:1614516116;s:39:"F:\ls\v4.1.2\app\install\view\base.html";i:1614516116;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
    ...
    .install-content-procedure .content-procedure-item:nth-child(3){
        background: url("http://www.ls.com/app/install/view/public/img/conduct.png") no-repeat center / contain;
        color: #fff;
    }
</style>
...
<script language="javascript" type="text/javascript">
    ...
    layui.use('form', function(){
        ...
        function install(data){
            ...
            $.ajax({
                url: "<?php echo htmlentities($root_url); ?>/install.php/index/index?step=4",
                data: data,
                dataType: 'json',
                type: 'post',
    ...
    function testDb()
    {
        ...
        inputBoxPointer('dbpwdsta').innerHTML='<img src="http://www.ls.com/app/install/view/public/img/ajax-loader.gif">';
    ...
    function haveDB()
    {
        ...
        var dbpwd = inputBoxPointer('dbpwd').value;
        var dbport = inputBoxPointer('dbport').value;
        inputBoxPointer('havedbsta').innerHTML='<img src="http://www.ls.com/app/install/view/public/img/ajax-loader.gif">';
