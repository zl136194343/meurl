<?php /*a:2:{s:47:"F:\ls\v4.1.2\app\install\view\index\step-2.html";i:1614516116;s:39:"F:\ls\v4.1.2\app\install\view\base.html";i:1614516116;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="testing-item">
		...
		<table  border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td><img clsss="check-icon" src="<?php if($variables_item['status']): ?>http://www.ls.com/app/install/view/public/img/success.png<?php else: ?>http://www.ls.com/app/install/view/public/img/error.png<?php endif; ?>"/></td>
			</tr>
			<?php endforeach; ?>
		</table>
	</div>
	...
	<div class="testing-item">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
			...
			<tr>
				...
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_readable']): ?>http://www.ls.com/app/install/view/public/img/success.png<?php else: ?>http://www.ls.com/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
				<td>
					<img clsss="check-icon" src="<?php if($dirs_item['is_write']): ?>http://www.ls.com/app/install/view/public/img/success.png<?php else: ?>http://www.ls.com/app/install/view/public/img/error.png<?php endif; ?>"/>
				</td>
			</tr>
			<?php endforeach; ?>
