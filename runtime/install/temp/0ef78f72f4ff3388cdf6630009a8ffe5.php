<?php /*a:2:{s:47:"F:\ls\v4.1.2\app\install\view\index\step-4.html";i:1614516118;s:39:"F:\ls\v4.1.2\app\install\view\base.html";i:1614516116;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta name="renderer" content="webkit" />
	<meta http-equiv="X-UA-COMPATIBLE" content="IE=edge,chrome=1" />
	<title>安装程序 - 多商户</title>
	<!--<script src="http://www.ls.com/app/install/view/public/js/jquery-2.2.js"></script>-->
	<link rel="icon" type="image/x-icon" href="http://www.ls.com/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="http://www.ls.com/app/install/view/public/css/style.css" />
	<link rel="stylesheet" type="text/css" href="http://www.ls.com/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="http://www.ls.com/app/shop/view/public/css/common.css" />
	<script src="http://www.ls.com/public/static/js/jquery-3.1.1.js"></script>
	<script src="http://www.ls.com/public/static/ext/layui/layui.js"></script>

	<script>
		layui.use(['layer', 'upload', 'element'], function() {});
		window.ns_url = {
			baseUrl: "http://www.ls.com/install.php/",
			route: ['install', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
		};
	</script>
	<script src="http://www.ls.com/app/install/view/public/js/common.js"></script>
	
<style>
	.install-content-procedure .content-procedure-item:first-of-type{
		background: url("http://www.ls.com/app/install/view/public/img/complete_two.png") no-repeat center / contain;
		color: #fff;
	}
	.install-content-procedure .content-procedure-item:nth-child(2), .install-content-procedure .content-procedure-item:nth-child(3){
		background: url("http://www.ls.com/app/install/view/public/img/complete_four.png") no-repeat center / contain;
		color: #fff;
	}
	.install-content-procedure .content-procedure-item:nth-child(4){
		background: url("http://www.ls.com/app/install/view/public/img/complete_three.png") no-repeat center / contain;
		color: #fff;
	}
...
<div class="head-block">
	<div class="top">
		...
		<div class="top-sub" style="flex:1;">多商户V4</div>
		<ul class="top-link">
...
<div class="install-success">
	<div class="install-success-box">
		<img class="install-success-pic" src="http://www.ls.com/app/install/view/public/img/install_complete.png" alt="">
		<div class="install-success-text">
			<p class="install-success-title">恭喜您！已成功安装多商户系统。</p>
	...
	<ul class="other-links-list">
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://www.ls.com/app/install/view/public/img/site_backstage.png" alt="">
			</div>
			<a href="<?php echo htmlentities($root_url); ?>/index.php/admin" class="other-links-text" target="_blank">网站后台</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://www.ls.com/app/install/view/public/img/site_index.png" alt="">
			</div>
			<a href="<?php echo htmlentities($root_url); ?>/index.php/shop" class="other-links-text" target="_blank">店铺后台</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://www.ls.com/app/install/view/public/img/official_website.png" alt="">
			</div>
			<a href="https://www.niushop.com" class="other-links-text" target="_blank">NIUSHOP官方网站</a>
		</li>
		<li class="other-links-item">
			<div  class="other-links-pic">
				<img src="http://www.ls.com/app/install/view/public/img/forum.png" alt="">
			</div>
