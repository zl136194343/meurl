<?php /*a:2:{s:62:"/www/wwwroot/www.hunqin.com/app/admin/view/user/edit_user.html";i:1614516022;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="username" value="<?php echo htmlentities($user_info['username']); ?>" type="text" placeholder="用户名" disabled class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="status" value="1" lay-skin="switch" <?php if($user_info['status'] == 1): ?> checked <?php endif; ?> />
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline ns-len-mid">
			<select name="group_id" lay-verify="groupid">
				...
				<option value="<?php echo htmlentities($group_list_v['group_id']); ?>" <?php if($user_info['group_id']==$group_list_v['group_id']): ?>selected<?php endif; ?>><?php echo htmlentities($group_list_v['group_name']); ?> </option> 
				<?php endforeach; ?>
			</select> 
		</div>
	</div> 
	...
	<!-- 隐藏域 -->
	<input value="<?php echo htmlentities($user_info['uid']); ?>" type="hidden" class="user_id" name="uid" />
</div>
	...
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				type: 'POST',
				dataType: 'JSON',
				url: ns.url("admin/user/editUser"),
				data: data.field,
				success: function(res) {
					repeat_flag = false;
					if (res.code == 0) {
						layer.confirm('编辑成功', {
							...
							btn: ['返回列表', '继续操作'],
							yes: function(){
								location.href = ns.url("admin/user/user")
							},
							btn2: function() {
								location.reload();
							}
