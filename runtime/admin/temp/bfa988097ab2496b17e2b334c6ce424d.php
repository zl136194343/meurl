<?php /*a:2:{s:60:"/www/wwwroot/www.hunqin.com/app/admin/view/shopjoin/adv.html";i:1614516008;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card-body">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="upload-img-block img-upload">
						<div class="upload-img-box <?php if($adv_config && $adv_config[0]['url']): ?>hover<?php endif; ?>">
							<div class="ns-upload-default" id="shopImg1">
								<?php if($adv_config && $adv_config['0']['url']): ?>
								<div id="preview_shopImg1" class="preview_img">
									<img layer-src src="<?php echo img($adv_config['0']['url']); ?>" class="img_prev"/>
								</div>
								<?php else: ?>
								<div class="upload">
							...
							<input type="hidden" name="shopImg1" value="<?php echo htmlentities($adv_config['0']['url']); ?>">
						</div>
					</div>
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="upload-img-block img-upload">
						<div class="upload-img-box <?php if($adv_config && $adv_config[1]['url']): ?>hover<?php endif; ?>">
							<div class="ns-upload-default" id="shopImg2">
								<?php if($adv_config && $adv_config['1']['url']): ?>
								<div id="preview_shopImg2" class="preview_img">
									<img layer-src src="<?php echo img($adv_config['1']['url']); ?>" class="img_prev"/>
								</div>
								<?php else: ?>
								<div class="upload">
									<img src="https://xyhl.chnssl.com/app/admin/view/public/img/upload_img.png"/>
							...
							<input type="hidden" name="shopImg2" value="<?php echo htmlentities($adv_config['1']['url']); ?>">
						</div>
					</div>
				</div>
				<span class="ns-word-aux">图片展示在商家端前台首页广告位，建议上传图片尺寸为1920px * 615px</span>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="upload-img-block img-upload">
						<div class="upload-img-box <?php if($adv_config && $adv_config[2]['url']): ?>hover<?php endif; ?>">
							<div class="ns-upload-default" id="shopImg3">
								<?php if($adv_config && $adv_config['2']['url']): ?>
								<div id="preview_shopImg3" class="preview_img">
									<img layer-src src="<?php echo img($adv_config['2']['url']); ?>" class="img_prev"/>
								</div>
								<?php else: ?>
								<div class="upload">
									<img src="https://xyhl.chnssl.com/app/admin/view/public/img/upload_img.png"/>
							...
							<input type="hidden" name="shopImg3" value="<?php echo htmlentities($adv_config['2']['url']); ?>">
						</div>
					</div>
				</div>
				<span class="ns-word-aux">图片展示在商家端前台首页广告位，建议上传图片尺寸为1920px * 615px</span>
...
<script>
	// var adv_configStr = '<?php echo json_encode($adv_config, JSON_UNESCAPED_SLASHES); ?>';
