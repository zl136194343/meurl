<?php /*a:2:{s:69:"/www/wwwroot/ls.chnssl.com/app/admin/view/memberlevel/edit_level.html";i:1661494876;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<?php if($level_info['data']['is_default'] == 0): ?>
	<div class="layui-form-item">
	...
	<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input name="discount" type="discount" lay-verify="num" class="layui-input ns-len-short" value="<?php echo htmlentities($level_info['data']['discount']); ?>">
			</div>
