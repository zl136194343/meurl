<?php /*a:2:{s:72:"/www/wwwroot/ls.chnssl.com/app/admin/view/shopcategory/add_category.html";i:1614516002;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class=" layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="category_name" lay-verify="required" class="layui-input ns-len-long" autocomplete="off">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="sort" value="0" class="layui-input ns-len-short" lay-verify="sorts" autocomplete="off">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-input-inline">
				<input type="number" name="baozheng_money" value="0.00" class="layui-input ns-len-short" lay-verify="flo" autocomplete="off">
			</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/shopcategory/addCategory"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res) {
					...
					if (res.code == 0) {
						layer.confirm('添加成功', {
							...
							btn2: function() {
								location.href = ns.url("admin/shopcategory/addCategory")
							}
						});
					}else{
						layer.msg(res.message);
