<?php /*a:2:{s:65:"/www/wwwroot/www.hunqin.com/app/admin/view/shopservice/lists.html";i:1614516010;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="service_type" lay-filter="service_type">
							...
							<?php foreach($service_name_arr as $value): ?>
							<option value="<?php echo htmlentities($value['key']); ?>"><?php echo htmlentities($value['name']); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="status" lay-filter="status">
							<option value="">全部</option>
							<?php foreach($service_status_arr as $list_k => $list_v): ?>
							<option value="<?php echo htmlentities($list_k); ?>"><?php echo htmlentities($list_v); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
...
<script>
	layui.use(['form', 'layer', 'laydate', 'element'], function() {
		...
		table = new Table({
			elem: '#service_list',
			url: ns.url("admin/shopservice/lists"),
		...
		table.tool(function(obj) {
			...
			switch (event){  
				...
				$.ajax({
						url: ns.url("admin/shopservice/pass"),
						data: {
				...
				case 'refuse':  //拒绝
					...
					layer.prompt({
						...
						yes: function(index, layero){
							...
							if (value) {
								$.ajax({
									url: ns.url("admin/shopservice/reject"),
									data: {
										"apply_id":data.apply_id,
										"reason":value
									},
				...
				break;
				case 'detail':  //查看详情
				location.href = ns.url("admin/shopservice/detail?apply_id=" +data.apply_id)
