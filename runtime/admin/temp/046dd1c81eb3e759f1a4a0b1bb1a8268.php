<?php /*a:2:{s:60:"/www/wwwroot/ls.chnssl.com/app/admin/view/member/config.html";i:1661239388;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-card ns-card-common ns-card-brief">
		<div class="layui-card ns-card-common ns-card-brief">
			<div class="layui-card-header">
				<span class="ns-card-title">投资金额设置</span>
			</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="layui-input-inline">
							<input type="number" name="min_money" value="<?php if(!empty($invest['min_money'])): ?><?php echo htmlentities($invest['min_money']); else: ?>0<?php endif; ?>" autocomplete="off" class="layui-input ns-len-short">
						</div>
			...
			<div class="layui-card-body">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="layui-input-inline">
							<input type="number" name="max_money" value="<?php if(!empty($invest['max_money'])): ?><?php echo htmlentities($invest['max_money']); else: ?>0<?php endif; ?>" autocomplete="off" class="layui-input ns-len-short">
						</div>
			...
			<div class="layui-card-body">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<div class="layui-input-inline">
							<input type="number" name="daily_limit" value="<?php if(!empty($invest['daily_limit'])): ?><?php echo htmlentities($invest['daily_limit']); else: ?>0<?php endif; ?>" autocomplete="off" class="layui-input ns-len-short">
						</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				type: 'POST',
				url: ns.url("admin/member/inveconfig"),
				data: data.field,
				dataType: 'JSON',
				success: function(res) {
					repeat_flag = false;
