<?php /*a:2:{s:65:"/www/wwwroot/www.hunqin.com/app/admin/view/config/receivable.html";i:1614515896;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="bank_account_name" lay-verify="name" value="<?php echo htmlentities($receivable_config['data']['value']['bank_account_name']); ?>" placeholder="请输入银行开户名" autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label"><span class="required">*</span>银行账户：</label>
		<div class="layui-input-block">
			<input type="text" name="bank_account_no" lay-verify="no" value="<?php echo htmlentities($receivable_config['data']['value']['bank_account_no']); ?>" placeholder="请输入银行账户"  autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label"><span class="required">*</span>开户行名称：</label>
		<div class="layui-input-block">
			<input type="text" name="bank_name" lay-verify="bank_name" value="<?php echo htmlentities($receivable_config['data']['value']['bank_name']); ?>" placeholder="请输入开户名称" autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label"><span class="required">*</span>开户行所在地：</label>
		<div class="layui-input-block">
			<input type="text" name="bank_address" lay-verify="bank_address" value="<?php echo htmlentities($receivable_config['data']['value']['bank_address']); ?>" placeholder="请输入开户所在地" autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
