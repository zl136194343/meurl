<?php /*a:2:{s:77:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\memberlabel\label_list.html";i:1614515918;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="ns-single-filter-box">
	<button class="layui-btn ns-bg-color" onclick="window.location.href='<?php echo addon_url("admin/memberlabel/addLabel"); ?>'">添加标签</button>
...
<script>
	...
	layui.use(['form'], function() {
		...
		table = new Table({
			elem: '#label_info',
			url: ns.url("admin/memberlabel/labelList"),
			cols: [
				[
					{
						width: "3%",
		...
		*/
		table.tool(function(obj) {
			...
			switch (obj.event) {
				case 'edit': //编辑
					location.href = ns.url("admin/memberlabel/editLabel?label_id="+data.label_id)
					break;
				case 'delete': //删除
		...
		*/
		function deleteLabel(label_ids) {
			...
			layer.confirm('确定要删除该标签吗?', function() {
				$.ajax({
					url: ns.url("admin/memberlabel/deleteLabel"),
	...
	function editSort(id, event){
		...
		if(data<0){
	 	...
	 	$.ajax({
	 		type: 'POST',
	 		url: ns.url("admin/memberlabel/modifySort"),
	 		data: {
	 			sort: data,
	 			label_id: id
	 		},
