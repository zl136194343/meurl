<?php /*a:2:{s:58:"/www/wwwroot/www.hunqin.com/app/admin/view/config/map.html";i:1614518646;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="tencent_map_key" autocomplete="off" value="<?php echo isset($info['tencent_map_key']) ? htmlentities($info['tencent_map_key']) : ''; ?>" class="layui-input ns-len-long inline-block">
            <a href="https://lbs.qq.com/dev/console/key/manage" class="ns-text-color" target="_blank" style="margin-left:5px;">获取密钥</a>
        </div>
        <div class="ns-word-aux">用于前台页面地图的获取</div>
    </div>

    <div class="layui-form-item">
        <label class="layui-form-label">高德地图密钥：</label>
        <div class="layui-input-block">
            <input type="text" name="gaode_map_key" autocomplete="off" value="<?php echo isset($info['gaode_map_key']) ? htmlentities($info['gaode_map_key']) : ''; ?>" class="layui-input ns-len-long inline-block">
