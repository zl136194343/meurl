<?php /*a:2:{s:63:"/www/wwwroot/ls.chnssl.com/app/admin/view/shop_account/fee.html";i:1614515998;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
    layui.use(['form', 'laydate'], function() {
        ...
        table = new Table({
            ...
            url: ns.url("admin/shopaccount/fee"),
            cols: [
                [{
                    field: 'account_no',
                    title: '账单编号',
                    ...
                    title: '<span style="padding-right: 50px;">分站抽成（元）</span>',
                    unresize: 'false',
					align: 'right',
                    templet: function(data) {
