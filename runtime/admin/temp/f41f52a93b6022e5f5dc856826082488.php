<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\shop\basic_info.html";i:1657517482;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="site_name" type="text" value="<?php echo htmlentities($shop_info['site_name']); ?>"  lay-verify="required" class="layui-input ns-len-long" autocomplete="off">
		</div>
		<p class="ns-word-aux">请不要随意修改店铺名称</p>
	</div>
	...
	<div class="layui-form-item">
		<label class="layui-form-label">是否参与会员优惠：</label>
		<div class="layui-input-block">
			<input type="radio" name="is_member" lay-filter="is_member" value="1" title="开启" <?php if($shop_info['is_member'] == 1): ?> checked <?php endif; ?>>
			<input type="radio" name="is_member" lay-filter="is_member" value="0" title="关闭" <?php if($shop_info['is_member'] == 0): ?> checked <?php endif; ?>>
		</div>
		<p class="ns-word-aux">开启后，会员消费时平台会给予优惠</p>
	</div>
