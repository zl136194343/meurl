<?php /*a:2:{s:76:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\memberlabel\add_label.html";i:1614515918;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div  class="layui-form ns-form">
	...
	<div class="ns-form-row">
		...
		<button class="layui-btn layui-btn-primary" onclick="window.location.href='<?php echo addon_url("admin/memberlabel/labelList"); ?>'">返回</button>
	</div>
</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/memberlabel/addLabel"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST', 
				success: function(res) {
					...
					if (res.code == 0) {
						layer.confirm('添加成功', {
							...
							btn: ['返回列表', '继续添加'],
							yes: function(){
								location.href = ns.url("admin/memberlabel/labelList")
							},
							btn2: function() {
								location.href = ns.url("admin/memberlabel/addLabel")
							}
						});
					}else{
						layer.msg(res.message);
