<?php /*a:2:{s:57:"/www/wwwroot/ls.chnssl.com/app/admin/view/user/group.html";i:1614516022;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use('form', function() {
		...
		table = new Table({
			elem: '#group_list',
			url: ns.url("admin/user/group"), //数据接口
			cols: [
				[
					{
						field: 'group_name',
		...
		table.tool(function(obj) {
			...
			switch (obj.event) {
				case 'edit': //编辑
					location.href = ns.url("admin/user/editGroup?group_id="+ data.group_id);
					break;
				case 'delete': //删除
		...
		function deleteGroup(group_id) {
			...
			layer.confirm('确定要删除该用户组吗?', function() {
				$.ajax({
					url: ns.url("admin/user/delGroup"),
