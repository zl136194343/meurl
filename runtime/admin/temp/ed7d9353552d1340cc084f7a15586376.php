<?php /*a:2:{s:62:"/www/wwwroot/ls.chnssl.com/app/admin/view/config/servicer.html";i:1616032148;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form" lay-filter="form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="state" lay-skin="switch" <?php if(isset($config['value']['type']) && $config['value']['type'] == 'system'): ?>checked<?php endif; ?> />
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="socket_url" value="<?php echo isset($config['value']['socket_url']) ? htmlentities($config['value']['socket_url']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long" lay-verify="required">
		</div>
		<div class="ns-word-aux">请根据需要谨慎填写websocket链接, 若变动后需重新刷新 <a href="<?php echo url('pc://admin/pc/deploy'); ?>" class="ns-text-color" target="_blank">web端部署</a> 和 <a href="<?php echo url('admin/system/refreshh5'); ?>" class="ns-text-color" target="_blank">H5端部署</a> 才能应用</div>
	</div>
