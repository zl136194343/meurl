<?php /*a:2:{s:67:"/www/wwwroot/www.hunqin.com/app/admin/view/goods/verify_config.html";i:1614515904;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="is_open" value="1" lay-skin="switch" <?php if($goods_verify_info && $goods_verify_info['is_open'] == 1): ?>checked<?php endif; ?>/>
		</div>
	</div>
	...
	layui.use(['form'], function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				type: 'POST',
				dataType: 'JSON',
				url: ns.url("admin/goods/verifyConfig"),
				data: data.field,
				success: function(res) {
					layer.msg(res.message);
					if (res.code == 0) {
