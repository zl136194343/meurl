<?php /*a:2:{s:81:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\goodscategory\add_category.html";i:1666682954;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-form-item">
		<label class="layui-form-label">是否为积分分类 :</label>
		<div class="layui-input-block">
			<input type="checkbox" name="is_jifen" lay-skin="switch" value="1" checked>
		</div>
		<div class="ns-word-aux">
			<p>用于积分分类展示与选择</p>
		</div>
...
<script src="https://www.hunqin.com/app/admin/view/public/js/goods_edit_category.js"></script>
