<?php /*a:2:{s:65:"/www/wwwroot/ls.chnssl.com/app/admin/view/promotion/platform.html";i:1614515932;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
	.ns-item-block-parent .ns-item-poa-pic{margin-top: 0;background-image: linear-gradient(to right, #fb8700, #fb6400);text-align: center;color: #FFFFFF;width: 70px;height: 30px;line-height: 30px;border-bottom-left-radius: 3px;}
	.ns-empty-body {
		width: 100%;
		text-align: center;
	}
...
<div class="layui-card ns-card-common ns-card-brief">
	<div class="layui-card-header">
		<span class="ns-card-title">平台营销</span>
	</div>
			...
			<?php foreach($promotion as $list_k => $list_v): if($list_v['show_type'] == 'admin'): if(empty($list_v['is_developing']) || (($list_v['is_developing'] instanceof \think\Collection || $list_v['is_developing'] instanceof \think\Paginator ) && $list_v['is_developing']->isEmpty())): ?>
				...
				<a class="ns-item-block ns-item-block-hover-a" href="#">
					<div class="ns-item-block-wrap">
						...
						<div class="ns-item-poa-pic">敬请期待</div>
					</div>
				</a>
				<?php endif; ?>
			<?php endif; ?>
...
<script>
	var _len = $(".ns-item-block-parent .ns-item-block").length;
	if (_len == 0) {
		$(".ns-item-block-parent").html('<div class="ns-empty-body"><img src="https://ls.chnssl.com/public/static/img/null_img.png" /><p>平台营销正在开发中，敬请期待~</p></div>');
	}
</script>
