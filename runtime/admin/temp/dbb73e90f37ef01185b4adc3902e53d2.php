<?php /*a:2:{s:57:"/www/wwwroot/ls.chnssl.com/app/admin/view/config/api.html";i:1614515894;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<?php if($config['value']): ?>
			<textarea name="private_key" class="layui-textarea ns-len-long" placeholder="请输入秘钥" disabled><?php echo htmlentities($config['value']['private_key']); ?></textarea>
			<?php else: ?>
