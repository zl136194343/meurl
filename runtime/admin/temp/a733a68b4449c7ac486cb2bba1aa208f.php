<?php /*a:2:{s:63:"/www/wwwroot/ls.chnssl.com/app/admin/view/config/copyright.html";i:1614515896;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card-body">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="upload-img-block img-upload">
						<div class="upload-img-box <?php if(!(empty($copyright['logo']) || (($copyright['logo'] instanceof \think\Collection || $copyright['logo'] instanceof \think\Paginator ) && $copyright['logo']->isEmpty()))): ?>hover<?php endif; ?>">
							<div class="ns-upload-default" id="webLogoUpload">
								<?php if($copyright['logo']): ?>
								<div id="preview_webLogoUpload" class="preview_img">
									<img layer-src src="<?php echo img($copyright['logo']); ?>" class="img_prev"/>
								</div>
								<?php else: ?>
								<div class="upload">
			...
			<?php else: ?>
			<div class="no-auth">授权之后才可修改版权信息，<a href="<?php echo url('admin/system/auth'); ?>" class="ns-text-color">绑定授权</a></div>
			<?php endif; ?>
		</div>
	</div>
	...
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card-body">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="market_supervision_url"  value="<?php echo isset($copyright['market_supervision_url']) ? htmlentities($copyright['market_supervision_url']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
				</div>
			</div>
