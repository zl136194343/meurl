<?php /*a:2:{s:66:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\album\lists.html";i:1614518646;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="http://www.hunqin.com/public/static/img/bitbug_favicon.ico" />
	...
	<link rel="stylesheet" type="text/css" href="http://www.hunqin.com/public/static/loading/msgbox.css"/>
	<link rel="stylesheet" type="text/css" href="http://www.hunqin.com/app/admin/view/public/css/common.css" />
	...
	<script>
		...
		window.ns_url = {
			...
			IMGPATH:"http://www.hunqin.com/app/admin/view/public/img/"
		};

	</script>
	<script src="http://www.hunqin.com/public/static/js/common.js"></script>
	<script src="http://www.hunqin.com/app/admin/view/public/js/common.js"></script>
	<style>
...
<link rel="stylesheet" type="text/css" href="http://www.hunqin.com/app/admin/view/public/css/picture_manager.css" />
<style>
...
<div class="ns-logo">
	<div class="logo-box">
		<!--<img src="http://www.hunqin.com/app/admin/view/public/img/logo.png">-->
	</div>
	<span>小谷粒管理系统</span>
			...
			<li class="layui-nav-item">
				<a href="javascript:;">
					<div class="ns-img-box">
						<img src="http://www.hunqin.com/app/admin/view/public/img/default_headimg.png" alt="">
					</div>
					...
					upload.render({
						...
						choose: function(obj) {
							...
							obj.preview(function(index, file, result) {
								...
								//禁止点击
								if ($(".multuple-list li").length > 1) {
									$("#modifyFileAction").addClass("ns-bg-color").removeClass("layui-btn-disabled").removeAttr("disabled");
									//隐藏添加按钮，仅替换一张图片
									$("#modifyFile").hide();
								}
							});
