<?php /*a:2:{s:67:"/www/wwwroot/ls.chnssl.com/app/admin/view/shopapply/edit_apply.html";i:1661741785;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-len-mid ns-input-text"><?php echo htmlentities($apply_info['shop_name']); ?></div>
	</div>

	<div class="layui-form-item ns-shop-time">
		<label class="layui-form-label">入驻时长：</label>
		<div class="layui-input-block ns-len-mid ns-input-text"><?php echo htmlentities($apply_info['apply_year']); ?> 年</div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">主营行业：</label>
		<div class="layui-input-block ns-len-mid ns-input-text"><?php echo htmlentities($apply_info['category_name']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">开店套餐：</label>
		<div class="layui-input-block ns-len-mid ns-input-text"><?php echo htmlentities($apply_info['group_name']); ?></div>
	</div>
		...
		<div class="layui-input-inline img-upload">
			...
			<div class="upload-img-block icon">
				<div class="upload-img-box">
					<img layer-src src="<?php echo img($apply_info['paying_money_certificate']); ?>" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-input-text ns-len-long"><?php echo htmlentities($apply_info['paying_money_certificate_explain']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">付款金额：</label>
		<div class="layui-input-inline"><?php echo htmlentities($apply_info['paying_amount']); ?></div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-input-text">
			<?php if(in_array($apply_info['apply_state'], [2])): ?>
			<textarea  name="apply_message" lay-verify="required" class="layui-textarea ns-len-long"></textarea>
			<?php else: ?>
			<?php echo htmlentities($apply_info['apply_message']); ?>
			<?php endif; ?>
		</div>
	</div>
	<?php if(in_array($apply_info['apply_state'], [2]) && $apply_info['paying_money_certificate']): ?>
	...
	<?php endif; ?>
	<input type="hidden" value="<?php echo htmlentities($apply_info['apply_id']); ?>" name="apply_id" >
	<input type="hidden" value="<?php echo htmlentities($apply_info['paying_money_certificate']); ?>" name="paying_money_certificate" >
</div>
