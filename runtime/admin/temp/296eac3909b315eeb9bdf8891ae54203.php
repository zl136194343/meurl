<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\shop\settlement_info.html";i:1664509833;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="ns-pay-win">
		...
		<div class="ns-pay-win" style="display: none">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<?php if($cert_info['bank_type'] == 3): ?>
					<input name="weixin_settlement_bank_name" id="weixin_settlement_bank_name"  type="text" value="<?php echo htmlentities($cert_info['settlement_bank_name']); ?>" class="layui-input ns-len-long" autocomplete="off" >
					<?php else: ?>
