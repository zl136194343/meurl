<?php /*a:2:{s:63:"/www/wwwroot/www.hunqin.com/app/admin/view/config/editsysm.html";i:1670823871;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="layui-card-body">
					     <div class="layui-form-item">
                    		...
                    		<div class="layui-input-inline">
                    			<input type="text" name="title" lay-verify="name" value="<?php echo htmlentities($info['title']); ?>" placeholder="请输入对应的分类名" autocomplete="off" class="layui-input ns-len-long">
                    		</div>
                    	</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="video-thumb">
									<video id="goods_video" class="video-js vjs-big-play-centered" controls="" poster="https://xyhl.chnssl.com/app/shop/view/public/img/goods_video_preview.png" preload="auto" src="<?php echo img($info['content']); ?>"></video>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="video_url" placeholder="视频地址" autocomplete="off" value="<?php echo htmlentities($info['content']); ?>" class="layui-input ns-len-long">
								<!--<input type="text" name="sort" value="<?php echo htmlentities($info['sort']); ?>" placeholder="权重" autocomplete="off" class="layui-input ns-len-long">-->
							</div>
						</div>
