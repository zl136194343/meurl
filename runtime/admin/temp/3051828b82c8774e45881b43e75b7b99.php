<?php /*a:2:{s:82:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\dtgl\category\edit_category.html";i:1671171641;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="name" type="text" value="<?php echo htmlentities($goods_category_info['name']); ?>" placeholder="请输入分类名称" maxlength="30" lay-verify="required" class="layui-input ns-len-long" autocomplete="off">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box <?php if(!(empty($goods_category_info['img']) || (($goods_category_info['img'] instanceof \think\Collection || $goods_category_info['img'] instanceof \think\Paginator ) && $goods_category_info['img']->isEmpty()))): ?>hover<?php endif; ?>">
					<div class="ns-upload-default" id="imgUpload">
						<?php if($goods_category_info['img']): ?>
						<div id="preview_imgUpload" class="preview_img">
							<img layer-src src="<?php echo img($goods_category_info['img']); ?>" class="img_prev"/>
						</div>
						<?php else: ?>
						<div class="upload">
							<img src="https://www.hunqin.com/app/admin/view/public/img/upload_img.png"/>
							<p>点击上传</p>
						</div>
						<?php endif; ?>
					</div>
					...
					<input type="hidden" name="img" value="<?php echo htmlentities($goods_category_info['img']); ?>">
				</div>
			</div>
		</div>
		<div class="ns-word-aux">
	...
	<input type="hidden" name="category_id" value="<?php echo htmlentities($goods_category_info['id']); ?>">
...
<script src="https://www.hunqin.com/app/admin/view/public/js/dtgl_edit_category.js"></script>
