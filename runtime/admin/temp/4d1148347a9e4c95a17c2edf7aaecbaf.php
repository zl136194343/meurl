<?php /*a:2:{s:60:"/www/wwwroot/ls.chnssl.com/app/admin/view/hospital/edit.html";i:1653975018;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="layui-card-body">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="title" type="text" id="hospital_name" class="layui-input ns-len-long" value="<?php echo htmlentities($verify_state['data']['hospital_name']); ?>"  autocomplete="off">

            </div>
        </div>
        <input type="hidden" name="hospital_id" id="hospital_id" value="<?php echo htmlentities($verify_state['data']['hospital_id']); ?>">
        <div class="layui-form-item">
                    ...
                    <div class="upload-img-box">
                        <div class="ns-upload-default" id="idCardPicFront">
                            <div id="preview_idCardPicFront" class="preview_img">
                                <img layer-src="" title="点击放大图片" src="<?php echo img($verify_state['data']['hospital_img']); ?>" class="img_prev" layer-index="0">
                            </div>
                        </div>
