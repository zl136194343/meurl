<?php /*a:2:{s:66:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\order\lists.html";i:1666064728;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://www.hunqin.com/app/admin/view/public/css/order_list.css"/>
    ...
    <div class="layui-colla-item">
        ...
        <form class="layui-colla-content layui-form layui-show"  lay-filter="order_list">
            ...
            <div class="ns-form-row">
                ...
                <a class="layui-btn layui-btn-primary" href="<?php echo addon_url('admin/order/export'); ?>" target="_blank">查看已生成报表</a>
            </div>
...
<script src="https://www.hunqin.com/app/admin/view/public/js/order_list.js"></script>
<script>
    ...
    layui.use(['laypage','laydate','form', 'element'], function(){
        ...
        form.on('submit(batch_export_order_goods)', function(data){
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: ns.url("admin/order/exportordergoods"),
                data: data.field,
                success: function (res) {

                }
            });
            window.open(ns.url("admin/order/export",{}));
            return false;
        });
        ...
        form.on('submit(batch_export_order)', function(data){
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: ns.url("admin/order/exportorder"),
                data: data.field,
                success: function (res) {
                }
            });
