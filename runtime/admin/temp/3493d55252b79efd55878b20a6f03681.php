<?php /*a:2:{s:61:"/www/wwwroot/ls.chnssl.com/app/admin/view/complain/lists.html";i:1614515894;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<select name="complain_status" lay-filter="complain_status">
							...
							<?php foreach($complain_status_list as $k => $status_val): ?>
...
<div class="layui-tab ns-table-tab" lay-filter="order_tab">
	<ul class="layui-tab-title">
		...
		<?php foreach($complain_status_list as $k => $status_val): if($status_val['status']!=0): ?>
...
<script src="https://ls.chnssl.com/app/admin/view/public/js/complain_list.js"></script>
<script>
