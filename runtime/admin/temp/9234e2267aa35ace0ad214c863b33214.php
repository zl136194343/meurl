<?php /*a:2:{s:66:"/www/wwwroot/ls.chnssl.com/app/admin/view/shopgroup/add_group.html";i:1614516004;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="site_list ns-item-block-parent ns-item-five">
					...
					<a class="ns-item-block ns-item-block-hover-a">
						...
						<div class="ns-input-box">
							<input type="checkbox" value="<?php echo htmlentities($promotion['name']); ?>" class="ns-input-checkbox" lay-filter="is_checked" lay-skin="primary">
						</div>
					</a>
					<?php endif; ?>
					<?php endforeach; ?>
