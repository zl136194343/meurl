<?php /*a:2:{s:59:"/www/wwwroot/ls.chnssl.com/app/admin/view/config/basic.html";i:1614518450;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-card-body">
			<div class="layui-form-item">
				...
				<div class="layui-input-block keywords-block">
					<?php if(!empty($config['search_keywords'])): foreach($config['search_keywords'] as $k => $v): ?>
						<div class="layui-input-inline keywords-item">
							<input type="text" name="search_keywords[]" lay-verify="required" value="<?php echo htmlentities($v); ?>" placeholder=""
