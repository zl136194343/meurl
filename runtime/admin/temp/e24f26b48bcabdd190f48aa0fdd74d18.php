<?php /*a:2:{s:66:"/www/wwwroot/ls.chnssl.com/app/admin/view/express/add_company.html";i:1614515900;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card-body">
			...
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="required">*</span>URL：</label>
				<div class="layui-input-block">
					<input type="text" name="url" lay-verify="required" class="layui-input ns-len-long">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="express_no_kdniao" class="layui-input ns-len-long">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="express_no_kd100_free" class="layui-input ns-len-long">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="express_no_ext" class="layui-input ns-len-long">
				</div>
			</div>
		</div>	
	</div>
...
<script>
	...
	layui.use(['form'], function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/express/addCompany"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res) {
