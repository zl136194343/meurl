<?php /*a:2:{s:73:"/www/wwwroot/ls.chnssl.com/app/admin/view/community/goodsbrand/lists.html";i:1657517005;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	...
	layui.use(['table', 'form'], function() {
		...
		table = new Table({
			elem: '#brand_list',
			url: ns.url("admin/comsbrand/lists"),
			cols: [
				[
					/* {
					width: "3%",
		...
		table.tool(function(obj) {
			...
			switch (obj.event) {
				case 'edit':
					location.href = ns.url("admin/comsbrand/editbrand",{"brand_id":data.brand_id});
					break;
				case 'delete':
		...
		function deleteBrand(brand_id) {
			layer.confirm('确定要删除该品牌吗？', function() {
				$.ajax({
					url: ns.url("admin/comsbrand/deleteBrand"),
	...
	function editSort(id, event){
		...
		$.ajax({
			type: 'POST',
			url: ns.url("admin/comsbrand/modifySort"),
			data: {
				sort: data,
				brand_id: id
			},
	...
	function addBrand() {
		location.href = ns.url("admin/comsbrand/addBrand");
	}
</script>
