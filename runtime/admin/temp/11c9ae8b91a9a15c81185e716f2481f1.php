<?php /*a:2:{s:61:"/www/wwwroot/www.hunqin.com/app/admin/view/message/lists.html";i:1614515922;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-card-body layui-field-box">
		...
		<div class="block-list">
			...
			<div class="block-content">
				...
				<?php if(in_array('email',$member_message_v['support_type_array'])): ?>
				...
				<?php endif; if(in_array('sms',$member_message_v['support_type_array'])): ?>
				...
				<?php endif; if(in_array('wechat',$member_message_v['support_type_array'])): ?>
...
<div class="layui-card ns-card-common ns-card-brief">
	...
	<div class="layui-card-body layui-field-box">
		...
		<div class="block-list">
			<div class="block-title"><?php echo htmlentities($shop_message_v['title']); ?></div>
			<div class="block-content">
				<?php if(in_array('email',$shop_message_v['support_type_array'])): ?>
				...
				<?php endif; if(in_array('sms',$shop_message_v['support_type_array'])): ?>
				...
				<?php endif; if(in_array('wechat',$shop_message_v['support_type_array'])): ?>
					<a href="<?php echo addon_url('wechat://admin/message/edit',['keywords' => $shop_message_v['keywords']]); ?>"><i class="iconfont iconseleted <?php if($shop_message_v['wechat_is_open'] == 1): ?>ns-text-color-red<?php endif; ?>"></i>微信公众号</a>
				<?php endif; ?>
