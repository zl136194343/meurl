<?php /*a:2:{s:67:"/www/wwwroot/www.hunqin.com/app/admin/view/member/editfeedback.html";i:1666070634;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		<label class="layui-form-label"><span class="required">*</span>会员名称：</label>
		<div class="layui-input-block">
			<p name="level_name" ><?php echo htmlentities($list['member_name']); ?></p>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-len-long">
			...
			<p name="remark" ><?php echo htmlentities($list['feedback']); foreach($list['img_str'] as $l): ?>
			<img class="" src=<?php echo img($l); ?> alt="" />
			<?php endforeach; ?>
			</p>
		</div>
	</div>
