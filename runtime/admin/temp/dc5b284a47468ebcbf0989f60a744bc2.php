<?php /*a:2:{s:61:"/www/wwwroot/ls.chnssl.com/app/admin/view/help/help_list.html";i:1614515910;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	...
	layui.use('form', function() {
		...
		table = new Table({
			elem: '#help_list',
			url: ns.url("admin/help/helpList"),
			cols: [
				[{
					field: 'title',
					title: '帮助标题',
		...
		table.tool(function(obj) {
			...
			switch (obj.event) {
				case 'edit': //编辑
					location.href = ns.url("admin/help/editHelp?id=" + data.id);
					break;
				case 'delete': //删除
					deleteHelp(data.id);
					break;
	...
	function deleteHelp(id) {
		...
		layer.confirm('确定要删除该帮助内容吗?', function() {
					$.ajax({
						url: ns.url("admin/help/deleteHelp"),
						data: {id: id},
						dataType: 'JSON',
						type: 'POST',
						success: function(res) {
	...
	function editSort(id, event) {
		...
		$.ajax({
			type: 'POST',
			url: ns.url("admin/help/modifySort"),
			data: {
				sort: data,
				help_id: id
			},
	...
	function add() {
		location.href = ns.url("admin/help/addHelp");
	}
</script>
