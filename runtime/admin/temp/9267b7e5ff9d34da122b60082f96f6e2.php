<?php /*a:2:{s:73:"/www/wwwroot/ls.chnssl.com/app/admin/view/message/edit_email_message.html";i:1614515920;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="email_is_open" value="1" <?php if($email_is_open == 1): ?>checked<?php endif; ?> lay-skin="switch">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">数据值：</label>
        <div class="layui-input-block">
            <?php foreach($message_variable_list as $message_variable_k => $message_variable_v): ?>
            <button class="layui-btn layui-btn-primary number-con" onclick="clickBtn('<?php echo htmlentities($message_variable_v); ?>')"><?php echo htmlentities($message_variable_v); ?></button>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="email_title" placeholder="请输入协议标题" value="<?php echo htmlentities($email_title); ?>" autocomplete="off" class="layui-input ns-len-long">
        </div>
    ...
    <input type="hidden" id="mailContent" value="<?php echo htmlentities($email_content); ?>"/>
</div>
