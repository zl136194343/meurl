<?php /*a:2:{s:76:"/www/wwwroot/ls.chnssl.com/app/admin/view/community/goodscategory/lists.html";i:1657517006;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="table_one" data-index="<?php echo htmlentities($index); ?>" data-sort="<?php echo htmlentities($vo['sort']); ?>" data-cateid="<?php echo htmlentities($vo['category_id']); ?>">
				<div class="table_tr">
					...
					<div class="table_td" style="flex:2">
						<div class="ns-table-btn">
							<a class="layui-btn" href="<?php echo addon_url('admin/community/editcategory',['category_id'=>$vo['category_id']]); ?>">编辑</a>
				...
				<?php if(!(empty($vo['child_list']) || (($vo['child_list'] instanceof \think\Collection || $vo['child_list'] instanceof \think\Paginator ) && $vo['child_list']->isEmpty()))): ?>
					...
					<div class="table_tr">
						...
						<div class="table_td" style="flex:2">
							<div class="ns-table-btn">
								<a class="layui-btn" href="<?php echo addon_url('admin/community/editcategory',['category_id'=>$second['category_id']]); ?>">编辑</a>
	...
	$(function() {
		...
		$('.table_one').arrangeable({
			...
			callback:function(e){
				...
				setTimeout(function(){
					$.ajax({
						url: ns.url("admin/community/modifySort"),
...
function deleteCategory(category_id) {
	...
	layer.confirm('子级分类也会删除，请谨慎操作', function() {
		$.ajax({
			url: ns.url("admin/community/deleteCategory"),
...
function addCategory() {
	location.href = ns.url("admin/community/addcategory");
}
...
function editSort(id, event) {
    ...
    $.ajax({
        type: 'POST',
        url: ns.url("admin/community/editCategorySort"),
        data: {
            sort: data,
            category_id: id
        },
