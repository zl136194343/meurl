<?php /*a:2:{s:60:"/www/wwwroot/ls.chnssl.com/app/admin/view/user/user_log.html";i:1614516022;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="layui-input-inline">
						<select name="uid" lay-filter="uid">
							<option value="">请选择操作用户</option>
								<?php foreach($user_list as $user_list_k => $user_list_v): ?>
							<option value="<?php echo htmlentities($user_list_v['uid']); ?>"><?php echo htmlentities($user_list_v['username']); ?></option>
						<?php endforeach; ?>
						</select>
					</div>
					<div class="layui-input-inline">
