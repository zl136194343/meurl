<?php /*a:2:{s:67:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\system\cache.html";i:1614516016;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
	...
	<div class="layui-card-body layui-field-box">
		<div class="site_list ns-item-block-parent ns-item-five">
			<?php foreach($cache_list as $k => $val): ?>
			<a class="ns-item-block ns-item-block-hover-a" href="#">
				<div class="ns-item-block-wrap">
					<div class="ns-item-pic">
						<img src="<?php echo img($val['icon']); ?>" />
					</div>
					<div class="ns-item-con">
						<div class="ns-item-content-title"><?php echo htmlentities($val['name']); ?></div>
						<p class="ns-item-content-desc ns-over-hide-second"><?php echo htmlentities($val['desc']); ?></p>
					</div>
					<div class="ns-item-poa-pic" onclick="clear_cache('<?php echo htmlentities($val['key']); ?>')">
				...
				<!-- <div class="ns-item-float-wrap">
					<div class="ns-item-float">
						...
						<div class="ns-item-float-con" onclick="clear_cache('<?php echo htmlentities($val['key']); ?>')">
