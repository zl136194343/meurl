<?php /*a:2:{s:65:"/www/wwwroot/ls.chnssl.com/app/admin/view/member/investyield.html";i:1661505765;s:24:"app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use(['form', 'laydate'], function() {
		...
		table = new Table({
			elem: '#fenxiao_list',
			url: ns.url("admin/member/investyield"),
			cols: [
				[{
				    field: 'nickname',
					title: '用户名',
		...
		table.tool(function(obj) {
			...
			switch (event) {
				case 'detail': //查看
                    location.href = ns.url('admin/order/detail', {'fenxiao_order_id': data.fenxiao_order_id})
					break;
			}
		});
	});
