<?php /*a:2:{s:59:"/www/wwwroot/ls.chnssl.com/app/admin/view/upgrade/auth.html";i:1616032152;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="system-function">
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($auth_info['data']['product_name']); ?></td>
                    <td class="ns-bg-color-light-gray">授权状态</td>
                    <td>已授权</td>
                </tr>
                <tr>
                    <td class="ns-bg-color-light-gray">授权码</td>
                    <td><?php echo htmlentities($auth_info['data']['devolution_code']); ?></td>
                    <td class="ns-bg-color-light-gray">授权类型</td>
                    <td><?php echo htmlentities($auth_info['data']['devolution_version_name']); ?></td>
                </tr>
                <tr>
                    <td class="ns-bg-color-light-gray">当前版本</td>
                    <td><?php echo htmlentities($app_info['version']); ?></td>
                    <td class="ns-bg-color-light-gray">最新版本</td>
                    <td><?php echo isset($auth_info['data']['newest_version']) ? htmlentities($auth_info['data']['newest_version']) : ''; ?></td>
                </tr>
                <tr>
                    <td class="ns-bg-color-light-gray">授权时间</td>
                    <td><?php echo date('Y-m-d H:i:s', $auth_info['data']['devolution_date']); ?></td>
                    <td class="ns-bg-color-light-gray">服务到期时间</td>
                    <td>
                        <?php echo date('Y-m-d H:i:s', $auth_info['data']['devolution_expire_date']); if($auth_info['data']['devolution_expire_date'] > time()): ?>
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities($auth_info['data']['devolution_attribution']); ?></td>
                    <td class="ns-bg-color-light-gray">授权域名</td>
                    <td><?php echo htmlentities($auth_info['data']['devolution_url']); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="system-function">
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>多商户V4</td>
                    <td class="ns-bg-color-light-gray">授权状态</td>
                    <td>未授权 <a href="https://www.niushop.com" class="ns-text-color" target="_blank">去授权</a> </td>
                </tr>
                <tr>
