<?php /*a:2:{s:72:"/www/wwwroot/ls.chnssl.com/app/admin/view/community/goods/add_goods.html";i:1658218263;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-card ns-card-common">
					...
					<div class="layui-card-body commodity-type-box" >
						<div class="commodity-type-item ns-border-color" onclick="location.href = ns.url('admin/community/addGoods')">
							<span class="ns-text-color">实物商品</span>
							<span>(需要物流)</span>
						</div>
						<!--<div class="commodity-type-item" onclick="location.href = ns.url('admin/virtualgoods/addGoods')">
							<span>虚拟商品</span>
							<span>(无需物流)</span>
						</div>-->
					</div>
