<?php /*a:2:{s:65:"/www/wwwroot/ls.chnssl.com/app/admin/view/shopservice/detail.html";i:1614516010;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-card ns-card-common ns-card-brief">
		<div class="layui-card-header">
			<span class="ns-card-title">服务申请信息</span>
		</div>
		<div class="layui-card-body">
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="required">*</span>站点名称：</label>
				<div class="layui-input-block">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities($info['site_name']); ?></p>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label"><span class="required">*</span>申请服务类型：</label>
				<div class="layui-input-block ns-len-mid">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities($info['service_type_name']); ?></p>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">申请时间：</label>
				<div class="layui-input-block">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($info['create_time'])? strtotime($info['create_time']) : $info['create_time'])); ?></p>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">通过时间：</label>
				<div class="layui-input-block">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($info['audit_time'])? strtotime($info['audit_time']) : $info['audit_time'])); ?></p>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">审核状态：</label>
				<div class="layui-input-block">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities($info['status_name']); ?></p>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">备注：</label>
				<div class="layui-input-block">
					<p class="ns-input-text">&nbsp;&nbsp;&nbsp;<?php echo htmlentities($info['remark']); ?></p>
				</div>
			</div>
...
<script>
	function back() {
		location.href = ns.url("admin/shopservice/lists")
	}
</script>
