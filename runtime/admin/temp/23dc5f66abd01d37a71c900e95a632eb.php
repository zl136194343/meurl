<?php /*a:2:{s:66:"/www/wwwroot/www.hunqin.com/app/admin/view/shopcategory/lists.html";i:1614516004;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-collapse ns-tips">
	<div class="layui-colla-item">
		...
		<ul class="layui-colla-content layui-show">
			<li>店铺分类是指店铺的主营行业分类，前台会根据店铺的主营分类进行筛选。</li>
			<li>不同店铺分类的保证金不同，会员申请入驻需要根据店铺分类缴纳相应的保证金。</li>
		</ul>
	</div>
</div>
<!-- 搜索框 -->
...
layui.use(['form'], function() {
	...
	table = new Table({
		elem: '#category_info',
		url: ns.url("admin/shopcategory/lists"),
		cols: [
			[{
				unresize: 'false',
				field: 'category_name',
	...
	*/
	table.tool(function(obj) {
		...
		switch (obj.event) {
			case 'edit': //编辑
			location.href = ns.url("admin/shopcategory/editCategory?category_id="+ data.category_id)
				break;
			case 'delete': //删除
	...
	*/
	function deleteCategory(category_ids) {
		layer.confirm('确定要删除该主营行业吗？', function() {
			$.ajax({
				url: ns.url("admin/shopcategory/deleteCategory"),
