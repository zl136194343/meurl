<?php /*a:2:{s:63:"/www/wwwroot/ls.chnssl.com/app/admin/view/member/inveabout.html";i:1661395844;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="title" required lay-verify="required" placeholder="请输入合伙人投资信息标题" value="<?php echo htmlentities($document_info['data']['title']); ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
	<div class="layui-form-item">
...
<script>
	...
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/member/inveabout"),
				data: {
