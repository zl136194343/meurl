<?php /*a:2:{s:68:"/www/wwwroot/ls.chnssl.com/app/admin/view/memberlevel/add_level.html";i:1614515918;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="growth" type="number" lay-verify="num" class="layui-input ns-len-short">
		</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			repeat_flag = true;
			$.ajax({
				url: ns.url("admin/memberlevel/addLevel"),
				data: data.field,
