<?php /*a:2:{s:68:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\account\index.html";i:1656655264;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
    ...
    <div class="layui-card-body">
        ...
        <div class="content">
            ...
            <p class="money"><?php echo htmlentities($dj_money); ?></p>
        </div>
        <?php endif; ?>
        ...
        <div class="content">
            ...
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">订单周期结算后按约定抽成的总金额</div>
                    </div>
                </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">由订单结算抽成、店铺开店续签费用抽成组成</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">平台可转账给城市分站的剩余金额</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">平台已实际转账给城市分站的总金额</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">分销商的订单总金额统计</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">分销商累计总佣金统计</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">分销商提现待审核佣金统计</div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="title ns-prompt-block">
                ...
                <div class="ns-prompt">
                    <i class="iconfont iconwenhao1"></i>
                    <div class="ns-prompt-box">
                        <div class="ns-prompt-con">分销商已提现的佣金统计</div>
                    </div>
                </div>
            </div>
...
<div class="layui-card ns-card-common ns-card-brief">
    ...
    <div class="layui-card-body">
        <div class="content">
            ...
            <p class="money"><?php echo !empty($supply_account['settlement']) ? htmlentities($supply_account['settlement']) :  '0'; ?></p>
        </div>
        <div class="content">
            ...
            <p class="money"><?php echo !empty($supply_account['fee']) ? htmlentities($supply_account['fee']) :  '0'; ?></p>
        </div>
        <div class="content">
            <p class="title">总保证金（元）<a href="<?php echo addon_url('supply://admin/account/deposit'); ?>" class="subhead ns-text-color">查看</a></p>
            <p class="money"><?php echo !empty($supply_account['bond']) ? htmlentities($supply_account['bond']) :  '0'; ?></p>
        </div>
        <div class="content">
            ...
            <p class="money"><?php echo !empty($supply_account['withdraw']) ? htmlentities($supply_account['withdraw']) :  '0'; ?> | <?php echo !empty($supply_account['withdraw_apply']) ? htmlentities($supply_account['withdraw_apply']) :  '0'; ?></p>
        </div>
        <div class="content">
            <p class="title">总可用余额（元）<a href="<?php echo addon_url('supply://admin/account/balance'); ?>" class="subhead ns-text-color">查看</a></p>
            <p class="money"><?php echo !empty($supply_account['account']) ? htmlentities($supply_account['account']) :  '0'; ?></p>
        </div>
    </div>
</div>
<?php endif; ?>-->
