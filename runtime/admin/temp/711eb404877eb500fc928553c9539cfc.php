<?php /*a:2:{s:61:"/www/wwwroot/ls.chnssl.com/app/admin/view/config/captcha.html";i:1614515896;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
				<input type="checkbox" name="admin_login" value="1" lay-skin="switch" <?php if(!empty($config_info['admin_login']) && $config_info['admin_login'] == 1): ?> checked <?php endif; ?> />
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="shop_login" value="1" lay-skin="switch" <?php if(!empty($config_info['shop_login']) && $config_info['shop_login'] == 1): ?>checked <?php endif; ?> />
		</div>
	...
	<?php if(addon_is_exit('store')): ?>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="store_login" value="1" lay-skin="switch" <?php if(!empty($config_info['store_login']) && $config_info['store_login'] == 1): ?>checked <?php endif; ?> />
			</div>
			<div class="ns-word-aux">设置门店登录验证码是否开启</div>
		</div>
	<?php endif; if(addon_is_exit('supply')): ?>
		<div class="layui-form-item">
			<label class="layui-form-label">是否启用供应商登录：</label>
			<div class="layui-input-block">
				<input type="checkbox" name="supply_login" value="1" lay-skin="switch" <?php if(!empty($config_info['supply_login']) && $config_info['supply_login'] == 1): ?>checked <?php endif; ?> />
			</div>
			<div class="ns-word-aux">设置供应商登录验证码是否开启</div>
		</div>
	<?php endif; if(addon_is_exit('city')): ?>
		<div class="layui-form-item">
			<label class="layui-form-label">是否启用城市分站登录：</label>
			<div class="layui-input-block">
				<input type="checkbox" name="city_login" value="1" lay-skin="switch" <?php if(!empty($config_info['city_login']) && $config_info['city_login'] == 1): ?>checked <?php endif; ?> />
			</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="shop_reception_login" value="1" lay-skin="switch" <?php if(!empty($config_info['shop_reception_login']) && $config_info['shop_reception_login'] == 1): ?>checked <?php endif; ?> />
		</div>
