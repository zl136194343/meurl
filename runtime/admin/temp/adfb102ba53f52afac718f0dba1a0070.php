<?php /*a:2:{s:74:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\goodscategory\lists.html";i:1616032148;s:59:"D:\phpstudy_pro\WWW\www.hunqin.com\app\admin\view\base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="table_one" data-index="<?php echo htmlentities($index); ?>" data-sort="<?php echo htmlentities($vo['sort']); ?>" data-cateid="<?php echo htmlentities($vo['category_id']); ?>">
				<div class="table_tr">
					<div class="table_td" style="width:60px">
						...
						<span class="switch ns-text-color js-switch" data-category-id="<?php echo htmlentities($vo['category_id']); ?>" data-level="<?php echo htmlentities($vo['level']); ?>" data-open="0">
							+
						</span>
					...
					<div class="table_td" style="flex:2">
						<?php echo htmlentities($vo['attr_class_name']); ?>
					</div>
					<div class="table_td" style="flex:2">
						<?php echo htmlentities($vo['commission_rate']); ?>%
					</div>
					<div class="table_td" style="flex:2">
				...
				<?php if(!(empty($vo['child_list']) || (($vo['child_list'] instanceof \think\Collection || $vo['child_list'] instanceof \think\Paginator ) && $vo['child_list']->isEmpty()))): ?>
					...
					<div class="table_tr">
						...
						<div class="table_td" style="flex:6.2">
							...
							<span class="switch ns-text-color js-switch" data-category-id="<?php echo htmlentities($second['category_id']); ?>" data-level="<?php echo htmlentities($second['level']); ?>" data-open="0" style="padding-right: 15px;">
								+
							</span>
							<?php else: ?>
						...
						<div class="table_td" style="flex:2">
							<?php echo htmlentities($second['attr_class_name']); ?>
						</div>
						<div class="table_td" style="flex:2">
							<?php echo htmlentities($second['commission_rate']); ?>%
						</div>
						<div class="table_td" style="flex:2">
					...
					<div class="table_three">
						...
						<div class="table_tr table_three_tr" data-sort="<?php echo htmlentities($third['sort']); ?>" data-cateid="<?php echo htmlentities($third['category_id']); ?>">
							<div class="table_td" style="width:30px">
							...
							<div class="table_td" style="flex:2">
								<?php echo htmlentities($third['attr_class_name']); ?>
							</div>
							<div class="table_td" style="flex:2">
								<?php echo htmlentities($third['commission_rate']); ?>%
							</div>
							<div class="table_td" style="flex:2">
