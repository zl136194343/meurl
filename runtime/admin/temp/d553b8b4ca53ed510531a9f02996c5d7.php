<?php /*a:2:{s:69:"/www/wwwroot/www.hunqin.com/app/admin/view/memberwithdraw/config.html";i:1614515920;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="is_auto_audit" lay-filter="is_auto_audit" value="1" lay-skin="switch" <?php if(!empty($config['value']) && $config['value']['is_auto_audit']==1): ?> checked <?php endif; ?> >
		</div>
	</div>
	<?php if($is_exist): ?>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="is_auto_transfer" lay-filter="is_auto_transfer" value="1" lay-skin="switch" <?php if(!empty($config['value']) && $config['value']['is_auto_transfer']==1): ?> checked <?php endif; ?> >
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="number" name="rate" value="<?php if(!empty($config['value'])): ?><?php echo htmlentities($config['value']['rate']); else: ?>0<?php endif; ?>" lay-verify="positivEinteger" autocomplete="off" class="layui-input ns-len-short">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-input-inline">
				<input type="number" name="min" value="<?php if(!empty($config['value'])): ?><?php echo !empty($config['value']['min']) ? htmlentities($config['value']['min']) : 0; else: ?>0<?php endif; ?>" lay-verify="growthInteger" autocomplete="off" class="layui-input ns-len-short">
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-input-inline">
				<?php foreach($transfer_type_list as $k => $v): ?>
					<input type="checkbox" name="transfer_type[]" title="<?php echo htmlentities($v); ?>" lay-skin="primary" value="<?php echo htmlentities($k); ?>" <?php if(!empty($config['value']) && stripos($config['value']['transfer_type'], $k) !== false): ?>checked<?php endif; ?>>
				<?php endforeach; ?>
			</div>
		</div>
	</div>
