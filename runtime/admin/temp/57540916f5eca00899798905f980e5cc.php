<?php /*a:2:{s:64:"/www/wwwroot/ls.chnssl.com/app/admin/view/member/investlist.html";i:1661333823;s:24:"app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
    layui.use(['form', 'element'], function() {
		...
		table = new Table({
            elem: '#charge_list',
            url: ns.url("admin/member/investlist"),
            cols: [
                [{
                    field: 'order_no',
                    title: '订单编号',
                ...
                }, 
                {
                    ...
                    templet: function(data) {
						if(data.status == 1){ return '未支付'} else{ return  '已支付'}
					}
                 },//{
                //     title: '操作',
                //     toolbar: '#action',
