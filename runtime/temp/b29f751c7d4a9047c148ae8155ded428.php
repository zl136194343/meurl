<?php /*a:2:{s:69:"/www/wwwroot/www.hunqin.com/addon/qiniu/admin/view/config/config.html";i:1614519834;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="access_key" placeholder="请输入Accesskey" lay-verify="required" value="<?php echo isset($info['value']['access_key']) ? htmlentities($info['value']['access_key']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="secret_key" placeholder="请输入Secretkey" lay-verify="required" value="<?php echo isset($info['value']['secret_key']) ? htmlentities($info['value']['secret_key']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="bucket" placeholder="请输入库的名称" lay-verify="required" value="<?php echo isset($info['value']['bucket']) ? htmlentities($info['value']['bucket']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="domain" placeholder="请输入domain" lay-verify="required" value="<?php echo isset($info['value']['domain']) ? htmlentities($info['value']['domain']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
        </div>
