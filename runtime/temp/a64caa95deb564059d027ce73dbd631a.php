<?php /*a:2:{s:83:"/www/wwwroot/ls.chnssl.com/addon/electronicsheet/shop/view/electronicsheet/add.html";i:1614520076;s:23:"app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="layui-form-item express_company">
				...
				<div class="layui-input-block ns-len-short">
					<select name="company_id" lay-verify="required" lay-filter="company_id">
						...
						<option value="<?php echo htmlentities($v['company_id']); ?>" class="company_id_<?php echo htmlentities($v['company_id']); ?>" data-value="<?php echo htmlentities($v['print_style']); ?>"><?php echo htmlentities($v['company_name']); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
