<?php /*a:2:{s:76:"/www/wwwroot/ls.chnssl.com/addon/fenxiao/admin/view/fenxiao/order_lists.html";i:1614520032;s:24:"app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use(['form', 'laydate'], function() {
		...
		table = new Table({
			...
			where:{
			    "fenxiao_id" : <?php echo htmlentities($fenxiao_id); ?>
			},
			cols: [
				[{
					title: '商品信息',
