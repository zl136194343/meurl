<?php /*a:2:{s:70:"/www/wwwroot/www.hunqin.com/addon/alioss/admin/view/config/config.html";i:1614520290;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" id="isOpen">
			<input type="checkbox" name="status" lay-filter="isOpen" value="1" lay-skin="switch" <?php if($info['is_use'] == 1): ?> checked <?php endif; ?> />
        </div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="access_key_id" lay-verify="required" placeholder="请输入Access Key ID" value="<?php echo isset($info['value']['access_key_id']) ? htmlentities($info['value']['access_key_id']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="access_key_secret" lay-verify="required" placeholder="请输入Access Key Secret" value="<?php echo isset($info['value']['access_key_secret']) ? htmlentities($info['value']['access_key_secret']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="bucket" lay-verify="required" placeholder="请输入存储空间的名称" value="<?php echo isset($info['value']['bucket']) ? htmlentities($info['value']['bucket']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="endpoint" lay-verify="required" placeholder="请输入endpoint" value="<?php echo isset($info['value']['endpoint']) ? htmlentities($info['value']['endpoint']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
        </div>
        <div class="ns-word-aux">Bucket地域endpoint</div>
    </div>

	<div class="layui-form-item">
		<label class="layui-form-label">是否开启自定义域名：</label>
		<div class="layui-input-block" >
			<input type="checkbox" name="is_domain" lay-filter="is_domain" value="1" lay-skin="switch" <?php if(!empty($info['value']['is_domain']) && $info['value']['is_domain'] == 1): ?> checked <?php endif; ?> />
		</div>
		<div class="ns-word-aux">默认选关闭，官方建议开启绑定域名，域名格式：http://xx.xxxx.com/（不可绑定当前网站域名，建议新开二级域名）</div>
	</div>
	<div class="layui-form-item domain-view" <?php if(empty($info['value']['is_domain']) ||  $info['value']['is_domain'] == 0): ?>style="display:none;"<?php endif; ?>>
		<label class="layui-form-label"><span class="required">*</span>domain：</label>
		<div class="layui-input-block">
			<input type="text" name="domain" lay-verify="domain" placeholder="请输入domain" value="<?php echo isset($info['value']['domain']) ? htmlentities($info['value']['domain']) : ''; ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
