<?php /*a:2:{s:64:"/www/wwwroot/ls.chnssl.com/addon/topic/admin/view/topic/add.html";i:1614519446;s:24:"app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box">
					...
					<input type="hidden" name="topic_adv" value="">
				</div>
			</div>
		</div>
	</div>
...
<script>
	layui.use(['form','laydate','colorpicker'], function() {
		...
		form.on("submit(save)",function(data){
			...
			//删除图片
			if(!data.field.topic_adv) webLogoUpload_upload.delete();
			
			$.ajax({
				url: ns.url("topic://admin/topic/add"),
				dataType: 'JSON',
				type: 'POST',
				data: data.field,
				success: function(res){
