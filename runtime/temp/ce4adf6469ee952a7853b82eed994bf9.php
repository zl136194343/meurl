<?php /*a:2:{s:69:"/www/wwwroot/ls.chnssl.com/addon/fenxiao/shop/view/fenxiao/index.html";i:1614520058;s:23:"app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
	...
	<div class="layui-card-body">
		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($shop_commission['real_goods_money']); ?></p>
			<p class="ns-member-title">分销订单总额（元）</p>
		</div>
		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($shop_commission['commission']); ?></p>
			<p class="ns-member-title">分销佣金总额（元）</p>
		</div>
		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($fenxiao_goods_num); ?></p>
