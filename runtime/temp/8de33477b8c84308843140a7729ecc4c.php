<?php /*a:2:{s:75:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/orderrefund/lists.html";i:1657528751;s:62:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/base.html";i:1657516832;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="https://ls.chnssl.com/app/admin/view/public/js/community/refund_list.js"></script>
<script>
    ...
    layui.use(['laypage','laydate','form', 'element'], function(){
        ...
        form.on('submit(batch_export)', function(data){
            // location.href = ns.url("community://shop/order/exportRefundOrder",data.field);

            $.ajax({
                type: 'post',
                dataType: 'json',
                url: ns.url("community://shop/orderrefund/exportrefundorder"),
                data: data.field,
                success: function (res) {

                }
            });
            window.open(ns.url("community://shop/orderrefund/export",{}))
    ...
    function getOrderList(){
        var url = ns.url("community://shop/orderrefund/lists", ns.urlReplace(location.hash.replace('#!', '')));
