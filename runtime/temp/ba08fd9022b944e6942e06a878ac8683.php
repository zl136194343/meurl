<?php /*a:2:{s:74:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/config/agreement.html";i:1665283739;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="layui-form-item apply">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="radio" name="is_agreement" value="1" lay-filter="level" title="显示" <?php if($agreement_info['is_agreement'] == 1): ?> checked <?php endif; ?>/>
                        <input type="radio" name="is_agreement" value="0" lay-filter="level" title="隐藏" <?php if($agreement_info['is_agreement'] != 1): ?> checked <?php endif; ?>/>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item apply_img">
                ...
                <div class="layui-input-block">
                    <div class="upload-img-block img-upload">
						<div class="upload-img-box <?php if(!(empty($agreement_info['img']) || (($agreement_info['img'] instanceof \think\Collection || $agreement_info['img'] instanceof \think\Paginator ) && $agreement_info['img']->isEmpty()))): ?>hover<?php endif; ?>">
							<div class="ns-upload-default" id="applyImg">
								<?php if($agreement_info['img']): ?>
								<div id="preview_applyImg" class="preview_img">
									<img layer-src src="<?php echo img($agreement_info['img']); ?>" class="img_prev"/>
								</div>
								<?php else: ?>
								<div class="upload">
							...
							<input type="hidden" name="img" value="<?php echo htmlentities($agreement_info['img']); ?>">
						</div>
                    </div>
                </div>
            </div>
    ...
    <div class="layui-card ns-card-common ns-card-brief">
        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="agreement_title" value="<?php echo htmlentities($document['title']); ?>" lay-verify="required" class="layui-input ns-len-mid new_pass" maxlength="18">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="hidden" name="agreement_content" id="agreement_content" value="<?php echo htmlentities($document['content']); ?>" />
                </div>
