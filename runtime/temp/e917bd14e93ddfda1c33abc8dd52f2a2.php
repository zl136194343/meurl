<?php /*a:2:{s:77:"/www/wwwroot/ls.chnssl.com/addon/electronicsheet/shop/view/config/config.html";i:1614520076;s:23:"app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="type" value="kdniao" title="快递鸟" <?php if($config_info['type'] == 'kdniao'): ?> checked="" <?php endif; ?> lay-filter="type">
                    <!--<input type="radio" name="type" value="cainiao" title="菜鸟"  <?php if($config_info['type'] == 'cainiao'): ?> checked="" <?php endif; ?> lay-filter="type">-->
                </div>
            </div>
            ...
            <div class="layui-form-item kdniao">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="kdniao_user_id" value="<?php echo htmlentities($config_info['kdniao_user_id']); ?>" class="layui-input ns-len-long">
                </div>
            </div>
            <div class="layui-form-item kdniao">
                <label class="layui-form-label">API key：</label>
                <div class="layui-input-inline">
                    <input type="text" name="kdniao_api_key" value="<?php echo htmlentities($config_info['kdniao_api_key']); ?>" class="layui-input ns-len-long">
                </div>
            </div>
            ...
            <div class="layui-form-item cainiao">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="cainiao_token" value="<?php echo htmlentities($config_info['cainiao_token']); ?>" class="layui-input ns-len-long">
                </div>
            </div>
    ...
    <div class="layui-card ns-card-common ns-card-brief">
        ...
        <div class="layui-card-body kdniao">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="kdniao_port" value="<?php echo htmlentities($config_info['kdniao_port']); ?>" class="layui-input ns-len-long">
                </div>
            </div>
            <!--<div class="layui-form-item">-->
        ...
        <div class="layui-card-body cainiao">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="cainiao_ip" value="<?php echo htmlentities($config_info['cainiao_ip']); ?>" class="layui-input ns-len-long">
                </div>
            </div>
        </div>
...
<script>
    ...
    var type = "<?php echo htmlentities($config_info['type']); ?>";
    if(type == 'kdniao'){
        $('.kdniao').show();
        $('.cainiao').hide();
    }else{
