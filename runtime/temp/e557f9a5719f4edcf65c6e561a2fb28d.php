<?php /*a:3:{s:67:"/www/wwwroot/ls.chnssl.com/addon/supply/shop/view/market/index.html";i:1616032466;s:59:"/www/wwwroot/ls.chnssl.com/addon/supply/shop/view/base.html";i:1614519506;s:39:"addon/supply/shop/view/market_head.html";i:1614519508;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://ls.chnssl.com/addon/supply/shop/view/public/css/index.css">
<style>
...
<div class="ns-supply-wrap">
	<div class="ns-supply-wrap-con">
		<link rel="stylesheet" href="https://ls.chnssl.com/addon/supply/shop/view/public/css/header.css">
	...
	<div class="ns-supply-header-search">
		<a href="<?php echo addon_url('supply://shop/market/index'); ?>">
			<div class="ns-supply-logo">
				<img src="<?php echo img($website_info['logo']); ?>" onerror="this.src='https://ls.chnssl.com/addon/supply/shop/view/public/img/logo.png'"/>
			</div>
		</a>
...
<script src="https://ls.chnssl.com/addon/supply/shop/view/public/js/common.js"></script>
<script>
					...
					<ul>
						...
						<li onclick="toGoodsList(<?php echo htmlentities($category_v['category_id']); ?>, <?php echo htmlentities($category_v['level']); ?>)">
							<div class="ns-cate-title">
								<div class="supplier-hide-text"><span><?php echo htmlentities($category_v['category_name']); ?></span></div>
		...
		<div class="ns-goods-li">
			<a href="{{ns.url('supply://shop/goods/detail?sku_id='+ item.sku_id)}}">
				<div class="ns-goods-img">
					<img src="{{ ns.img(item.goods_image.split(',')[0]) }}" onerror="this.src = 'https://ls.chnssl.com/addon/supply/shop/view/public/img/default_goods.png' " />
				</div>
			</a>
			<a href="{{ns.url('supply://shop/goods/detail?sku_id='+ item.sku_id)}}">
