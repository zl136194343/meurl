<?php /*a:2:{s:70:"/www/wwwroot/ls.chnssl.com/addon/bargain/shop/view/bargain/detail.html";i:1614520256;s:23:"app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-inline"><?php echo htmlentities($bargain_info['bargain_name']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">开始时间：</label>
		<div class="layui-input-inline"><?php echo date('Y-m-d H:i:s',$bargain_info['start_time']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">结束时间：</label>
		<div class="layui-input-inline"><?php echo date('Y-m-d H:i:s',$bargain_info['end_time']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">是否参与分销：</label>
		<div class="layui-input-inline"><?php if($bargain_info['is_fenxiao'] == 1): ?> 参与 <?php else: ?> 不参与 <?php endif; ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">购买方式：</label>
		<div class="layui-input-inline"><?php if($bargain_info['buy_type'] == 1): ?> 砍到指定价格 <?php else: ?> 任意金额可购买 <?php endif; ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">帮砍金额：</label>
		<div class="layui-input-inline"><?php if($bargain_info['bargain_type'] == 1): ?> 随机金额 <?php else: ?> 固定金额 <?php endif; ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">是否允许自己砍价：</label>
		<div class="layui-input-inline"><?php if($bargain_info['is_own'] == 1): ?> 是 <?php else: ?> 否 <?php endif; ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">帮砍人数：</label>
		<div class="layui-input-inline"><?php echo htmlentities($bargain_info['bargain_num']); ?></div>
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">砍价有效期：</label>
		<div class="layui-input-inline"><?php echo htmlentities($bargain_info['bargain_time']); ?> 小时</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-input-text"><?php echo htmlentities($bargain_info['remark']); ?></div>
	</div>
...
<script>
	var goods_list = <?php echo json_encode($bargain_info['goods_list'], JSON_UNESCAPED_UNICODE); ?>;
