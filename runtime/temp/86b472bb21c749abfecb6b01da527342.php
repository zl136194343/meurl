<?php /*a:2:{s:77:"/www/wwwroot/ls.chnssl.com/addon/freeshipping/shop/view/freeshipping/add.html";i:1614520024;s:23:"app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form" >
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="price" type="number" min="0" placeholder="请输入金额" lay-verify="required" class="layui-input ns-len-long" autocomplete="off">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-area-table">
			<table id="distributionArea" class="layui-table">
				...
				<tbody>
					<tr>
						<td colspan="2" class="ns-text-color add-distribution js-add-record">选择地区</td>
					</tr>
				</tbody>
			</table>
		</div>
...
<script type='text/javascript' src='https://ls.chnssl.com/addon/freeshipping/shop/view/public/js/freeshipping_template.js'></script>
