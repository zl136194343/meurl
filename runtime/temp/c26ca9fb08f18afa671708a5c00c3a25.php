<?php /*a:2:{s:71:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/fenxiao/lists.html";i:1614520032;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		table = new Table({
			...
			cols: [
				[{
					...
					unresize: 'false',
                    templet: function(data){
					    if(<?php echo htmlentities($basics_info['level']); ?> == 1 || <?php echo htmlentities($basics_info['level']); ?> == 0){
							return 0;
						}else if(<?php echo htmlentities($basics_info['level']); ?> == 2){
