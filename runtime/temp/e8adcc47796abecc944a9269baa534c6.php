<?php /*a:2:{s:71:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/fenxiao/index.html";i:1614520032;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
	<div class="layui-card-header">
		<span class="ns-card-title">佣金概览</span>
	</div>
	<div class="layui-card-body">
		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($fenxiao_account); ?></p>
			<p class="ns-member-title">累计佣金（元）</p>
		</div>

		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($account_data['account_withdraw_apply']); ?></p>
			<p class="ns-member-title">提现待审核（元）</p>
		</div>

		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($account_data['account_withdraw']); ?></p>
			<p class="ns-member-title">提现佣金（元）</p>
		</div>
	</div>
</div>
...
<div class="layui-card ns-card-common ns-card-brief">
	...
	<div class="layui-card-body">
		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($fenxiao_apply_num); ?></p>
			<p class="ns-member-title">待审核（人）</p>
		</div>

		<div class="ns-member">
			<p class="ns-member-num"><?php echo htmlentities($fenxiao_num); ?></p>
			<p class="ns-member-title">分销商（人）</p>
		</div>
	</div>
</div>
