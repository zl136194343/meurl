<?php /*a:2:{s:83:"/www/wwwroot/ls.chnssl.com/addon/pointexchange/admin/view/exchange_order/lists.html";i:1614519856;s:24:"app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
        ...
        table = new Table({
            ...
            where:{exchange_id:"<?php echo htmlentities($exchange_id); ?>"},
            cols: [
                [{
                    field: 'order_no',
                    title: '兑换单号',
