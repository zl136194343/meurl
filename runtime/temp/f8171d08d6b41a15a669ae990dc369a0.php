<?php /*a:2:{s:76:"/www/wwwroot/ls.chnssl.com/addon/memberregister/admin/view/config/index.html";i:1614519920;s:24:"app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="point" lay-verify="required|number|int" value="<?php if(empty( $config['value'])): ?>0<?php else: ?><?php echo htmlentities($config['value']['point']); ?><?php endif; ?>"
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="balance" lay-verify="required|number|flnum" value="<?php if(empty( $config['value'])): ?>0<?php else: ?><?php echo htmlentities($config['value']['balance']); ?><?php endif; ?>"
			 autocomplete="off" class="layui-input ns-len-short">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="growth" lay-verify="required|number|flnum" value="<?php if(empty( $config['value'])): ?>0<?php else: ?><?php echo htmlentities($config['value']['growth']); ?><?php endif; ?>" autocomplete="off" class="layui-input ns-len-short">
		</div>
