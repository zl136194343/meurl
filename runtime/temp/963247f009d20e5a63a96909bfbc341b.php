<?php /*a:2:{s:80:"/www/wwwroot/ls.chnssl.com/addon/fenxiao/admin/view/fenxiao/fenxiao_account.html";i:1614520030;s:24:"app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="ns-form">
    <div class="layui-card-body ns-item-block-parent ns-shop-account">
        ...
        <div class="ns-shop-detail">
            <p><strong>分销商：</strong><span class="ns-text-color-dark-gray"><?php echo htmlentities($fenxiao_info['fenxiao_name']); ?></span></p>
            <p><strong>上级分销商：</strong><span class="ns-text-color-dark-gray"><?php if($fenxiao_info['parent_name'] == ''): ?> 无 <?php else: ?><?php echo htmlentities($fenxiao_info['parent_name']); ?> <?php endif; ?></span></p>
            <p><strong>联系方式：</strong><span class="ns-text-color-dark-gray"><?php echo htmlentities($fenxiao_info['mobile']); ?></span></p>
            <p><strong>分销等级：</strong><span class="ns-text-color-dark-gray"><?php echo htmlentities($fenxiao_info['level_name']); ?></span></p>
        </div>
    </div>
</div>
...
<div class="layui-card ns-card-common ns-card-brief">
    ...
    <div class="layui-card-body">
        <div class="content">
            ...
            <p class="money"><?php echo htmlentities($fenxiao_info['account']); ?></p>
        </div>
        <div class="content">
            <p class="title">已提现佣金（元）</p>
            <p class="money"><?php echo htmlentities($fenxiao_info['account_withdraw']); ?></p>
        </div>
        <div class="content">
            <p class="title">提现中佣金（元）</p>
            <p class="money"><?php echo htmlentities($fenxiao_info['account_withdraw_apply']); ?></p>
        </div>
...
<script>
    ...
    layui.use(['form', 'laytpl', 'laydate'], function() {
        ...
        table = new Table({
            ...
            where:{'fenxiao_id':<?php echo htmlentities($fenxiao_id); ?>},
            cols: [
                [{
                    field: 'account_no',
                    title: '账单编号',
