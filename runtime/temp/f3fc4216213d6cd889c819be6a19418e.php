<?php /*a:2:{s:62:"/www/wwwroot/ls.chnssl.com/addon/gift/admin/view/gift/add.html";i:1614520012;s:24:"app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="gift_no" disabled lay-verify="required" placeholder="" value="<?php echo htmlentities($gift_no); ?>" class="layui-input ns-len-long">
        </div>
    </div>
