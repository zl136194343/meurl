<?php /*a:2:{s:70:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/fenxiao/team.html";i:1614520058;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="userdetail">
    <div class='ns-table-tuwen-box'>
        <div class='ns-img-box'>
            <img layer-src src="{{ns.img(d.headimg)}}" onerror="this.src = 'https://xyhl.chnssl.com/app/admin/view/public/img/default_headimg.png' ">
        </div>
...
<script>
    ...
    layui.use(['form', 'element'], function() {
        ...
        table = new Table({
            elem: '#team_list',
            url: ns.url("fenxiao://admin/fenxiao/team"),
