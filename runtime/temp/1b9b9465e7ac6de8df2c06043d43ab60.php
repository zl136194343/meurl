<?php /*a:2:{s:82:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/community/withdraw/lists.html";i:1658213655;s:62:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/base.html";i:1657516832;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <form class="layui-colla-content layui-form layui-show">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="commander_name" placeholder="请输入团长名" class="layui-input">
                    </div>
                </div>
...
<script>
    layui.use(['form', 'laytpl', 'laydate', 'element'], function() {
        ...
        table = new Table({
            ...
            url: ns.url("community://shop/community/withdrawlist"),
            cols: [
                [{
                    width: "3%",
                    type: 'checkbox',
                        ...
                        layer.prompt({
                            ...
                            yes: function (index, layero) {
                                ...
                                layer.confirm('确定要拒绝申请吗?', function() {
                                    $.ajax({
                                        url: ns.url("community://shop/community/withdrawrefuse"),
                                        data: {"verify_state_remark": value,'id':data.id},
                                        dataType: 'JSON',
                                        type: 'POST',
                                        success: function(res) {
                                            layer.msg(res.message);
        ...
        function applyPass(id) {
            ...
            layer.confirm('确定要通过申请吗?', function() {
                $.ajax({
                    url: ns.url("community://shop/community/withdrawpass"),
                    data: {'id':id},
                    dataType: 'JSON',
                    type: 'POST',
                    success: function(res) {
