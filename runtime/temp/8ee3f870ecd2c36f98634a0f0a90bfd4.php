<?php /*a:2:{s:75:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/config/settlement.html";i:1614520030;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <!--<div class="layui-form-item">-->
                ...
                <!--<div class="layui-input-block">-->
                    <!--<div class="layui-input-inline">-->
                        <!--<input type="radio" name="account_type" value="1" lay-filter="account_type" title="实际支付" <?php if($settlement_info['account_type'] == 1): ?> checked <?php endif; ?>/>-->
    ...
    <div class="layui-card ns-card-common ns-card-brief">
        ...
        <div class="layui-card-body">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="radio" name="withdraw_status" value="1" lay-filter="withdraw_type" title="手动审核" <?php if($withdraw_info['withdraw_status'] == 1): ?> checked <?php endif; ?> />
                        <input type="radio" name="withdraw_status" value="2" lay-filter="withdraw_type" title="自动审核" <?php if($withdraw_info['withdraw_status'] == 2): ?> checked <?php endif; ?>/>
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="number" name="withdraw" lay-verify="required" value="<?php echo htmlentities($withdraw_info['withdraw']); ?>" autocomplete="off" class="layui-input ns-len-short">
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="number" name="withdraw_rate" lay-verify="required" value="<?php echo htmlentities($withdraw_info['withdraw_rate']); ?>" autocomplete="off" class="layui-input ns-len-short">
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline ns-len-short ns-noboder-searchbox">
                        <input type="number" name="min_no_fee" lay-verify="required|number" value="<?php echo htmlentities($withdraw_info['min_no_fee']); ?>" autocomplete="off" class="layui-input ">
                    </div>
                    <span class="layui-form-mid">元&nbsp;&nbsp;至 </span>
                    <div class="layui-input-inline ns-len-short">
                        <input type="number" name="max_no_fee" lay-verify="required|number" value="<?php echo htmlentities($withdraw_info['max_no_fee']); ?>" autocomplete="off" class="layui-input ">
                    </div>
