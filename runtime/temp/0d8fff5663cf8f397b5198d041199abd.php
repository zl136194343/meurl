<?php /*a:2:{s:74:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/config/community.html";i:1657610162;s:62:"/www/wwwroot/ls.chnssl.com/addon/community/shop/view/base.html";i:1657516832;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-card-body">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" id="book_time" placeholder="请选择时间" autocomplete="off" value="<?php if($trade['book_time']): ?> <?php echo htmlentities($trade['book_time']); ?> <?php endif; ?>" readonly>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" class="layui-input" id="pickup_time" placeholder="请选择时间" autocomplete="off" value="<?php if($trade['pickup_time']): ?> <?php echo htmlentities($trade['pickup_time']); ?> <?php endif; ?>" readonly>
					<i class="ns-calendar"></i>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-input-inline">
						<input type="radio" name="delivery_type" value="1" title="当日达" autocomplete="off" class="layui-input ns-len-long" <?php if($trade['delivery_type'] == 1): ?> checked <?php endif; ?>>
						<input type="radio" name="delivery_type" value="2" title="次日达" autocomplete="off" class="layui-input ns-len-long" <?php if($trade['delivery_type'] == 2): ?> checked <?php endif; ?>>
						<input type="radio" name="delivery_type" value="3" title="隔日达" autocomplete="off" class="layui-input ns-len-long" <?php if($trade['delivery_type'] == 3): ?> checked <?php endif; ?>>
					</div>
				</div>
...
<script>
	var bookTime = "<?php echo htmlentities($trade['book_time']); ?>", pickupTime = "<?php echo htmlentities($trade['pickup_time']); ?>";
	if (Number(bookTime)){
