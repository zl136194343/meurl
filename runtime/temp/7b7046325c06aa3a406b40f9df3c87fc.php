<?php /*a:2:{s:70:"/www/wwwroot/ls.chnssl.com/addon/bundling/shop/view/bundling/edit.html";i:1614520242;s:23:"app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form" id="add_active">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="bl_name" value="<?php echo htmlentities($info['bl_name']); ?>" lay-verify="required" autocomplete="off" placeholder="请输入活动名称" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<table class="layui-table" id="goods" lay-skin="line" lay-size="lg">
				...
				<tbody>
					<?php if($info['bundling_goods']): foreach($name=$info['bundling_goods'] as $k => $v): ?>
							<tr data-sku_id="<?php echo htmlentities($v['sku_id']); ?>">
								<td><?php echo htmlentities($v['sku_name']); ?></td>
								<td class="price-one"><?php echo htmlentities($v['price']); ?></td>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block ns-form-row">
			<div class="layui-input-inline">
				<input type="number" name="bl_price" lay-verify="flo" value="<?php echo htmlentities($info['bl_price']); ?>" autocomplete="off" class="layui-input ns-len-small combined-price" min="0.00">
			</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<p class="ns-input-text"><span class="original-price"><?php echo htmlentities($info['goods_money']); ?></span>元</p>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="radio" name="shipping_fee_type" value="1" title="卖家承担运费" <?php echo $info['shipping_fee_type']==1 ? 'checked'  :  ''; ?>>
			<input type="radio" name="shipping_fee_type" value="2" title="买家承担运费（快递）" <?php echo $info['shipping_fee_type']==2 ? 'checked'  :  ''; ?>>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="status" lay-filter="isOpen" value="1" lay-skin="switch" <?php if($info['status']==1): ?>checked<?php endif; ?> />
		</div>
	</div>
	...
	<input type="hidden" name="bl_id" value="<?php echo htmlentities($bl_id); ?>" />
</div>
