<?php /*a:2:{s:82:"/www/wwwroot/ls.chnssl.com/addon/memberrecharge/admin/view/memberrecharge/add.html";i:1614519928;s:24:"app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="couponList">
	<div class="coupon-box">
		...
		<table class="layui-table" id="goods" lay-skin="line" lay-size="lg">
			...
			<tbody>
				<?php foreach($coupon_list['data'] as $coupon_list_k => $coupon_list_v): ?>
				<tr>
					<td class="ns-check-box">
						<div class="layui-form">
							{{# var a = <?php echo htmlentities($coupon_list_v['coupon_type_id']); ?> }}
							{{#  if($.inArray(a.toString(), d.coupon_id) != -1){  }}
							<input type="checkbox" name="" lay-filter="select<?php echo htmlentities($coupon_list_k); ?>" lay-skin="primary" checked>
							{{#  }else{  }}
							<input type="checkbox" name="" lay-filter="select<?php echo htmlentities($coupon_list_k); ?>" lay-skin="primary">
							{{#  }  }}
							<input type="hidden" id="coupon_id" value="<?php echo htmlentities($coupon_list_v['coupon_type_id']); ?>">
						</div>
					</td>
					<td>
						<div class="ns-table-tuwen-box">
							<div class="ns-img-box">
								<?php if($coupon_list_v['image']): ?>
								<img src="<?php echo img($coupon_list_v['image']); ?>">
								<?php endif; ?>
							</div>
							<div class="ns-font-box">
								<p class="ns-multi-line-hiding"><?php echo htmlentities($coupon_list_v['coupon_name']); ?></p>
							</div>
						</div>
					</td>
					<td class="layui-elip coupon-money"><?php echo htmlentities($coupon_list_v['money']); ?></td>
					<td class="layui-elip coupon-end-time"><?php echo time_to_date($coupon_list_v['end_time']); ?></td>
				</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
