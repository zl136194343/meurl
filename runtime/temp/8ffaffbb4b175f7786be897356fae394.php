<?php /*a:2:{s:70:"/www/wwwroot/www.hunqin.com/addon/fenxiao/admin/view/config/words.html";i:1614520030;s:24:"app/admin/view/base.html";i:1666314447;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="concept" lay-verify="required" <?php if(isset($config_info['concept'])): ?> value='<?php echo htmlentities($config_info['concept']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="fenxiao_name" lay-verify="required" <?php if(isset($config_info['fenxiao_name'])): ?> value='<?php echo htmlentities($config_info['fenxiao_name']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text"  name="withdraw" lay-verify="required" <?php if(isset($config_info['withdraw'])): ?> value='<?php echo htmlentities($config_info['withdraw']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text"  name="account" lay-verify="required" <?php if(isset($config_info['account'])): ?> value='<?php echo htmlentities($config_info['account']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text"  name="my_team" lay-verify="required" <?php if(isset($config_info['my_team'])): ?> value='<?php echo htmlentities($config_info['my_team']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text"  name="child" lay-verify="required" <?php if(isset($config_info['child'])): ?> value='<?php echo htmlentities($config_info['child']); ?>' <?php endif; ?> autocomplete="off" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	layui.use(['form'], function() {
		...
		form.on('submit(save)', function(data){
			...
			$.ajax({
				type: 'POST',
				dataType: 'JSON',
				url: ns.url("fenxiao://admin/config/words"),
				data: data.field,
				async: false,
				success: function(res){
					repeat_flag = false;
