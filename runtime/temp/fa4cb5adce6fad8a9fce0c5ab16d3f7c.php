<?php /*a:2:{s:72:"/www/wwwroot/ls.chnssl.com/addon/bundling/shop/view/bundling/detail.html";i:1614520242;s:23:"app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="ns-detail-card ns-tips">
	<div class="ns-detail-con">
		<p class="ns-detail-line">
			<span class="ns-goods-name"><?php echo htmlentities($info['data']['bl_name']); ?></span>
			<span class="ns-text-color">（<?php echo $info['data']['status']==1 ? '开启'  :  '关闭'; ?>）</span>
		</p>
		<p class="ns-detail-line">
			<span>套餐价格：￥<?php echo htmlentities($info['data']['bl_price']); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span>原价：￥<?php echo htmlentities($info['data']['goods_money']); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<span>节省价：￥<?php echo htmlentities($info['data']['goods_money'] - $info['data']['bl_price']); ?></span>
		</p>
		<p class="ns-detail-line">运费承担：<?php echo $info['data']['shipping_fee_type']==1 ? '卖家承担运费'  :  '买家承担运费（快递）'; ?></p>
	</div>
</div>
...
<table class="layui-table" id="goods" lay-skin="line" lay-size="lg">
	...
	<tbody>
		<?php foreach($name=$info['data']['bundling_goods'] as $k => $v): ?>
			<tr data-sku_id="<?php echo htmlentities($v['sku_id']); ?>">
				<td>
					<div class="ns-table-title">
					    <div class="ns-title-pic">
					        <img layer-src src="<?php echo img($v['sku_image']); ?>">
					    </div>
					    <div class="ns-title-content">
					        <p class="ns-multi-line-hiding"><?php echo htmlentities($v['sku_name']); ?></p>
					    </div>
					</div>
				</td>
				<td class="price-one" align="right">￥<?php echo htmlentities($v['price']); ?></td>
				<td align="right">￥<?php echo htmlentities($v['promotion_price']); ?></td>
			</tr>
		<?php endforeach; ?>
	</tbody>
</table>
