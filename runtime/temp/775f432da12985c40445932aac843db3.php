<?php /*a:2:{s:82:"/www/wwwroot/ls.chnssl.com/addon/supply/admin/view/supplyaccount/open_account.html";i:1614519480;s:24:"app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
    ...
    <div class="layui-card-body">
        ...
        <div class="content">
            <p class="title">供应商入驻总费用（元）</p>
            <p class="money"><?php echo htmlentities($account_data['open_fee']); ?></p>
        </div>
    </div>
</div>
    ...
    <div class="layui-form">
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" placeholder="供应商名称" name="site_name" autocomplete="off">
                </div>
...
<table id="open_account_list" lay-filter="open_account_list"></table>
...
<script>
    layui.use(['form', 'laydate'], function () {
         ...
         */
        table = new Table({
            elem: '#open_account_list',
            url: ns.url("supply://admin/supplyaccount/openaccount"),
            cols: [
                [{
                    field: 'account_no',
                    title: '账单编号',
