<?php /*a:2:{s:70:"/www/wwwroot/ls.chnssl.com/addon/wechat/admin/view/wechat/setting.html";i:1614519408;s:24:"app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<ul class="ns-progress-wrap">
			<li class="ns-progress-point">
				<div class="ns-progress-point-pic">
					<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/flow/register.png" alt="">
				</div>
				<p class="ns-progress-point-text">注册微信公众号</p>
			</li>
			<li class="ns-progress-point-arrow">
				<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/flow/arrow.png" alt="">
			</li>
			<li class="ns-progress-point">
				<div class="ns-progress-point-pic">
					<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/config_info.png" alt="">
				</div>
			...
			<li class="ns-progress-point">
				<div class="ns-progress-point-pic">
					<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/flow/public_number.png" alt="">
				</div>
			...
			<li class="ns-progress-point">
				<div class="ns-progress-point-pic">
					<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/flow/edition.png" alt="">
				</div>
			...
			<li class="ns-progress-point">
				<div class="ns-progress-point-pic">
					<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/flow/complete.png" alt="">
				</div>
			...
			<a class="ns-item-block ns-item-block-hover-a" href="<?php echo htmlentities($val['url']); ?>">
				<div class="ns-item-block-wrap">
					<div class="ns-item-pic">
						<img src="https://ls.chnssl.com/addon/wechat/admin/view/public/img/<?php echo htmlentities($val['img']); ?>">
					</div>
