<?php /*a:2:{s:89:"/www/wwwroot/ls.chnssl.com/addon/memberrecharge/admin/view/memberrecharge/card_lists.html";i:1614519928;s:24:"app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use(['form', 'element'], function() {
		...
		table = new Table({
			...
			where:{recharge_id:"<?php echo htmlentities($recharge_id); ?>"},
			cols: [
				[{
			    	field:'card_account',
					title: '充值卡号',
