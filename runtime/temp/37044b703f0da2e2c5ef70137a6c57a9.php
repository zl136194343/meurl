<?php /*a:2:{s:72:"/www/wwwroot/www.hunqin.com/addon/bundling/shop/view/bundling/lists.html";i:1614520242;s:23:"app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
			...
			table = new Table({
				...
				cols: [
					[ {
						...
						field: 'bl_price',
						title: '<span style="padding-right: 15px;">套餐价</span>',
						unresize: 'false',
						width: '15%',
						align: 'right',
						templet: function(data) {
							return '<span style="padding-right: 15px;">￥'+ data.bl_price +'</span>';
						}
					}, {
						field: 'goods_money',
						title: '<span style="padding-right: 15px;">市场价</span>',
						unresize: 'false',
						width: '12%',
						align: 'right',
						templet: function(data) {
