<?php /*a:2:{s:59:"/www/wwwroot/www.hunqin.com/app/shop/view/order/config.html";i:1614518478;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-card-body">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="radio" name="invoice_status" value="0" title="关闭" autocomplete="off" class="layui-input ns-len-long" <?php if(empty($config['invoice_status']) || $config['invoice_status'] == 0): ?> checked <?php endif; ?>>
					<input type="radio" name="invoice_status" value="1" title="开启" autocomplete="off" class="layui-input ns-len-long" <?php if(!empty($config['invoice_status']) && $config['invoice_status'] == 1): ?> checked <?php endif; ?>>
				</div>
			</div>
			<!--<div class="layui-form-item">-->
				...
				<!--<div class="layui-input-block">-->
					<!--<div class="layui-input-inline ns-len-short">-->
						<!--<input type="number" name="invoice_rate" min="0" lay-verify="required" value="<?php echo isset($config['invoice_rate']) ? htmlentities($config['invoice_rate']) : 0; ?>" placeholder="请输入税率"  autocomplete="off" class="layui-input ns-len-short">-->
					<!--</div>-->
			...
			<div class="layui-form-item invoice-content-block">
				...
				<div class="layui-input-inline invoice-content-box">
					<?php if(!empty($config['invoice_content'])): foreach($config['invoice_content'] as $k => $v): ?>
						<div class="item">
							<input type="text" name="invoice_content[]" lay-verify="required" value="<?php echo htmlentities($v); ?>" placeholder="请输入发票内容"  autocomplete="off" class="layui-input ns-len-short" >
			...
			<!--<div class="layui-form-item">-->
				...
				<!--<div class="layui-input-block">-->
					<!--<div class="layui-input-inline ns-len-short">-->
						<!--<input type="number" name="invoice_money" min="0" lay-verify="required" value="<?php echo isset($config['invoice_money']) ? htmlentities($config['invoice_money']) : 0; ?>" placeholder="请输入费用" autocomplete="off" class="layui-input ns-len-short">-->
					<!--</div>-->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-input-inline">
						<input type="checkbox" name="type[]" value="1" title="普通发票" lay-skin="primary" <?php if(!empty($config['type']) && in_array(1, $config['type'])): ?>checked<?php endif; ?>>
						<input type="checkbox" name="type[]" value="2" title="电子发票" lay-skin="primary"<?php if(!empty($config['type']) && in_array(2, $config['type'])): ?>checked<?php endif; ?>>
					</div>
				</div>
			</div>
			<div class="layui-form-item">
