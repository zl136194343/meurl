<?php /*a:2:{s:64:"/www/wwwroot/www.hunqin.com/app/shop/view/member/tixing_add.html";i:1668581365;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form-item js-new-attr-list">
						...
						<div class="layui-input-block">
							...
							<input type="hidden" name="id" id="id" value="<?php echo htmlentities($id); ?>" />
...
<!-- <script src="https://xyhl.chnssl.com/app/shop/view/public/js/formSelects-v4.js"></script>-->
<script>
        layui.config({
	...
	var html = '<tr class="goods-attr-tr goods-new-attr-tr">' +
		...
		'</td>' +
		'<td>' +
		 ' <select name="select_base_cityname['+num+']" id="select_base_cityname['+num+']" lay-filter="select_base_cityname['+num+']" xm-select="select_base_cityname['+num+']" xm-select-type="1"><option value="">请选择推送人员</option><?php if(is_array($brand_list) || $brand_list instanceof \think\Collection || $brand_list instanceof \think\Paginator): if( count($brand_list)==0 ) : echo "" ;else: foreach($brand_list as $key=>$vo): ?><option value="<?php echo htmlentities($vo['member_id']); ?>" name="<?php echo htmlentities($vo['name']); ?>"><?php echo htmlentities($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select>'+ 
		'</td>' +
		'<td>' +
