<?php /*a:2:{s:67:"/www/wwwroot/ls.chnssl.com/app/shop/view/shopjoin/guide_detail.html";i:1614516276;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
	...
	.ns-guide-title, .ns-guide-time {text-align: center;}
	.ns-guide-title {font-size: 25px; font-weight: 600; height: 50px; line-height: 50px;}
	.ns-guide-time {line-height: 24px;}
	.ns-guide-time {color: #999999;}
	.guide_content {padding: 10px 80px 0; }
</style>
...
<div class="layui-form ns-form">
	<p class="ns-guide-title"><?php echo htmlentities($guide_info['title']); ?></p>
	<p class="ns-guide-time"><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($guide_info['create_time'])? strtotime($guide_info['create_time']) : $guide_info['create_time'])); ?></p>
	<div class="guide_content">
        <?php echo html_entity_decode($guide_info['content']); ?>
	</div>
</div>
