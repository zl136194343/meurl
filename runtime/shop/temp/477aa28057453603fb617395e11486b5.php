<?php /*a:2:{s:57:"/www/wwwroot/ls.chnssl.com/app/shop/view/store/lists.html";i:1614516280;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-collapse ns-tips">
	<div class="layui-colla-item">
		...
		<ul class="layui-colla-content layui-show">
			...
			<?php if($store_is_exit == 1): ?>
			<li>通过以下链接前往门店管理中心<a href="<?php echo addon_url('store://store/login/login'); ?>" target="_blank" class="ns-text-color"> <?php echo addon_url('store://store/login/login'); ?></a></li>
			<?php endif; ?>
		</ul>
	</div>
</div>
...
<script type="text/html" id="store">
	<div class="ns-table-title">
		<div class="ns-title-pic">
			...
			{{#  }else{  }}
			<img layer-src src="<?php echo img($default_img['default_store_img']); ?>" alt="" class="img_size">
			{{#  }  }}
		</div>
		...
		table = new Table({
			...
			cols: [
				[{
					...
					width: '10%',
					templet:'#store_admin',
					hide: <?php echo htmlentities($store_is_exit); ?> ? false : true
				},{
					title: '创建时间',
					unresize: 'false',
					width: '10%',
