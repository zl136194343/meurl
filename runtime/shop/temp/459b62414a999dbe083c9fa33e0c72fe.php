<?php /*a:2:{s:58:"/www/wwwroot/www.hunqin.com/app/shop/view/login/login.html";i:1666231231;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="https://121.4.231.120/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="https://121.4.231.120/public/static/css/iconfont.css" />
	<link rel="stylesheet" type="text/css" href="https://121.4.231.120/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="https://121.4.231.120/app/shop/view/public/css/common.css" />
	<script src="https://121.4.231.120/public/static/js/jquery-3.1.1.js"></script>
	<script src="https://121.4.231.120/public/static/ext/layui/layui.js"></script>
	<script src="https://121.4.231.120/public/static/js/jquery.cookie.js"></script> 
	<script src="https://cdn.jsdelivr.net/npm/js-cookie@2/src/js.cookie.min.js"></script>
	<script>
		layui.use(['layer', 'upload', 'element'], function() {});
		var nsColor = '#FF6A00';
		window.ns_url = {
			baseUrl: "https://121.4.231.120/",
			route: ['<?php echo request()->module(); ?>', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
			IMGPATH:"https://121.4.231.120/app/shop/view/public/img/",
			site_id:"<?php echo isset($site_id) ? htmlentities($site_id) : 0; ?>"
		};
	</script>
	<script src="https://121.4.231.120/public/static/js/common.js"></script>
	<script src="https://121.4.231.120/app/shop/view/public/js/common.js"></script>
	<style>
		.ns-calendar{background: url("https://121.4.231.120/public/static/img/ns_calendar.png") no-repeat center / 16px 16px;}
...
<link rel="stylesheet" href="https://121.4.231.120/app/shop/view/public/css/login.css">
<style>
	/* .login-body{background-image: url("<?php echo img('https://121.4.231.120/app/shop/view/public/img/login/login_bg.png'); ?>"); background-size: cover;} */
</style>
...
<!--					<?php if(!(empty($website_info['logo']) || (($website_info['logo'] instanceof \think\Collection || $website_info['logo'] instanceof \think\Paginator ) && $website_info['logo']->isEmpty()))): ?>
					...
					<?php else: ?>
					<img src="https://121.4.231.120/app/shop/view/public/img/shop_logo.png">
					<?php endif; ?>-->
...
<!--		<h3>登录之后可进入店铺或申请入驻</h3>-->
		<div class="layui-form">
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="https://121.4.231.120/app/shop/view/public/img/login/login_username.png" alt="">
				</div>
				<input type="text" name="username" lay-verify="userName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
			</div>
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="https://121.4.231.120/app/shop/view/public/img/login/login_password.png" alt="">
				</div>
	...
	<!--<div class="ns-login-bottom">
		<a class="ns-footer-img" href="#"><img src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>https://121.4.231.120/public/static/img/copyright_logo.png<?php endif; ?>" /></a>
		<p>
