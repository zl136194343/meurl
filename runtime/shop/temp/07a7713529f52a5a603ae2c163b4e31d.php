<?php /*a:2:{s:57:"/www/wwwroot/ls.chnssl.com/app/shop/view/login/login.html";i:1660100797;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://ls.chnssl.com/app/shop/view/public/css/login.css">
<style>
	/* .login-body{background-image: url("<?php echo img('https://ls.chnssl.com/app/shop/view/public/img/login/login_bg.png'); ?>"); background-size: cover;} */
</style>
		...
		<div class="apply-header-box">
			<div class="apply-header-title">
				<a href="<?php echo url('shop/index/index'); ?>">
					...
					<?php endif; ?>
					<span class="ns-text-color">赞友情商户店铺端</span>
				</a>
			</div>
		...
		<div class="layui-form">
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="https://ls.chnssl.com/app/shop/view/public/img/login/login_username.png" alt="">
				</div>
				<input type="text" name="username" lay-verify="userName" placeholder="请输入用户名" autocomplete="off" class="layui-input">
			</div>
			<div class="login-input login-info">
				<div class="login-icon">
					<img src="https://ls.chnssl.com/app/shop/view/public/img/login/login_password.png" alt="">
				</div>
