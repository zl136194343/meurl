<?php /*a:2:{s:57:"/www/wwwroot/ls.chnssl.com/app/shop/view/account/fee.html";i:1614516184;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief">
    ...
    <div class="layui-card-body">
        <div class="content">
            ...
            <p class="money"><?php echo htmlentities($apply_data['shop_open_fee']); ?></p>
        </div>
        <div class="content">
            <p class="title">保证金</p>
            <p class="money"><?php echo htmlentities($apply_data['shop_baozhrmb']); ?></p>
        </div>
        <div class="content">
            <p class="title">
                到期时间
                <?php if(isset($apply_data['is_reopen']) && $apply_data['is_reopen']  == 2 && $apply_data['cert_id'] > 0): if($is_reopen == 1): ?>
                     <span class="subhead ns-text-color reopen_apply" >申请续签</span>
                    <?php else: ?>
                    <span class="subhead ns-text-color reopen_apply_detail" >申请续签</span>
                    <?php endif; elseif(isset($apply_data['is_reopen']) && $apply_data['is_reopen']  == 2 && $apply_data['cert_id'] == 0): ?>
                <span class="subhead ns-text-color shop_auth_apply" >申请续签</span>
                <?php endif; ?>
                <span class="subhead ns-text-color reopen-list">续签记录</span>
            </p>

            <p class="money"><?php echo htmlentities($apply_data['expire_time']); ?></p>
        </div>
...
<script>
    ...
    layui.use(['form', 'laytpl', 'laydate'], function() {
        ...
        function deleteApply(id) {
            ...
            layer.confirm('确定要删除续签申请记录吗?', function() {
                $.ajax({
