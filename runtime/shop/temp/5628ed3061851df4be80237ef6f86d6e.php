<?php /*a:2:{s:63:"/www/wwwroot/www.hunqin.com/app/shop/view/settlement/lists.html";i:1668588994;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-collapse ns-tips">
    <div class="layui-colla-item">
        ...
        <ul class="layui-colla-content layui-show">
            <li>1、平台设置店铺结算周期后，系统会按照设置定期进行结算</li>
...
<script>
    ...
    var table = new Table({
        elem: '#account_list',
        url: ns.url("shop/settlement/lists"),
        cols: [
            [{
                field:'settlement_no',
                title: '账单编号',
				...
				align: 'right',
                templet: function (res){
                    var shop_price = (parseFloat(res.shop_money) - parseFloat(res.refund_shop_money) - parseFloat(res.commission) + parseFloat(res.platform_coupon_money) - parseFloat(res.refund_platform_coupon_money));
                    var shop_moneys = 0;
                    if(shop_price){
    ...
    table.tool(function(obj) {
        ...
        switch (obj.event) {
            case 'detail': //编辑
                location.href = ns.url("shop/settlement/detail", {"id": data.id});
                break;
        }
    });
