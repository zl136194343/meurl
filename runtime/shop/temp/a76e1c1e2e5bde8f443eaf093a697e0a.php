<?php /*a:2:{s:65:"/www/wwwroot/www.hunqin.com/app/shop/view/verify/verify_card.html";i:1614516284;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="https://xyhl.chnssl.com/app/shop/view/public/css/verify.css" />
...
<script type="text/javascript">
    ...
    layui.use('form', function () {
        ...
        form.on('submit(search)', function(data){
            ...
            submitting = true;
            $.ajax({
                url: '<?php echo addon_url("shop/verify/verifyCard"); ?>',
                data: data.field,
                dataType: 'json',
                type: "post",
                success: function (res) {
    ...
    function verify(){
        ...
        is_submit = false;
        $.ajax({
            url: '<?php echo addon_url("shop/verify/verify"); ?>',
