<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\www.hunqin.com\app\shop\view\goods\edit_goods.html";i:1657078733;s:58:"D:\phpstudy_pro\WWW\www.hunqin.com\app\shop\view\base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="ns-tab layui-tab layui-tab-brief" lay-filter="goods_tab">
		<ul class="layui-tab-title">
			...
			<li lay-id="wenjuan" id="wenjuan" <?php if($goods_info['wj_off'] == 2): ?>style="display:none"<?php endif; ?>>问卷调查</li>
		</ul>
						...
						<div class="layui-form-item js-supplier">
							...
							<div class="layui-input-inline">
								<select name="supplier">
									...
									<option value="<?php echo htmlentities($vo['supplier_site_id']); ?>" <?php if($goods_info['supplier_id'] ==$vo['supplier_site_id']): ?>selected<?php endif; ?>><?php echo htmlentities($vo['title']); ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
								<input type="hidden" name="supplier_id" value="<?php echo htmlentities($goods_info['supplier_id']); ?>" />
							</div>
						</div>
						<?php endif; ?>
...
<div class="layui-card ns-card-common">
	...
	<div class="layui-card-body">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" >
				<input type="radio" name="is_sale" value="0" title="不展示" <?php if($goods_info['is_sale'] == 0): ?>checked<?php endif; ?>  lay-filter="is_sale">
				<input type="radio" name="is_sale" value="1" title="展示" <?php if($goods_info['is_sale'] == 1): ?>checked<?php endif; ?> lay-filter="is_sale">
			</div>
