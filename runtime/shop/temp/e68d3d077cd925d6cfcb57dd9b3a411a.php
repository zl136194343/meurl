<?php /*a:2:{s:64:"/www/wwwroot/www.hunqin.com/app/shop/view/settlement/detail.html";i:1668589039;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-collapse ns-tips">
    <div class="layui-colla-item">
        ...
        <ul class="layui-colla-content layui-show">
            <li>店铺收入金额 = 店铺结算总金额 - 店铺退款金额  + 平台优惠券平台承担金额 - 平台优惠券平台承担金额（退款部分）</li>
...
<div class="layui-card ns-card-common ns-card-brief">
    <div class="layui-card-header">
        <div>
            ...
            <span>账期时间：<?php echo date('Y-m-d H:i:s', $info['period_start_time']); ?> 至 <?php echo date('Y-m-d H:i:s', $info['period_end_time']); ?></span>
        </div>
    </div>
    <div class="layui-card-body">
        <div class="content">
            <p class="title">店铺收入金额（元）</p>
            <p class="money"><?php echo htmlentities($shop_money); ?></p>
        </div>
        <div class="content">
            <p class="title">店铺结算总金额（元）</p>
            <p class="money"><?php echo htmlentities($info['shop_money']); ?></p>
        </div>
        <div class="content">
            <p class="title">店铺退款金额（元）</p>
            <p class="money"><?php echo htmlentities($info['refund_shop_money']); ?></p>
        </div>
       <!-- <div class="content">
            <p class="title">佣金金额（元）</p>
            <p class="money"><?php echo htmlentities($info['commission']); ?></p>
        </div>-->
        <div class="content">
            <p class="title">平台抽成金额（元）</p>
            <p class="money"><?php echo htmlentities($money); ?></p>
        </div>
        <div class="content">
            <p class="title">平台结算总抽成（元）</p>
            <p class="money"><?php echo htmlentities($info['platform_money']); ?></p>
        </div>
        <div class="content">
            <p class="title">平台退款抽成（元）</p>
            <p class="money"><?php echo htmlentities($info['refund_platform_money']); ?></p>
        </div>
        <div class="content">
            <p class="title">平台优惠券平台承担金额（元）</p>
            <p class="money"><?php echo htmlentities($info['platform_coupon_money']); ?></p>
        </div>
        <div class="content">
            <p class="title">平台优惠券平台承担金额（退款部分）（元）</p>
            <p class="money"><?php echo htmlentities($info['refund_platform_coupon_money']); ?></p>
        </div>
    </div>
</div>
...
<script>
    layui.use(['laydate','form'], function () {
        ...
        var table = new Table({
            ...
            where:{id:"<?php echo htmlentities($info['id']); ?>"},
            cols: [
                [{
                    field: 'order_no',
                    title: '订单编号',
