<?php /*a:2:{s:66:"/www/wwwroot/ls.chnssl.com/app/shop/view/goodsbrand/add_brand.html";i:1614516198;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	layui.use(['form'], function() {
		...
		form.on('submit(save)', function (data) {
			...
			$.ajax({
				url: '<?php echo addon_url("shop/goodsbrand/addBrand"); ?>',
				data: data.field,
				dataType: 'json',
				type: 'post',
				success: function (res) {
