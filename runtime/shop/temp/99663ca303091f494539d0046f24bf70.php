<?php /*a:9:{s:61:"/www/wwwroot/www.hunqin.com/app/shop/view/delivery/lists.html";i:1614516190;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;s:72:"/www/wwwroot/www.hunqin.com/app/shop/view/order/order_common_action.html";i:1616032162;s:71:"/www/wwwroot/www.hunqin.com/app/shop/view/order/order_adjust_price.html";i:1614516208;s:65:"/www/wwwroot/www.hunqin.com/app/shop/view/order/order_action.html";i:1614516206;s:73:"/www/wwwroot/www.hunqin.com/app/shop/view/order/order_address_update.html";i:1614516206;s:83:"/www/wwwroot/www.hunqin.com/app/shop/view/storeorder/store_order_take_delivery.html";i:1614518768;s:74:"/www/wwwroot/www.hunqin.com/app/shop/view/order/order_delivery_action.html";i:1614516208;s:85:"/www/wwwroot/www.hunqin.com/app/shop/view/localorder/local_order_delivery_action.html";i:1614516202;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://xyhl.chnssl.com/app/shop/view/public/css/delivery_lists.css"/>
<style>
    ...
    <div class="layui-colla-item">
        ...
        <form class="layui-colla-content layui-form layui-show"  lay-filter="order_list">
            ...
            <div class="ns-form-row">
                <button class="layui-btn ns-bg-color" id="btn_search" lay-submit lay-filter="btn_search">筛选</button>
...
<script src="https://xyhl.chnssl.com/app/shop/view/public/js/deliver_lists.js"></script>
<script src="https://xyhl.chnssl.com/app/shop/view/public/js/lodop_funcs.js"></script>
<script type="text/javascript">
var laytpl;
var form;
//渲染模板引擎
...
<script type="text/javascript" src="https://xyhl.chnssl.com/app/shop/view/public/js/address.js"></script>
<script type="text/javascript" src="https://xyhl.chnssl.com/public/static/js/map_address.js"></script>
<style>
...
<script type="text/html" id="express_sheet">
    <div class="layui-form express-sheet">
        ...
        <div class="ns-form-row">
            <button type="button" class="layui-btn ns-bg-color" lay-submit lay-filter="express_sheet_save">点击确定</button>
        </div>
    </div>
</script>
<script>
        ...
        layer.open({
            ...
            success: function (layero, index) {
                ...
                $.ajax({
                    ...
                    success(res){
                        if (res.code >= 0){
                            ...
                            html += '</select>';
                            $(".express-sheet select[name='template_id']").html(html);
                            form.render();
                        }
                    }
                });
                ...
                form.on('submit(express_sheet_save)', function(data){
                    for (var i = 0; i < orderDataAll.length; i++){
                        data.field.order_id = orderDataAll[i].order_id;
