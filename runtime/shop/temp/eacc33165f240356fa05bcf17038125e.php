...
<link rel="stylesheet" href="https://xyhl.chnssl.com/app/shop/view/public/css/order_list.css"/>
<style>
...
<script src="https://xyhl.chnssl.com/app/shop/view/public/js/order_list.js"></script>
...
<script>
    ...
    function orderVerify(id){
        var url = ns.url("shop/order/verify", ns.urlReplace(location.hash.replace('#!', '')));
    ...
    function order_gh(id){
        var url = ns.url("shop/order/order_gh", ns.urlReplace(location.hash.replace('#!', '')));
    ...
    function order_tyj(id){
        var url = ns.url("shop/order/order_tyj", ns.urlReplace(location.hash.replace('#!', '')));
