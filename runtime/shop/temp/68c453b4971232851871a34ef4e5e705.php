<?php /*a:2:{s:65:"/www/wwwroot/www.hunqin.com/app/shop/view/member/operational.html";i:1668132849;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
layui.use(['form', 'laydate','laytpl'], function () {
	...
	var table = new Table({
		elem: '#member_list',
		url: ns.url("shop/member/operational"),
		cols: [
			[
				{
					title: '执行人员',
				...
				},
				{
					...
					templet: function (data) {
						return data.moblile == '' ? '--' : data.moblile;
					}
				}/*,
				{
					title: '是否在小程序端使用',
