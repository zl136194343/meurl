<?php /*a:2:{s:69:"/www/wwwroot/ls.chnssl.com/app/shop/view/express/express_company.html";i:1614516194;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="https://ls.chnssl.com/app/shop/view/public/css/express_company.css" />
<style>
...
<fieldset class="layui-elem-field layui-field-title">
	...
	<div class="layui-field-box shop-express-list">
		<?php foreach($company_shop_list as $company_shop_list_k => $company_shop_list_v): ?>
		<div class="express-company-block ns-border-color-gray">
			<div class="express-company-top">
				<img src="<?php echo img($company_shop_list_v['logo']); ?>" />
			</div>
			<div class="express-company-bottom">
				<div class="express-company-name" title="<?php echo htmlentities($company_shop_list_v['company_name']); ?>"><?php echo htmlentities($company_shop_list_v['company_name']); ?></div>
				<div class="express-company-operation">
					<input type="hidden" value="<?php echo htmlentities($company_shop_list_v['company_id']); ?>" class="company-id" />
					<input type="hidden" value="<?php echo htmlentities($company_shop_list_v['id']); ?>" class="id" />
...
<fieldset class="layui-elem-field layui-field-title">
	...
	<div class="layui-field-box">
		<?php foreach($company_list as $company_list_k => $company_list_v): ?>
		<div class="express-company-block ns-border-color-gray">
			<div class="express-company-top">
				<img src="<?php echo img($company_list_v['logo']); ?>" />
			</div>
			<div class="express-company-box">
				<div class="express-company-name" title="<?php echo htmlentities($company_list_v['company_name']); ?>"><?php echo htmlentities($company_list_v['company_name']); ?></div>
			</div>
			
			<div class="express-company-shade">
				<input type="hidden" value="<?php echo htmlentities($company_list_v['company_id']); ?>" id="company_id" />
...
<script>
	...
	function addCompany(e) {
		...
		// layer.confirm('确定要添加该物流公司吗?', function() {
			$.ajax({
				url: ns.url("shop/express/addExpressCompanyShop"),
				data: {
