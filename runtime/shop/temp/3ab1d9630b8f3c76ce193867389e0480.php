<?php /*a:2:{s:61:"/www/wwwroot/www.hunqin.com/app/shop/view/user/user_list.html";i:1614516282;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="action">
	<div class="ns-table-btn">
		...
		{{#  }else if(d.uid == '<?php echo htmlentities($shop_member_id); ?>'){ }}
		<span class="ns-cursor ns-text-color-dark-gray ns-margin">系统用户不可编辑</span>
		{{#  }else{ }}
