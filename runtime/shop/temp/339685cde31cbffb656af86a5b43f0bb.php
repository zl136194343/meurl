<?php /*a:2:{s:67:"/www/wwwroot/ls.chnssl.com/app/shop/view/diy/bottom_nav_design.html";i:1614516192;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://ls.chnssl.com/public/static/ext/diyview/css/bottom_nav_design.css" />
<style>
	.ns-footer{
		clear: both;
	}
			...
			<ul v-show="data.list.length>0" v-bind:style="{ backgroundColor : data.backgroundColor }">
				<li v-for="(item,index) in data.list" v-on:mouseover="mouseOver(index)" v-on:mouseout="mouseOut()">
					<div v-show="data.type == 1 || data.type == 2">
						<img v-bind:src="(selected == index ? (item.selectedIconPath? changeImgUrl(item.selectedIconPath) : 'https://ls.chnssl.com/public/static/ext/diyview/img/crack_figure.png') :  (item.iconPath? changeImgUrl(item.iconPath) : 'https://ls.chnssl.com/public/static/ext/diyview/img/crack_figure.png') )"/>
					</div>
...
<script src="https://ls.chnssl.com/public/static/ext/diyview/js/shop_bottom_nav.js"></script>
