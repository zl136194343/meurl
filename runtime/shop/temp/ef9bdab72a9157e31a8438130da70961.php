<?php /*a:2:{s:66:"/www/wwwroot/www.hunqin.com/app/shop/view/goods/edit_zy_goods.html";i:1669015306;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="layui-card ns-card-common">
					...
					<div class="layui-card-body">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="virtual_indate" value="<?php echo htmlentities($goods_info['virtual_indate']); ?>" placeholder="0" class="layui-input ns-len-short" lay-verify="virtual_indate" autocomplete="off">
							</div>
					...
					<div class="layui-card-body">
						...
						<div class="js-single-spec" <?php if(!(empty($goods_info['goods_spec_format']) || (($goods_info['goods_spec_format'] instanceof \think\Collection || $goods_info['goods_spec_format'] instanceof \think\Paginator ) && $goods_info['goods_spec_format']->isEmpty()))): ?>style="display:none;"<?php endif; ?>>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="cash_pledge" value="<?php echo htmlentities($goods_info['cash_pledge']); ?>" placeholder="0.00" class="layui-input ns-len-short" lay-verify="cash_pledge" autocomplete="off">
									<div class="layui-form-mid">元</div>
								</div>
								<div class="ns-word-aux">成本价将不会对前台会员展示，用于商家统计使用</div>
							</div>
						...
						<div class="js-more-spec" <?php if(!(empty($goods_info['goods_spec_format']) || (($goods_info['goods_spec_format'] instanceof \think\Collection || $goods_info['goods_spec_format'] instanceof \think\Paginator ) && $goods_info['goods_spec_format']->isEmpty()))): ?>style="display:block;"<?php endif; ?>>
							...
							<div class="layui-form-item batch-operation-sku">
								...
								<div class="layui-input-inline">
									...
									<span class="ns-text-color" data-field="cost_price" data-verify="cost_price">押金</span>
							...
							<div class="js-edit-sku-list">
								...
								<div data-index="<?php echo htmlentities($k); ?>">
									...
									<input type="hidden" name="edit_cash_pledge" value="<?php echo htmlentities($vo['cash_pledge']); ?>" />
					...
					<ul>
						...
						<li data-index="{{j}}" data-parent-index="{{i}}" >
							...
							<div class="img-wrap">
								...
								{{# }else{ }}
								<img src="https://xyhl.chnssl.com/app/shop/view/public/img/goods_spec_value_empty.png" alt="">
								{{# } }}
							</div>
							{{# } }}
...
<script type="text/html" id="skuTableTemplate">
	...
	<table class="layui-table">
		...
		<tr>
			...
			<td>
				<input type="text" name="cash_pledge" placeholder="押金" value="{{d.skuList[i].cash_pledge}}" lay-verify="sku_cash_pledge" class="layui-input ns-len-small" autocomplete="off" data-index="{{i}}">
			</td>
			<td>
...
<script src="https://xyhl.chnssl.com/app/shop/view/public/js/virtual_goods_zy_edit.js"></script>
<script src="https://xyhl.chnssl.com/app/shop/view/public/js/category_zy_select.js"></script>
