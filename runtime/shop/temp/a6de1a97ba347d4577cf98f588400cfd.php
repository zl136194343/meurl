<?php /*a:2:{s:59:"/www/wwwroot/ls.chnssl.com/app/shop/view/user/add_user.html";i:1614516280;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="layui-input-block ns-len-mid">
			<select name="group_id" lay-verify="groupid">
				...
				<?php foreach($group_list as $group_list_k => $group_list_v): ?>
					<option value="<?php echo htmlentities($group_list_v['group_id']); ?>"><?php echo htmlentities($group_list_v['group_name']); ?></option>
				<?php endforeach; ?>
			</select>
		</div>
	</div>
