        ...
        textImgStyleList:[
            {
                ...
                selectedSrc:STATICEXT+"/diyview/img/nav_style/img_link_hover"+url+".png"
            },
            {
                text: "文字超链接",
                value: "2",
                src: STATICEXT+"/diyview/img/nav_style/text_link.png",
                selectedSrc: STATICEXT+"/diyview/img/nav_style/text_link_hover"+url+".png"
            }
        ],
        textImgPositionList:[
            {
                ...
                selectedSrc:STATICEXT+"/diyview/img/nav_style/text_left_hover"+url+".png"
            },
            {
                text: "居中",
                value: "center",
                src: STATICEXT+"/diyview/img/nav_style/text_right.png",
                selectedSrc: STATICEXT+"/diyview/img/nav_style/text_right_hover"+url+".png"
            }
        ],
        //自定义组件集合
        data: []
