			...
			typeList: [
				{
					...
					selectedSrc:STATICEXT+"/diyview/img/nav_style/img_text_hover"+url+".png"
				},
				{
					label: "图片", 
					value: 2,
					src: STATICEXT+"/diyview/img/nav_style/img.png",
					selectedSrc:STATICEXT+"/diyview/img/nav_style/img_1"+url+".png"
				},
				{
					label: "文字",
					value: 3,
					src: STATICEXT+"/diyview/img/nav_style/font.png",
					selectedSrc:STATICEXT+"/diyview/img/nav_style/font_1"+url+".png"
				},
			],
