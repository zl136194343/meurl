...
//                break;
    ...
    public function refundData()
    {
        ...
        $order_goods_info_result = $order_refund_model->getRefundDetail($refund_condition);
    ...
    public function detail()
    {
        ...
        if ($order_goods_info_result[ "data" ]) {
            ...
            $shop_info_result = $shop_model->getShopInfo([ [ "site_id", "=", $order_goods_info_result[ "data" ][ 'site_id' ] ] ], "full_address");
            $shop_info = $shop_info_result[ "data" ];
            $order_goods_info_result[ "data" ][ "shop_address" ] = $shop_info[ "full_address" ];
        }
