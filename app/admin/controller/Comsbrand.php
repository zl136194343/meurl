...
class Comsbrand extends BaseAdmin
{
    /**
     * 商品品牌列表
     */
    public function lists()
    {
        if (request()->isAjax()) {
            ...
            return $this->fetch('community/goodsbrand/lists');
        }
    }
    ...
    public function addBrand()
    {
        if (request()->isAjax()) {
            ...
            return $this->fetch('community/goodsbrand/add_brand');
        }
    }
    ...
    public function editBrand()
    {
        ...
        if (request()->isAjax()) {
            ...
            return $this->fetch('community/goodsbrand/edit_brand');
        }
    }
