...
class Comsattr extends BaseAdmin

{
    ...
    public function lists()
    {
        if (request()->isAjax()) {
            ...
            $this->forthMenu();
            return $this->fetch('community/goodsattr/lists');
        }
    }
    ...
    public function editAttr()
    {
        ...
        if (request()->isAjax()) {
            ...
            return $this->fetch('community/goodsattr/edit_attr');
        }
    }
