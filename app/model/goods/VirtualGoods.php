...
class VirtualGoods extends BaseModel
{
     ...
     * @param $data
     */
    public function addGoods($data,$type=1)
    {
...
//                'sort' => $data['sort'],
            ...
            foreach ($data[ 'goods_sku_data' ] as $item) {
                ...
                /*dump($item);die;*/
                if($type == 2){
                    if(!empty($item['cash_pledge'])){
                        $sku_data['cash_pledge'] = ['cash_pledge'];
                    }
                    
                    $sku_data['is_lease'] = 1;
                    $common_data['cash_pledge'] = $data['cash_pledge'];
                }
     ...
     * @param $data
     */
    public function editGoods($data,$type=1)
    {
...
//                'sort' => $data['sort'],
            ...
            /*dump(array_merge($goods_data, $common_data));die;*/
            ...
            if (!empty($data[ 'goods_sku_data' ][ 0 ][ 'sku_id' ])) {
                ...
                if ($data[ 'spec_type_status' ] == 1) {
                    ...
                    foreach ($data[ 'goods_sku_data' ] as $item) {
                       ...
                       if($type == 2){
                           if(!empty($item['cash_pledge'])){
                               $sku_data['cash_pledge'] = $item['cash_pledge'];
                           }
