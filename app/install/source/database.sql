...
DROP TABLE IF EXISTS order_batch_delivery;
DROP TABLE IF EXISTS order_batch_delivery_log;
...
DROP TABLE IF EXISTS promotion_present_goods;
...
CREATE TABLE servicer_dialogue (
  ...
  `message` text NOT NULL COMMENT '消息内容 纯文本消息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客服对话内容';
ALTER TABLE servicer_dialogue
  ADD PRIMARY KEY (`id`),
  ADD KEY `index_create_day` (`create_day`) COMMENT '聊天日期索引';
ALTER TABLE servicer_dialogue
...
COLLATE utf8_general_ci,
COMMENT = '进货单';
ALTER TABLE wholesale_goods_cart
ADD INDEX IDX_wholesale_goods_cart_member_id (member_id);
...
ADD INDEX IDX_wechat_fans_tag (tag_id);
...
ADD INDEX IDX_weixin_fans (unionid, openid);
...
CREATE TABLE weapp_live_room (
  ...
  site_name varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '站点名称',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
CREATE TABLE verify (
  ...
  relate_id int(11) NOT NULL DEFAULT 0 COMMENT '业务关联id',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
COMMENT = '核销编码管理';
ALTER TABLE verify
ADD INDEX IDX_verify_is_verify (is_verify);
ALTER TABLE verify
ADD INDEX IDX_verify_site_id (site_id);
ALTER TABLE verify
ADD INDEX IDX_verify_verify_code (verify_code);
ALTER TABLE verify
ADD INDEX IDX_verify_verify_time (verify_time);
ALTER TABLE verify
ADD INDEX IDX_verify_verify_type (verify_type);
...
ADD INDEX IDX_verifier_member_id (member_id);
ALTER TABLE verifier
ADD INDEX IDX_verifier_site_id (site_id);
...
ADD INDEX IDX_user_log (`uid`, site_id);
CREATE TABLE `user` (
...
COMMENT = '站点后台用户表';
ALTER TABLE `user`
ADD INDEX IDX_user (group_id, app_module);
ALTER TABLE `user`
ADD INDEX IDX_user_member_id (member_id);
ALTER TABLE `user`
ADD INDEX IDX_user_site_id (site_id);
ALTER TABLE `user`
...
CREATE TABLE supply_settlement_period (
  ...
  supply_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  refund_supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '退款总金额',
...
CHARACTER SET utf8,
COLLATE utf8_general_ci;
ALTER TABLE supply_settlement_period
ADD UNIQUE INDEX period_no (period_no);
CREATE TABLE supply_settlement (
  ...
  site_name varchar(255) NOT NULL DEFAULT '' COMMENT '站点名称',
  order_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '订单总金额',
  supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '店铺金额',
  refund_platform_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '平台退款抽成',
  platform_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '平台抽成',
  refund_supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '店铺退款金额',
  refund_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '退款金额',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  period_start_time int(11) NOT NULL DEFAULT 0 COMMENT '账期开始时间',
  period_end_time int(11) NOT NULL DEFAULT 0 COMMENT '账期结束时间',
...
CHARACTER SET utf8,
COLLATE utf8_general_ci;
ALTER TABLE supply_settlement
ADD UNIQUE INDEX settlement_no_index (settlement_no);
...
CREATE TABLE supply_purchase_goods_item (
  ...
  price decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '期望单价',
...
CREATE TABLE supply_order_goods (
  ...
  supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '供应商实际金额',
  ...
  is_move int(11) NOT NULL DEFAULT 0 COMMENT '是否已经迁移过商品',
  refund_delivery_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '退款中包含的运费',
...
CREATE TABLE supply_order (
  ...
  supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '供应商金额',
  ...
  refund_supply_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '退款店铺金额',
...
COLLATE utf8_general_ci,
COMMENT = '供应商商品表';
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_brand_id (brand_id);
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_goods_class (goods_class);
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_is_delete (is_delete);
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_is_own_shop (is_own);
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_sort (sort);
ALTER TABLE supply_goods_sku
ADD INDEX IDX_supply_goods_website_id (website_id);
...
COLLATE utf8_general_ci,
COMMENT = '进货单';
ALTER TABLE supply_goods_cart
ADD INDEX IDX_supply_goods_uid (`uid`);
...
COLLATE utf8_general_ci,
COMMENT = '供应商商品表';
ALTER TABLE supply_goods
ADD INDEX IDX_supply_goods_sku_id (sku_id);
ALTER TABLE supply_goods
ADD INDEX IDX_supply_goods_brand_id (brand_id);
ALTER TABLE supply_goods
ADD INDEX IDX_supply_goods_category_id (category_id);
ALTER TABLE supply_goods
ADD INDEX IDX_supply_goods_goods_class (goods_class);
ALTER TABLE supply_goods
ADD INDEX IDX_supply_goods_is_delete (is_delete);
...
CREATE TABLE supply_apply (
  ...
  paying_money_certificate varchar(255) NOT NULL DEFAULT '' COMMENT '付款凭证',
  paying_money_certificate_explain varchar(255) NOT NULL DEFAULT '' COMMENT '付款凭证说明',
  paying_deposit decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '保证金',
  paying_apply decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '开店费用',
  paying_amount decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '付款金额',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  audit_time int(11) NOT NULL DEFAULT 0 COMMENT '审核通过时间',
...
CREATE TABLE supplier (
  ...
  bond decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '保证金',
...
CREATE TABLE store_settlement (
  ...
  refund_platform_coupon_money decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '平台优惠券平台承担金额(退款部分)',
  offline_platform_coupon_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  offline_refund_platform_coupon_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
ADD INDEX IDX_stat_shop_day (`day`);
ALTER TABLE stat_shop
ADD INDEX IDX_stat_shop_day_time (day_time);
ALTER TABLE stat_shop
ADD INDEX IDX_stat_shop_month (`month`);
ALTER TABLE stat_shop
ADD INDEX IDX_stat_shop_site_id (site_id);
ALTER TABLE stat_shop
ADD INDEX IDX_stat_shop_year (`year`);
ALTER TABLE stat_shop
ADD UNIQUE INDEX `year` (site_id, `year`, `month`, `day`);
...
CREATE TABLE site_diy_view (
  ...
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  update_time int(11) NOT NULL DEFAULT 0 COMMENT '修改时间',
  `type` varchar(255) NOT NULL DEFAULT 'admin' COMMENT '应用模块:admin、shop、city、store',
...
CHARACTER SET utf8,
COLLATE utf8_general_ci;
ALTER TABLE shop_settlement_period
ADD UNIQUE INDEX period_no (period_no);
...
CREATE TABLE shop_group (
  ...
  menu_array text DEFAULT NULL COMMENT '功能权限',
  addon_array text DEFAULT NULL COMMENT '营销插件',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  modify_time int(11) NOT NULL DEFAULT 0 COMMENT '修改时间',
...
CREATE TABLE servicer_dialogue (
  ...
  relate_data varchar(3000) NOT NULL DEFAULT '' COMMENT '相关数据 json格式',
  content text NOT NULL COMMENT '聊天内容',
  `message` text NOT NULL COMMENT '消息内容 纯文本消息' AFTER `content`,
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
CREATE TABLE servicer (
  ...
  avatar varchar(500) NOT NULL DEFAULT '' COMMENT '客服头像',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
ADD INDEX IDX_promotion_topic_goods_end_time (end_time);
ALTER TABLE promotion_topic_goods
ADD INDEX IDX_promotion_topic_goods_site_id (site_id);
ALTER TABLE promotion_topic_goods
ADD INDEX IDX_promotion_topic_goods_sku_id (sku_id);
ALTER TABLE promotion_topic_goods
ADD INDEX IDX_promotion_topic_goods_start_time (start_time);
ALTER TABLE promotion_topic_goods
ADD INDEX IDX_promotion_topic_goods_topic_id (topic_id);
...
COLLATE utf8_general_ci,
COMMENT = '秒杀活动';
CREATE TABLE promotion_present_goods (
  id int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  site_id int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '店铺id',
  present_id int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '主键',
  sku_id int(11) NOT NULL DEFAULT 0 COMMENT '商品sku_id',
  goods_id int(11) NOT NULL DEFAULT 0 COMMENT '商品id',
...
ADD INDEX IDX_promotion_present_goods_id (goods_id);
ALTER TABLE promotion_present
ADD INDEX IDX_promotion_present_site_id (site_id);
ALTER TABLE promotion_present
ADD INDEX IDX_promotion_present_status (status);
...
COLLATE utf8_general_ci,
COMMENT = '优惠券表';
ALTER TABLE promotion_platformcoupon
ADD INDEX IDX_promotion_platformcoupon_end_time (end_time);
ALTER TABLE promotion_platformcoupon
ADD INDEX IDX_promotion_platformcoupon_member_id (member_id);
ALTER TABLE promotion_platformcoupon
ADD INDEX IDX_promotion_platformcoupon_platformcoupon_type_id (platformcoupon_type_id);
...
ADD INDEX IDX_promotion_manjian_goods_end_time (end_time);
ALTER TABLE promotion_manjian_goods
ADD INDEX IDX_promotion_manjian_goods_goods_id (goods_id);
ALTER TABLE promotion_manjian_goods
ADD INDEX IDX_promotion_manjian_goods_manjian_id (manjian_id);
ALTER TABLE promotion_manjian_goods
ADD INDEX IDX_promotion_manjian_goods_manjian_type (manjian_type);
ALTER TABLE promotion_manjian_goods
ADD INDEX IDX_promotion_manjian_goods_start_time (start_time);
...
ADD INDEX IDX_promotion_manjian_end_time (end_time);
ALTER TABLE promotion_manjian
ADD INDEX IDX_promotion_manjian_manjian_type (manjian_type);
ALTER TABLE promotion_manjian
ADD INDEX IDX_promotion_manjian_site_id (site_id);
ALTER TABLE promotion_manjian
ADD INDEX IDX_promotion_manjian_start_time (start_time);
ALTER TABLE promotion_manjian
ADD INDEX IDX_promotion_manjian_status (status);
ALTER TABLE promotion_manjian
ADD INDEX IDX_promotion_manjian_type (`type`);
...
ADD INDEX IDX_promotion_groupbuy_end_time (end_time);
ALTER TABLE promotion_groupbuy
ADD INDEX IDX_promotion_groupbuy_goods_id (goods_id);
ALTER TABLE promotion_groupbuy
ADD INDEX IDX_promotion_groupbuy_site_id (site_id);
ALTER TABLE promotion_groupbuy
ADD INDEX IDX_promotion_groupbuy_start_time (start_time);
ALTER TABLE promotion_groupbuy
ADD INDEX IDX_promotion_groupbuy_status (status);
...
ADD INDEX IDX_promotion_games_end_time (end_time);
ALTER TABLE promotion_games
ADD INDEX IDX_promotion_games_game_type (game_type);
ALTER TABLE promotion_games
ADD INDEX IDX_promotion_games_site_id (site_id);
ALTER TABLE promotion_games
ADD INDEX IDX_promotion_games_start_time (start_time);
ALTER TABLE promotion_games
ADD INDEX IDX_promotion_games_status (status);
...
CREATE TABLE promotion_exchange_order (
  ...
  gift_order_id int(11) NOT NULL DEFAULT 0 COMMENT '关联订单id',
  PRIMARY KEY (order_id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
ADD INDEX IDX_promotion_discount_goods_discount_id (discount_id);
ALTER TABLE promotion_discount_goods
ADD INDEX IDX_promotion_discount_goods_end_time (end_time);
ALTER TABLE promotion_discount_goods
ADD INDEX IDX_promotion_discount_goods_goods_id (goods_id);
ALTER TABLE promotion_discount_goods
ADD INDEX IDX_promotion_discount_goods_sku_id (sku_id);
ALTER TABLE promotion_discount_goods
ADD INDEX IDX_promotion_discount_goods_start_time (start_time);
...
ADD INDEX IDX_promotion_discount_end_time (end_time);
ALTER TABLE promotion_discount
ADD INDEX IDX_promotion_discount_start_time (start_time);
ALTER TABLE promotion_discount
ADD INDEX IDX_promotion_discount_status (status);
...
ADD INDEX IDX_promotion_coupon_type_site_id (site_id);
...
ADD INDEX IDX_promotion_coupon_coupon_type_id (coupon_type_id);
ALTER TABLE promotion_coupon
ADD INDEX IDX_promotion_coupon_end_time (end_time);
ALTER TABLE promotion_coupon
ADD INDEX IDX_promotion_coupon_member_id (member_id);
ALTER TABLE promotion_coupon
ADD INDEX IDX_promotion_coupon_site_id (site_id);
...
ADD INDEX IDX_promotion_bundling_goods_bl_id (bl_id);
ALTER TABLE promotion_bundling_goods
ADD INDEX IDX_promotion_bundling_goods_site_id (site_id);
ALTER TABLE promotion_bundling_goods
ADD INDEX IDX_promotion_bundling_goods_sku_id (sku_id);
...
ADD INDEX IDX_promotion_bundling_site_id (site_id);
ALTER TABLE promotion_bundling
ADD INDEX IDX_promotion_bundling_status (status);
...
ADD INDEX IDX_promotion_bargain_record_bargain_time (bargain_time);
ALTER TABLE promotion_bargain_record
ADD INDEX IDX_promotion_bargain_record_launch_id (launch_id);
ALTER TABLE promotion_bargain_record
ADD INDEX IDX_promotion_bargain_record_member_id (member_id);
...
ADD INDEX IDX_promotion_bargain_launch_bargain_id (bargain_id);
ALTER TABLE promotion_bargain_launch
ADD INDEX IDX_promotion_bargain_launch_end_time (end_time);
ALTER TABLE promotion_bargain_launch
ADD INDEX IDX_promotion_bargain_launch_goods_id (goods_id);
ALTER TABLE promotion_bargain_launch
ADD INDEX IDX_promotion_bargain_launch_site_id (site_id);
ALTER TABLE promotion_bargain_launch
ADD INDEX IDX_promotion_bargain_launch_sku_id (sku_id);
ALTER TABLE promotion_bargain_launch
ADD INDEX IDX_promotion_bargain_launch_start_time (start_time);
...
ADD INDEX IDX_promotion_bargain_goods_bargain_id (bargain_id);
ALTER TABLE promotion_bargain_goods
ADD INDEX IDX_promotion_bargain_goods_goods_id (goods_id);
ALTER TABLE promotion_bargain_goods
ADD INDEX IDX_promotion_bargain_goods_is_own (is_own);
ALTER TABLE promotion_bargain_goods
ADD INDEX IDX_promotion_bargain_goods_sku_id (sku_id);
ALTER TABLE promotion_bargain_goods
ADD INDEX IDX_promotion_bargain_goods_status (status);
...
ADD INDEX IDX_promotion_bargain_end_time (end_time);
ALTER TABLE promotion_bargain
ADD INDEX IDX_promotion_bargain_start_time (start_time);
...
CREATE TABLE pc_floor (
  ...
  `value` text DEFAULT NULL COMMENT '配置',
  `state` tinyint(4) NOT NULL DEFAULT 1 COMMENT '状态（0：禁用，1：启用）',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  sort int(11) NOT NULL DEFAULT 0 COMMENT '排序号',
  PRIMARY KEY (id)
...
ADD INDEX UK_pay_refund_out_trade_no (out_trade_no);
CREATE TABLE pay (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  site_id int(11) NOT NULL DEFAULT 0 COMMENT '站点id',
...
COMMENT = '支付记录';
ALTER TABLE pay
ADD UNIQUE INDEX UK_pay_out_trade_no (out_trade_no);
...
CREATE TABLE order_goods (
  ...
  is_fenxiao int(11) NOT NULL DEFAULT 1 COMMENT '是否参与分销',
  PRIMARY KEY (order_goods_id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
COLLATE utf8_general_ci,
COMMENT = '订单平台维权投诉';
CREATE TABLE order_batch_delivery_log (
  id int(11) NOT NULL AUTO_INCREMENT,
  site_id int(11) NOT NULL DEFAULT 0,
  batch_id int(11) NOT NULL DEFAULT 0 COMMENT '上传文件id',
  order_no varchar(255) NOT NULL DEFAULT '' COMMENT '订单编号',
  order_name varchar(255) NOT NULL DEFAULT '' COMMENT '订单内容',
  reason varchar(255) NOT NULL DEFAULT '' COMMENT '原因',
  `type` varchar(255) NOT NULL DEFAULT '' COMMENT '结果  success  成功  fail  失败',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
COLLATE utf8_general_ci,
COMMENT = '订单批量发货导入明细';
CREATE TABLE order_batch_delivery (
  ...
  batch_no varchar(255) NOT NULL DEFAULT '' COMMENT '记录编号',
...
CREATE TABLE `order` (
  ...
  refund_platform_coupon_total_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  refund_platform_coupon_shop_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  refund_platform_coupon_money decimal(10, 2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (order_id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
COMMENT = '订单表';
ALTER TABLE `order`
ADD INDEX IDX_order_create_time (create_time);
ALTER TABLE `order`
ADD INDEX IDX_order_finish_time (finish_time);
ALTER TABLE `order`
ADD INDEX IDX_order_is_tax_invoice (is_tax_invoice);
ALTER TABLE `order`
ADD INDEX IDX_order_member_id (member_id);
ALTER TABLE `order`
ADD INDEX IDX_order_order_from (order_from);
ALTER TABLE `order`
ADD INDEX IDX_order_order_status (order_status);
ALTER TABLE `order`
ADD INDEX IDX_order_order_type (order_type);
ALTER TABLE `order`
ADD INDEX IDX_order_pay_status (pay_status);
ALTER TABLE `order`
ADD INDEX IDX_order_promotion_id (promotion_id);
CREATE TABLE notice (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
ADD INDEX IDX_notes_dianzan_record_member_id (member_id);
ALTER TABLE notes_dianzan_record
ADD INDEX IDX_notes_dianzan_record_note_id (note_id);
CREATE TABLE notes (
...
COMMENT = '店铺笔记';
ALTER TABLE notes
ADD INDEX IDX_promotion_notes_group_id (group_id);
ALTER TABLE notes
ADD INDEX IDX_promotion_notes_site_id (site_id);
...
COMMENT = '菜单表';
ALTER TABLE menu
ADD INDEX IDX_menu_app_module (app_module);
ALTER TABLE menu
ADD INDEX IDX_menu_is_control (is_control);
ALTER TABLE menu
ADD INDEX IDX_menu_is_show (is_show);
ALTER TABLE menu
ADD INDEX IDX_menu_name (name);
ALTER TABLE menu
ADD INDEX IDX_menu_parent (parent);
ALTER TABLE menu
ADD INDEX IDX_menu_url (url);
...
ADD INDEX IDX_member_account_account_type (account_type);
ALTER TABLE member_account
ADD INDEX IDX_member_account_create_time (create_time);
ALTER TABLE member_account
ADD INDEX IDX_member_account_from_type (from_type);
ALTER TABLE member_account
ADD INDEX IDX_member_account_member_id (member_id);
CREATE TABLE member (
...
COMMENT = '系统用户表';
ALTER TABLE member
ADD INDEX IDX_member_weapp_openid (weapp_openid);
ALTER TABLE member
...
CREATE TABLE goods_sku (
  ...
  supply_goods_id int(11) NOT NULL DEFAULT 0,
  supply_sku_id int(11) NOT NULL DEFAULT 0 COMMENT '关联供应商sku_id',
...
ADD INDEX IDX_goods_brand_id (brand_id);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_goods_class (goods_class);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_is_delete (is_delete);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_is_own_shop (is_own);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_site_id (site_id);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_sort (sort);
ALTER TABLE goods_sku
ADD INDEX IDX_goods_website_id (website_id);
...
ADD INDEX IDX_goods_collect_member_id (member_id);
ALTER TABLE goods_collect
ADD INDEX IDX_goods_collect_sku_id (sku_id);
CREATE TABLE goods_category (
  ...
  supply_commission_rate decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '供应商的佣金比率',
  PRIMARY KEY (category_id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
ADD INDEX IDX_goods_cart_member_id (member_id);
...
ADD INDEX IDX_goods_browse_member_id (member_id);
ALTER TABLE goods_browse
ADD INDEX IDX_goods_browse_sku_id (sku_id);
...
CREATE TABLE goods_attribute (
  ...
  attr_value_list varchar(500) NOT NULL DEFAULT '' COMMENT '属性值列表（'',''隔开注意键值对）',
  attr_value_format varchar(5000) NOT NULL DEFAULT '' COMMENT '属性值格式json',
...
CREATE TABLE goods (
  ...
  keywords varchar(255) NOT NULL DEFAULT '' COMMENT '关键词',
  unit varchar(255) NOT NULL DEFAULT '' COMMENT '单位',
  sort int(11) NOT NULL DEFAULT 0 COMMENT '权重（平台排序 ）',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  modify_time int(11) NOT NULL DEFAULT 0 COMMENT '修改时间',
  video_url varchar(555) NOT NULL DEFAULT '' COMMENT '视频',
  commission_rate decimal(10, 2) NOT NULL DEFAULT 0.00 COMMENT '分佣比率(按照分类)',
  ...
  timer_on int(11) NOT NULL DEFAULT 0 COMMENT '定时上架',
  timer_off int(11) NOT NULL DEFAULT 0 COMMENT '定时下架',
  supply_goods_id int(11) NOT NULL DEFAULT 0 COMMENT '关联供应商商品id',
  discount_config tinyint(1) NOT NULL DEFAULT 0 COMMENT '优惠设置（0默认 1自定义）',
  discount_method varchar(20) NOT NULL DEFAULT '' COMMENT '优惠方式（discount打折 manjian 满减 fixed_price 指定价格）',
  sku_id int(11) NOT NULL DEFAULT 0 COMMENT 'sku_id',
  promotion_addon varchar(255) NOT NULL DEFAULT '' COMMENT '当前参与的营销活动，逗号分隔（限时折扣、团购、拼团、秒杀、专题活动）',
  category_name varchar(255) NOT NULL DEFAULT '' COMMENT '商品分类',
  recommend_way int(11) NOT NULL DEFAULT 0 COMMENT '推荐方式，1：新品，2：精品，3；推荐',
  PRIMARY KEY (goods_id)
)
ENGINE = INNODB,
...
ADD INDEX IDX_goods_brand_id (brand_id);
ALTER TABLE goods
ADD INDEX IDX_goods_category_id (category_id);
ALTER TABLE goods
ADD INDEX IDX_goods_goods_class (goods_class);
ALTER TABLE goods
ADD INDEX IDX_goods_is_delete (is_delete);
...
ADD INDEX IDX_goods_site_id (site_id);
ALTER TABLE goods
ADD INDEX IDX_goods_sku_id (sku_id);
ALTER TABLE goods
ADD INDEX IDX_goods_sort (sort);
ALTER TABLE goods
ADD INDEX IDX_goods_website_id (website_id);
...
ADD INDEX IDX_fenxiao_goods_collect_member_id (member_id);
ALTER TABLE fenxiao_goods_collect
ADD INDEX IDX_fenxiao_goods_collect_sku_id (sku_id);
...
CREATE TABLE fenxiao (
  ...
  is_delete tinyint(1) NOT NULL DEFAULT 0 COMMENT '会员注销',
...
COMMENT = '分销商表';
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_audit_time (audit_time);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_create_time (create_time);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_grand_parent (grand_parent);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_level_id (level_id);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_member_id (member_id);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_parent (parent);
ALTER TABLE fenxiao
ADD INDEX IDX_fenxiao_status (status);
...
ADD INDEX IDX_express_template_item_fee_type (fee_type);
ALTER TABLE express_template_item
ADD INDEX IDX_express_template_item_template_id (template_id);
...
ADD INDEX IDX_express_template_is_default (is_default);
...
ADD INDEX IDX_express_delivery_package_order_id (order_id);
ALTER TABLE express_delivery_package
ADD INDEX IDX_express_delivery_package_site_id (site_id);
...
CREATE TABLE express_company (
  company_id int(11) NOT NULL AUTO_INCREMENT COMMENT '物流公司id',
  company_name varchar(50) NOT NULL DEFAULT '' COMMENT '物流公司名称',
...
ADD INDEX IDX_document_app_module (app_module);
ALTER TABLE document
ADD INDEX IDX_document_document_key (document_key);
ALTER TABLE document
ADD INDEX IDX_document_site_id (site_id);
...
ADD INDEX IDX_div_template_mark (mark);
ALTER TABLE div_template
ADD INDEX IDX_div_template_type (`type`);
...
CREATE TABLE album (
  ...
  app_module varchar(255) NOT NULL DEFAULT 'shop',
...
COMMENT = '插件表';
ALTER TABLE addon
ADD UNIQUE INDEX UK_nc_addoname (name);
...
(1, 0, 'ORDER_CREATE', 2, '订单创建通知', '尊敬的会员，您的订单已创建，订单号{orderno}。', '{"orderno":"other_number"}', 0, 0, 0, 1596437584),
(2, 0, 'ORDER_CLOSE', 2, '订单关闭通知', '尊敬的会员，您的订单{orderno}，已关闭。', '{"orderno":"other_number"}', 0, 0, 0, 1596427379),
(3, 0, 'ORDER_COMPLETE', 2, '订单完成通知', '尊敬的会员，您的订单{orderno}，交易成功。', '{"orderno":"other_number"}', 0, 0, 0, 1596427376),
(4, 0, 'ORDER_PAY', 2, '订单支付通知', '亲爱的{username},你的订单号为{orderno}的订单已成功支付,支付金额{ordermoney}', '{"username":"others","orderno":"other_number","ordermoney":"amount"}', 0, 0, 0, 1596428621),
(5, 0, 'ORDER_DELIVERY', 2, '订单发货通知', '尊敬的会员，您的订单已发货，订单号{orderno}。', '{"orderno":"other_number"}', 0, 0, 0, 1596427369),
(6, 0, 'ORDER_TAKE_DELIVERY', 2, '订单收货通知', '尊敬的会员，您的订单{orderno}，收货成功。', '{"orderno":"other_number"}', 0, 0, 0, 1596427365),
(7, 0, 'ORDER_REFUND_AGREE', 2, '商家同意退款', '尊敬的会员，您的订单{orderno}，商家同意退款。', '{"orderno":"other_number"}', 0, 0, 0, 1596427356),
(8, 0, 'ORDER_REFUND_REFUSE', 2, '商家拒绝退款', '尊敬的会员，您的订单{orderno}，商家拒绝退款。', '{"orderno":"other_number"}', 0, 0, 0, 1596427352),
(9, 0, 'VERIFY', 2, '核销取货', '尊敬的会员，您的订单{orderno}，商家核销成功。', '{"orderno":"other_number"}', 0, 0, 0, 1596427347),
(10, 0, 'REGISTER_CODE', 1, '注册验证', '您的验证码为：{code}，该验证码 5 分钟内有效，请勿泄漏于他人！', '{"code":"valid_code"}', 0, 0, 0, 1596426737),
(11, 0, 'REGISTER_SUCCESS', 2, '注册成功', '尊敬的{username},您以成功注册为{shopname}用户。', '{"username":"others","shopname":"others"}', 0, 0, 0, 1596426734),
(12, 0, 'FIND_PASSWORD', 1, '找回密码', '您的验证码{code}，该验证码5分钟内有效，请勿泄漏于他人！', '{"code":"valid_code"}', 0, 0, 0, 1596426730),
(13, 0, 'LOGIN', 2, '会员登录', '尊敬的{name}，您的账号登陆成功。', '{"name":"others"}', 0, 0, 0, 1596426726),
(14, 0, 'MEMBER_BIND', 1, '账户绑定', '您的验证码为：{code}，该验证码 5 分钟内有效，请勿泄漏于他人！', '{"code":"valid_code"}', 0, 0, 0, 1596426723),
(15, 0, 'LOGIN_CODE', 1, '动态码登录', '您的验证码为：{code}，该验证码 5 分钟内有效，请勿泄漏于他人！', '{"code":"valid_code"}', 0, 0, 0, 1596426719),
(16, 0, 'SET_PASSWORD', 1, '设置密码', '您的验证码{code}，该验证码5分钟内有效，请勿泄漏于他人！', '{"code":"valid_code"}', 0, 0, 0, 1596426714),
(17, 0, 'BUYER_REFUND', 2, '买家已退货提醒', '订单号为{orderno}，买家退货。', '{"orderno":"other_number"}', 0, 0, 0, 1596436982),
(18, 0, 'BUYER_DELIVERY_REFUND', 2, '买家发起退款提醒', '{username}申请了退款，订单号为{orderno}的商品{goodsname}，退款单号为{refundno}，退款金额{refundmoney}，退款原因{refundreason}。', '{"username":"others","orderno":"other_number","goodsname":"others","refundno":"other_number","refundmoney":"amount","refundreason":"others"}', 0, 0, 0, 1596437579),
(19, 0, 'BUYER_TAKE_DELIVERY', 2, '买家收货提醒', '订单号为{orderno}，买家已收货。', '{"orderno":"other_number"}', 0, 0, 0, 1599040477),
(20, 0, 'BUYER_PAY', 2, '买家支付提醒', '订单号为{orderno}，买家已支付，支付金额为{ordermoney}。', '{"orderno":"other_number","ordermoney":"amount"}', 0, 0, 0, 1599040486),
(21, 0, 'USER_WITHDRAWAL_APPLY', 2, '会员申请提现通知', '会员{username}申请余额提现，提现金额为{money}', '{"username":"others","money":"amount"}', 0, 0, 0, 1599876409),
(22, 0, 'FENXIAO_WITHDRAWAL_APPLY', 2, '分销申请提现通知', '分销商{fenxiaoname}申请佣金提现，提现金额为{money}', '{"fenxiaorname":"others","money":"amount"}', 0, 0, 0, 1599820140),
(23, 0, 'USER_WITHDRAWAL_SUCCESS', 2, '会员提现成功通知', '尊敬的{username}，您申请的{money}余额，已提现成功。', '{"username":"others","money":"amount"}', 0, 0, 0, 1599876399),
(24, 0, 'FENXIAO_WITHDRAWAL_SUCCESS', 2, '分销提现成功通知', '尊敬的{username}，您申请的{money}佣金，已提现成功。', '{"fenxiaorname":"others","money":"amount"}', 0, 0, 0, 1599820115),
(25, 0, 'USER_CANCEL_SUCCESS', 2, '会员注销成功', '尊敬的{username}，您的账号已注销成功。', '{"username":"others"}', 0, 0, 0, 1603694000),
(26, 0, 'USER_CANCEL_FAIL', 2, '会员注销失败', '尊敬的{username}，您的账号商家拒绝注销。', '{"username":"others"}', 0, 0, 0, 1603693993),
(27, 0, 'USER_CANCEL_APPLY', 2, '会员注销申请', '账号为{username}，会员申请注销。', '{"username":"others"}', 0, 0, 0, 1603693989),
(28, 0, 'FENXIAO_WITHDRAWAL_ERROR', 2, '分销提现失败结果通知', '尊敬的{fenxiaoname}，您申请的{money}余额，提现审核失败。', '{"fenxiaoname":"others","money":"amount"}', 1, 0, 0, 1608274672);
INSERT INTO message VALUES
(1, '', 'ORDER_CREATE', '订单创建通知', 1, '{"orderno":"订单号"}', 0, '', '', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355\\u5df2\\u521b\\u5efa\\uff0c\\u8ba2\\u5355\\u53f7${orderno}\\u3002","smssign":""}}', '【{sitename}】,您的验证码{code},请不要泄露得1其他人', 1, '{"template_id_short":"OPENTM401874876","template_id":"","headtext":"","bottomtext":"","headtextcolor":"#e73030","bottomtextcolor":"","content":"\\u8ba2\\u5355\\u53f7\\uff1a{{keyword1.DATA}}\\n\\u4e0b\\u5355\\u65f6\\u95f4\\uff1a{{keyword2.DATA}}\\n\\u4ea7\\u54c1\\u8be6\\u60c5\\uff1a{{keyword3.DATA}}\\n\\u9700\\u652f\\u4ed8\\u91d1\\u989d\\uff1a{{keyword4.DATA}}\\n\\u6536\\u8d27\\u8be6\\u60c5\\uff1a{{keyword5.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(2, '', 'ORDER_CLOSE', '订单关闭通知', 1, '{"orderno":"订单号"}', 1, '订单关闭', '<p>尊敬的会员，您的订单{订单号}，已关闭</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u5df2\\u5173\\u95ed\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM205543831","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"订单商品：{{keyword1.DATA}}\\n订单编号：{{keyword2.DATA}}\\n下单时间：{{keyword3.DATA}}\\n订单金额：{{keyword4.DATA}}\\n关闭时间：{{keyword5.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(3, '', 'ORDER_COMPLETE', '订单完成通知', 1, '{"orderno":"订单号"}', 0, '订单完成', '<p>尊敬的会员，您的订单{订单号}，交易成功</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u4ea4\\u6613\\u6210\\u529f\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM412034601","template_id":"","headtext":"您的订单已完成。","bottomtext":"详情请登录公众号查看。","headtextcolor":"#fe0000","bottomtextcolor":"#1f7af2","content":"订单单号：{{keyword1.DATA}}\\n订单商品：{{keyword2.DATA}}\\n下单时间：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(4, '', 'ORDER_PAY', '订单支付通知', 1, '{"orderno":"订单号","username":"会员名称","ordermoney":"订单金额"}', 0, '订单支付', '<p>亲爱的{会员名称},你的订单号为{订单号}的订单已成功支付,支付金额{订单金额}</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u4eb2\\u7231\\u7684${username},\\u4f60\\u7684\\u8ba2\\u5355\\u53f7\\u4e3a${orderno}\\u7684\\u8ba2\\u5355\\u5df2\\u6210\\u529f\\u652f\\u4ed8,\\u652f\\u4ed8\\u91d1\\u989d${ordermoney}","smssign":""}}', '', 1, '{"template_id_short":"OPENTM402074360","template_id":"CDdclx9Oz93xQrB1bmxe3P1PvPld9VoumWNH5PTAeTU","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"下单时间：{{keyword1.DATA}}\\n订单编号：{{keyword2.DATA}}\\n商品信息：{{keyword3.DATA}}\\n订单金额：{{keyword4.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(5, '', 'ORDER_DELIVERY', '订单发货通知', 1, '{"orderno":"订单号"}', 0, '', '', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355\\u5df2\\u53d1\\u8d27\\uff0c\\u8ba2\\u5355\\u53f7${orderno}\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM406700005","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u8ba2\\u5355\\u7f16\\u53f7\\uff1a{{keyword1.DATA}}\\n\\u5546\\u54c1\\u540d\\u79f0\\uff1a{{keyword2.DATA}}\\n\\u5546\\u54c1\\u4ef6\\u6570\\uff1a{{keyword3.DATA}}\\n\\u652f\\u4ed8\\u91d1\\u989d\\uff1a{{keyword4.DATA}}\\n\\u53d1\\u8d27\\u65f6\\u95f4\\uff1a{{keyword5.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(6, '', 'ORDER_TAKE_DELIVERY', '订单收货通知', 1, '{"orderno":"订单号"}', 0, '订单收货成功', '<p>尊敬的会员，您的订单{订单号}，收货成功</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u6536\\u8d27\\u6210\\u529f\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM418052192","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"收货地址：{{keyword1.DATA}}\\n联系人：{{keyword2.DATA}}\\n订单号：{{keyword3.DATA}}\\n订单详情：{{keyword4.DATA}}\\n操作时间：{{keyword5.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(7, '', 'ORDER_REFUND_AGREE', '商家同意退款', 1, '{"orderno":"订单号"}', 0, '商家同意退款', '<p>尊敬的会员，您的订单{订单号}，商家同意退款</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u5546\\u5bb6\\u540c\\u610f\\u9000\\u6b3e\\u3002","smssign":""}}', '', 0, '{"template_id_short":"OPENTM412135258","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u8ba2\\u5355\\u53f7\\uff1a{{keyword1.DATA}}\\n\\u9000\\u6b3e\\u91d1\\u989d\\uff1a{{keyword2.DATA}}\\n\\u65f6\\u95f4\\uff1a{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(8, '', 'ORDER_REFUND_REFUSE', '商家拒绝退款', 1, '{"orderno":"订单号"}', 0, '商家拒绝退款', '<p>尊敬的会员，您的订单{订单号}，商家拒绝退款</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u5546\\u5bb6\\u62d2\\u7edd\\u9000\\u6b3e\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM417819857","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"单号：{{keyword1.DATA}}\\n金额：{{keyword2.DATA}}\\n时间：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(9, '', 'VERIFY', '核销取货', 1, '{"orderno":"订单号"}', 0, '核销成功', '<p>尊敬的会员，您的订单{订单号}，商家核销成功</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684\\u4f1a\\u5458\\uff0c\\u60a8\\u7684\\u8ba2\\u5355${orderno}\\uff0c\\u5546\\u5bb6\\u6838\\u9500\\u6210\\u529f\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM416687547","template_id":"", "headtext": "", "bottomtext": "", "headtextcolor": "", "bottomtextcolor": "", "content": "商品名称：{{keyword1.DATA}}\\n商品数量：{{keyword2.DATA}}\\n核销时间：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email'),
(10, '', 'BUYER_REFUND', '买家发起退款提醒', 2, '{"username":"会员名称","goodsname":"商品名称","orderno":"订单号","refundmoney":"退款金额","refundreason":"退款原因","refundno":"退款单号"}', 1, '买家发起退款1', '<p>{会员名称}申请了退款，订单号为{订单号}的商品{商品名称}，退款单号为{退款单号}，退款金额{退款金额}，退款原因{退款原因}。</p>', 0, '', '{"alisms":{"template_id":"","content":"${username}\\u7533\\u8bf7\\u4e86\\u9000\\u6b3e\\uff0c\\u8ba2\\u5355\\u53f7\\u4e3a${orderno}\\u7684\\u5546\\u54c1${goodsname}\\uff0c\\u9000\\u6b3e\\u5355\\u53f7\\u4e3a${refundno}\\uff0c\\u9000\\u6b3e\\u91d1\\u989d${refundmoney}\\uff0c\\u9000\\u6b3e\\u539f\\u56e0${refundreason}\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM412244458","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u9000\\u6b3e\\u5355\\u53f7\\uff1a{{keyword1.DATA}}\\n\\u7533\\u8bf7\\u65f6\\u95f4\\uff1a{{keyword2.DATA}}\\n\\u9000\\u6b3e\\u91d1\\u989d\\uff1a{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(11, '', 'BUYER_DELIVERY_REFUND', '买家已退货提醒', 2, '{"orderno":"订单号"}', 1, '买家退货通知', '<p>订单号为{订单号}，买家退货。</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u8ba2\\u5355\\u53f7\\u4e3a${orderno}\\uff0c\\u4e70\\u5bb6\\u9000\\u8d27\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM206905995","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u9000\\u8d27\\u8ba2\\u5355\\u53f7\\uff1a{{keyword1.DATA}}\\n\\u9000\\u8d27\\u5546\\u54c1\\uff1a{{keyword2.DATA}}\\n\\u9000\\u8d27\\u6570\\u91cf\\uff1a{{keyword3.DATA}}\\n\\u9000\\u8d27\\u91d1\\u989d\\uff1a{{keyword4.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(12, '', 'REGISTER_CODE', '注册验证', 1, '{"code":"验证码","site_name":"站点名称"}', 0, '发送邮箱注册验证码', '<p>{站点名称}发送邮箱注册验证码{验证码}</p>', 0, '', '{"alisms":{"template_id":"","content":"{code}\\u60a8\\u7684\\u9a8c\\u8bc1\\u7801{site_name}\\u4e3a\\uff1a${code}\\uff0c\\u8be5\\u9a8c\\u8bc1\\u7801 5 \\u5206\\u949f\\u5185\\u6709\\u6548\\uff0c\\u8bf7\\u52ff\\u6cc4\\u6f0f\\u4e8e\\u4ed6\\u4eba\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(13, '', 'REGISTER_SUCCESS', '注册成功', 1, '{"shopname":"商城名称","username":"会员名称"}', 0, '会员注册成功通知', '<p>尊敬的{会员名称},您已成功注册为{商城名称}用户。</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684${username},\\u60a8\\u4ee5\\u6210\\u529f\\u6ce8\\u518c\\u4e3a${shopname}\\u7528\\u6237\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM409413579","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"注册账号：{{keyword1.DATA}}\\n注册时间：{{keyword2.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(14, '', 'FIND_PASSWORD', '找回密码', 1, '{"code":"验证码","site_name":"站点名称"}', 1, '发送邮箱找回密码验证码', '\r\n<p>{站点名称}发送邮箱找回密码验证码{验证码}</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u60a8\\u7684\\u9a8c\\u8bc1\\u7801\\u4e3a\\uff1a${number}\\uff0c\\u8be5\\u9a8c\\u8bc1\\u7801 5 \\u5206\\u949f\\u5185\\u6709\\u6548\\uff0c\\u8bf7\\u52ff\\u6cc4\\u6f0f\\u4e8e\\u4ed6\\u4eba\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(15, '', 'LOGIN', '会员登录', 1, '{"name":"会员名称"}', 1, '会员登录', '<p>尊敬的{会员名称}，您的账号登陆成功。</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684${name}\\uff0c\\u60a8\\u7684\\u8d26\\u53f7\\u767b\\u9646\\u6210\\u529f\\u3002","smssign":""}}', '', 1, '{"template_id_short":"OPENTM412447375","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"登录账号：{{keyword1.DATA}}\\n登录状态：{{keyword2.DATA}}\\n登录时间：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(16, '', 'MEMBER_BIND', '账户绑定', 1, '{"code":"验证码","site_name":"站点名称"}', 1, '发送邮箱绑定验证码', '<p>{站点名称}发送邮箱绑定验证码{验证码}</p>', 1, '', '{"alisms":{"template_id":"","content":"","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(17, '', 'LOGIN_CODE', '动态码登录', 1, '{"code":"验证码"}', 0, '', '<p>您的验证码为：{验证码}，该验证码 5 分钟内有效，请勿泄漏于他人。</p>', 1, '', '{"alisms":{"template_id":"","content":"\\u60a8\\u7684\\u9a8c\\u8bc1\\u7801\\u4e3a\\uff1a${code}\\uff0c\\u8be5\\u9a8c\\u8bc1\\u7801 5 \\u5206\\u949f\\u5185\\u6709\\u6548\\uff0c\\u8bf7\\u52ff\\u6cc4\\u6f0f\\u4e8e\\u4ed6\\u4eba\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(18, '', 'SET_PASSWORD', '设置密码', 1, '{"code":"验证码"}', 0, '', '', 1, '', '{"alisms":{"template_id":"","content":"\\u60a8\\u7684\\u9a8c\\u8bc1\\u7801\\u4e3a\\uff1a${code}\\uff0c\\u8be5\\u9a8c\\u8bc1\\u7801 5 \\u5206\\u949f\\u5185\\u6709\\u6548\\uff0c\\u8bf7\\u52ff\\u6cc4\\u6f0f\\u4e8e\\u4ed6\\u4eba\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms'),
(19, '', 'BUYER_TAKE_DELIVERY', '买家收货通知', 2, '{"orderno":"订单号"}', 0, '', '', 0, '', '', '', 0, '{"template_id_short":"OPENTM418052192","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u6536\\u8d27\\u5730\\u5740\\uff1a{{keyword1.DATA}}\\n\\u8054\\u7cfb\\u4eba\\uff1a{{keyword2.DATA}}\\n\\u8ba2\\u5355\\u53f7\\uff1a{{keyword3.DATA}}\\n\\u8ba2\\u5355\\u8be6\\u60c5\\uff1a{{keyword4.DATA}}\\n\\u64cd\\u4f5c\\u65f6\\u95f4\\uff1a{{keyword5.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(20, '', 'BUYER_PAY', '买家支付通知', 2, '{"orderno":"订单号","ordermoney":"订单金额"}', 0, '', '', 0, '', '', '', 0, '{"template_id_short":"OPENTM402074360","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"\\u4e0b\\u5355\\u65f6\\u95f4\\uff1a{{keyword1.DATA}}\\n\\u8ba2\\u5355\\u7f16\\u53f7\\uff1a{{keyword2.DATA}}\\n\\u5546\\u54c1\\u4fe1\\u606f\\uff1a{{keyword3.DATA}}\\n\\u8ba2\\u5355\\u91d1\\u989d\\uff1a{{keyword4.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(21, '', 'USER_WITHDRAWAL_APPLY', '会员申请提现通知', 2, '{"username":"会员名称","money":"提现金额"}', 0, '', '', 0, '', '', '', 0, '{"template_id_short":"OPENTM416719519","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"申请人：{{keyword1.DATA}}\\n创建时间：{{keyword2.DATA}}\\n申请金额：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(22, '', 'FENXIAO_WITHDRAWAL_APPLY', '分销申请提现通知', 2, '{"fenxiaoname":"分销商名称","money":"提现金额"}', 0, '', '', 0, '', '', '', 0, '{"template_id_short":"OPENTM416719519","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"申请人：{{keyword1.DATA}}\\n创建时间：{{keyword2.DATA}}\\n申请金额：{{keyword3.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(23, '', 'USER_WITHDRAWAL_SUCCESS', '会员提现成功通知', 1, '{"username":"会员名称","money":"提现金额"}', 0, '', '', 0, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684{username}\\uff0c\\u60a8\\u7533\\u8bf7\\u7684{money}\\u4f59\\u989d\\uff0c\\u5df2\\u63d0\\u73b0\\u6210\\u529f\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(24, '', 'FENXIAO_WITHDRAWAL_SUCCESS', '分销提现成功通知', 1, '{"fenxiaoname":"分销商名称","money":"提现金额"}', 0, '', '', 0, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684{fenxiaoname}\\uff0c\\u60a8\\u7533\\u8bf7\\u7684{money}\\u4f63\\u91d1\\uff0c\\u5df2\\u63d0\\u73b0\\u6210\\u529f\\u3002","smssign":""}}', '', 0, '', 0, '', 0, '', 'sms,email'),
(25, '', 'USER_CANCEL_SUCCESS', '会员注销成功', 1, '{"username":"会员账号"}', 0, '', '', 0, '', '', '', 0, '', 0, '', 0, '', 'sms,email'),
(26, '', 'USER_CANCEL_FAIL', '会员注销失败', 1, '{"username":"会员账号"}', 0, '', '', 0, '', '', '', 0, '', 0, '', 0, '', 'sms,email'),
(27, '', 'USER_CANCEL_APPLY', '会员注销申请', 2, '{"username":"会员账号"}', 0, '', '', 0, '', '', '', 0, '{"template_id_short":"OPENTM413481457","template_id":"","headtext":"","bottomtext":"","headtextcolor":"","bottomtextcolor":"","content":"申请人：{{keyword1.DATA}}\\n手机号码：{{keyword2.DATA}}"}', 0, '', 0, '', 'sms,email,wechat'),
(28, '', 'FENXIAO_WITHDRAWAL_ERROR', '分销提现失败通知', 1, '{"fenxiaoname":"分销商名称","money":"提现金额"}', 0, '', '', 0, '', '{"alisms":{"template_id":"","content":"\\u5c0a\\u656c\\u7684{username}\\uff0c\\u60a8\\u7533\\u8bf7\\u7684{money}\\u4f63\\u91d1\\uff0c\\u5df2\\u63d0\\u73b0\\u6210\\u529f\\u3002","smssign":""}}', '', 0, '{"template_id_short":"OPENTM417749055","template_id":"","headtext":"\\u4f1a\\u5458\\u63d0\\u73b0\\u5931\\u8d25\\u901a\\u77e5","bottomtext":"\\u8fdb\\u5165\\u5546\\u57ce\\u67e5\\u770b\\u8be6\\u60c5","headtextcolor":"","bottomtextcolor":"","content":"\\u63d0\\u73b0\\u65f6\\u95f4\\uff1a{{keyword1.DATA}}\\n\\u5ba1\\u6838\\u72b6\\u6001\\uff1a{{keyword2.DATA}}\\n\\u63d0\\u73b0\\u65b9\\u5f0f\\uff1a{{keyword3.DATA}}\\n\\u63d0\\u73b0\\u91d1\\u989d\\uff1a{{keyword4.DATA}}"}', 0, '', 0, '', 'sms,wechat');
...
(1, '顺丰速运', 'upload/default/express/shunfeng.jpg', 'https://www.sf-express.com/cn/sc/', 1, 'SF', '100免费版编码', '100免费版编码', 'SF', '', '[{"item_name":"logistics_number","item_title":"货到付款物流编号","left":273.96875,"top":259.96875},{"item_name":"sender_address","item_title":"发件人地址","left":227.96875,"top":141.96875},{"item_name":"sender_name","item_title":"发件人姓名","left":44.953125,"top":162.984375},{"item_name":"collection_payment","item_title":"代收金额","left":252.96875,"top":45.96875}]', '', 14, 766, 510, 0, 0, 0, 0, ''),
(2, '韵达快递', 'upload/default/express/yunda.jpg', 'http://www.yundaex.com/cn/index.php', 2, 'YD', 'yunda', 'yunda', 'YUNDA', '', '[{"item_name":"order_no","item_title":"订单编号","left":61,"top":36},{"item_name":"receiver_post_code","item_title":"收件人邮编","left":136,"top":90},{"item_name":"logistics_number","item_title":"货到付款物流编号","left":227,"top":130},{"item_name":"collection_payment","item_title":"代收金额","left":181,"top":216}]', '', 14, 766, 510, 0, 0, 0, 0, '');


INSERT INTO div_template VALUES
(1, '水果生鲜商城', '牛之云网络科技专注模板设计与开发，智能装修，操作简单，助您提升店铺装修视觉体验，提高店铺转化！售后有保障，牛之云网络科技愿竭诚为您服务！', 'fresh_template', 'DIY_VIEW_INDEX', '{"global":{"title":"水果生鲜商城","bgColor":"#ffffff","bgUrl":"public\\/diy_view\\/style1\\/img\\/bg_img.png","moreLink":{"name":""},"mpCollect":false,"navStyle":1,"openBottomNav":true,"popWindow":{"imageUrl":"","count":-1,"link":{"name":""},"imgWidth":"","imgHeight":""},"textImgPosLink":"center","textImgStyleLink":"1","textNavColor":"#333333","topNavColor":"#ffffff","topNavImg":"","topNavbg":false},"value":[{"title":"搜索","textColor":"#999999","textAlign":"left","backgroundColor":"","bgColor":"#ffffff","defaultTextColor":"#999999","borderType":2,"searchType":1,"searchImg":"","searchStyle":1,"addon_name":"","type":"SEARCH","name":"商品搜索","controller":"Search","is_delete":"0"},{"selectedTemplate":"carousel-posters","imageClearance":0,"imageRadius":"fillet","carouselChangeStyle":"circle","marginTop":0,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/adv_01.png","title":"","link":{"name":""},"imgWidth":"690","imgHeight":"322"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"textColor":"#666666","defaultTextColor":"#666666","backgroundColor":"","selectedTemplate":"imageNavigation","showType":5,"scrollSetting":"fixed","padding":20,"marginTop":10,"list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/pintuan.png","title":"超值拼团","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"PINTUAN_PREFECTURE","title":"拼团专区","wap_url":"\\/promotionpages\\/pintuan\\/list\\/list"},"imgWidth":"80","imgHeight":"80"},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/grup_purchase.png","title":"精彩团购","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"GROUPBUY_PREFECTURE","title":"团购专区","wap_url":"\\/promotionpages\\/groupbuy\\/list\\/list"},"imgWidth":"80","imgHeight":"80"},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/seckill.png","title":"限时秒杀","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"SECKILL_PREFECTURE","title":"秒杀专区","wap_url":"\\/promotionpages\\/seckill\\/list\\/list"},"imgWidth":"80","imgHeight":"80"},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/integral.png","title":"积分商城","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"INTEGRAL_STORE","title":"积分商城","wap_url":"\\/promotionpages\\/point\\/list\\/list"},"imgWidth":"80","imgHeight":"80"},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/notice.png","title":"公告","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MALL_LINK","name":"SHOPPING_NOTICE","title":"公告","wap_url":"\\/otherpages\\/notice\\/list\\/list"},"imgWidth":"80","imgHeight":"80"}],"addon_name":"","type":"GRAPHIC_NAV","navRadius":"fillet","name":"图文导航","controller":"GraphicNav","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":12,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/adv_05.png","title":"","link":{"name":""},"imgWidth":"747","imgHeight":"185"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"selectedTemplate":"row1-of2","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/adv_02.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/adv_03.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":10,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"height":10,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-of4","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/function_03.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/function_01.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/function_04.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style1\\/img\\/function_02.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":10,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"sources":"default","categoryId":0,"goodsCount":"6","goodsId":[],"style":1,"styleName":"风格一","changeType":1,"backgroundColor":"","bgSelect":"yellow","marginTop":10,"list":{"imageUrl":"public\\/diy_view\\/style1\\/img\\/groupbuy_title.png","title":"团购专区"},"listMore":{"imageUrl":"","title":"查看更多"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"groupbuy","type":"GROUPBUY_LIST","name":"团购","controller":"Groupbuy","is_delete":"0"},{"style":1,"backgroundColor":"","marginTop":10,"styleName":"风格一","bgSelect":"red","changeType":1,"paddingLeftRight":0,"isShowGoodsName":1,"isShowGoodsDesc":0,"isShowGoodsPrice":1,"isShowGoodsPrimary":1,"isShowGoodsStock":0,"list":{"imageUrl":"public\\/diy_view\\/style1\\/img\\/seckill_title.png","title":"秒杀专区"},"listMore":{"imageUrl":"","title":"更多秒杀"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"seckill","type":"SECKILL_LIST","name":"秒杀","controller":"Seckill","is_delete":"0"},{"title":"今日热销","textColor":"#333333","defaultTextColor":"#333333","alignStyle":"center","subTitle":"","marginTop":20,"padding":0,"backgroundColor":"","link":{"name":""},"fontSize":16,"fontSizeSub":14,"colorSub":"#999999","defaultColorSub":"#999","style":"1","sub":"0","styleName":"模板一","isShowMore":0,"fontWeight":600,"moreText":"查看更多","moreLink":{"name":""},"btnColor":"#999999","defaultBtnColor":"#999","addon_name":"","type":"TEXT","name":"文本","controller":"Text","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":10,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style1\\/img\\/adv_04.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"188"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","categoryId":0,"categoryName":"请选择","goodsCount":"6","goodsId":[],"style":"2","backgroundColor":"","marginTop":10,"paddingLeftRight":0,"isShowCart":0,"cartStyle":1,"isShowGoodName":1,"isShowMarketPrice":1,"isShowGoodSaleNum":1,"isShowGoodSubTitle":0,"goodsTag":"default","tagImg":{"imageUrl":""},"addon_name":"","type":"GOODS_LIST","name":"商品列表","controller":"GoodsList","is_delete":"0"}]}', 'public/diy_view/style1/img/cover.png'),
(2, '时尚简约商城', '牛之云网络科技专注模板设计与开发，智能装修，操作简单，助您提升店铺装修视觉体验，提高店铺转化！售后有保障，牛之云网络科技愿竭诚为您服务！', 'shop_template', 'DIY_VIEW_INDEX', '{"global":{"title":"时尚简约商城","bgColor":"#f8f8f8","topNavColor":"#ffffff","topNavbg":false,"textNavColor":"#303133","topNavImg":"","moreLink":{"name":""},"openBottomNav":true,"navStyle":1,"textImgStyleLink":"1","textImgPosLink":"center","popWindow":{"imageUrl":"","count":-1,"link":{"name":""},"imgWidth":"","imgHeight":""},"bgUrl":"","mpCollect":false},"value":[{"selectedTemplate":"carousel-posters","imageClearance":0,"imageRadius":"fillet","carouselChangeStyle":"circle","marginTop":0,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style2\\/img\\/posters_1.png","title":"","link":{"name":""},"imgWidth":"690","imgHeight":"323"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/posters_2.png","title":"","link":{"name":""},"imgWidth":"690","imgHeight":"322"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"textColor":"#303133","defaultTextColor":"#666666","backgroundColor":"#ffffff","selectedTemplate":"imageNavigation","showType":5,"scrollSetting":"fixed","padding":20,"marginTop":10,"list":[{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon1.png","title":"拼团","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"PINTUAN_PREFECTURE","title":"拼团专区","wap_url":"\\/promotionpages\\/pintuan\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon2.png","title":"团购","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"GROUPBUY_PREFECTURE","title":"团购专区","wap_url":"\\/promotionpages\\/groupbuy\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon3.png","title":"秒杀","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"SECKILL_PREFECTURE","title":"秒杀专区","wap_url":"\\/promotionpages\\/seckill\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon4.png","title":"积分商城","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"INTEGRAL_STORE","title":"积分商城","wap_url":"\\/promotionpages\\/point\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon5.png","title":"专题活动","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"THEMATIC_ACTIVITIES_LIST","title":"专题活动列表","wap_url":"\\/promotionpages\\/topics\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon6.png","title":"砍价","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"BARGAIN_PREFECTURE","title":"砍价专区","wap_url":"\\/promotionpages\\/bargain\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon7.png","title":"直播","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"LIVE_LIST","title":"直播","wap_url":"\\/otherpages\\/live\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon8.png","title":"领券","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","name":"COUPON_PREFECTURE","title":"优惠券专区","wap_url":"\\/otherpages\\/goods\\/coupon\\/coupon"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon9.png","title":"公告","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MALL_LINK","name":"SHOPPING_NOTICE","title":"公告","wap_url":"\\/otherpages\\/notice\\/list\\/list"},"imgWidth":"70","imgHeight":"70"},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/icon10.png","title":"帮助","link":{"type":1,"menuOne":"MALL_PAGE","menuTwo":"MALL_LINK","name":"SHOPPING_HELP","title":"帮助","wap_url":"\\/otherpages\\/help\\/list\\/list"},"imgWidth":"70","imgHeight":"70"}],"addon_name":"","type":"GRAPHIC_NAV","name":"图文导航","navRadius":"fillet","controller":"GraphicNav","is_delete":"0"},{"sources":"default","backgroundColor":"#ffffff","marginTop":10,"style":1,"isEdit":1,"styleName":"风格一","textColor":"#606266","defaultTextColor":"#333333","fontSize":14,"list":[{"title":"单商户V4.0.4更新啦！","link":{"name":""}}],"noticeIds":[],"addon_name":"","type":"NOTICE","name":"公告","controller":"Notice","is_delete":"0"},{"marginTop":10,"isShowAnchorInfo":"1","isShowLiveGood":"1","addon_name":"live","type":"WEAPP_LIVE","name":"小程序直播","controller":"LiveInfo","is_delete":"0"},{"height":10,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-lt-of2-rt","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style2\\/img\\/adv1.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/adv2.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style2\\/img\\/adv3.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":10,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"sources":"default","style":1,"couponCount":"6","styleName":"风格一","backgroundColor":"","marginTop":0,"status":1,"couponIds":[],"addon_name":"platformcoupon","type":"ADMIN_PLATFORM_COUPON","name":"平台优惠券","controller":"AdminPlatformCoupon","is_delete":"0"},{"style":1,"backgroundColor":"","marginTop":10,"styleName":"风格一","bgSelect":"red","changeType":1,"paddingLeftRight":0,"isShowGoodsName":1,"isShowGoodsDesc":0,"isShowGoodsPrice":1,"isShowGoodsPrimary":1,"isShowGoodsStock":0,"list":{"imageUrl":"public\\/diy_view\\/style2\\/img\\/title1.png","title":"秒杀专区"},"listMore":{"imageUrl":"","title":"更多秒杀"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"seckill","type":"SECKILL_LIST","name":"秒杀","controller":"Seckill","is_delete":"0"},{"sources":"default","categoryId":0,"goodsCount":"6","goodsId":[],"style":1,"styleName":"风格一","changeType":1,"backgroundColor":"","bgSelect":"blue","marginTop":10,"list":{"imageUrl":"public\\/diy_view\\/style2\\/img\\/title2.png","title":"爱拼才会赢"},"listMore":{"imageUrl":"","title":"好友都在拼"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"pintuan","type":"PINTUAN_LIST","name":"拼团","controller":"Pintuan","is_delete":"0"},{"sources":"default","categoryId":0,"goodsCount":"6","goodsId":[],"style":1,"styleName":"风格一","changeType":1,"backgroundColor":"","bgSelect":"yellow","marginTop":10,"list":{"imageUrl":"public\\/diy_view\\/style2\\/img\\/title3.png","title":"一起团才更实惠"},"listMore":{"imageUrl":"","title":"查看更多"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"groupbuy","type":"GROUPBUY_LIST","name":"团购","controller":"Groupbuy","is_delete":"0"},{"sources":"default","categoryId":0,"goodsCount":"6","styleName":"风格一","goodsId":[],"style":1,"changeType":1,"backgroundColor":"","bgSelect":"violet","marginTop":10,"list":{"imageUrl":"public\\/diy_view\\/style2\\/img\\/title4.png","title":"低价一目了然"},"listMore":{"imageUrl":"","title":"更多"},"titleTextColor":"#000","defaultTitleTextColor":"#000","moreTextColor":"#858585","defaultMoreTextColor":"#858585","addon_name":"bargain","type":"BARGAIN_LIST","name":"砍价","controller":"Bargain","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":25,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style2\\/img\\/title.png","title":"","link":{"name":""},"imgWidth":"690","imgHeight":"65"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","categoryId":0,"categoryName":"请选择","goodsCount":"6","goodsId":[],"style":"2","backgroundColor":"","marginTop":10,"paddingLeftRight":0,"isShowCart":0,"cartStyle":1,"isShowGoodName":1,"isShowMarketPrice":1,"isShowGoodSaleNum":1,"isShowGoodSubTitle":0,"goodsTag":"default","tagImg":{"imageUrl":""},"addon_name":"","type":"GOODS_LIST","name":"商品列表","controller":"GoodsList","is_delete":"0"}]}', 'public/diy_view/style2/img/cover.png'),
(3, '外卖美食商城', '牛之云网络科技专注模板设计与开发，智能装修，操作简单，助您提升店铺装修视觉体验，提高店铺转化！售后有保障，牛之云网络科技愿竭诚为您服务！', 'toke_template', 'DIY_VIEW_INDEX', '{"global":{"title":"外卖美食商城","bgColor":"#f7f7f7","topNavColor":"#ffffff","topNavbg":false,"textNavColor":"#303133","topNavImg":"","moreLink":{"name":""},"openBottomNav":true,"navStyle":1,"textImgStyleLink":"1","textImgPosLink":"center","popWindow":{"imageUrl":"","count":-1,"link":{"name":""},"imgWidth":"","imgHeight":""},"bgUrl":"public\\/diy_view\\/style3\\/img\\/bg_img.png","mpCollect":false},"value":[{"selectedTemplate":"carousel-posters","imageClearance":0,"imageRadius":"fillet","carouselChangeStyle":"circle","marginTop":0,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style3\\/img\\/posters_1.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"337"},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/posters_2.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"337"},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/posters_3.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"337"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","backgroundColor":"#ffffff","marginTop":10,"style":1,"isEdit":1,"styleName":"风格一","textColor":"#333333","defaultTextColor":"#333333","fontSize":14,"list":[{"title":"多端小程序即将上线","link":{"name":""}}],"noticeIds":[],"addon_name":"","type":"NOTICE","name":"公告","controller":"Notice","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":10,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_01.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"161"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"height":10,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-lt-of2-rt","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_02.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_03.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_04.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":15,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"height":7,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-of3","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_05.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_06.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style3\\/img\\/adv_07.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":15,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":20,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style3\\/img\\/title.png","title":"","link":{"name":""},"imgWidth":"690","imgHeight":"65"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","categoryId":0,"categoryName":"请选择","goodsCount":"6","goodsId":[],"style":"2","backgroundColor":"","marginTop":10,"paddingLeftRight":0,"isShowCart":0,"cartStyle":1,"isShowGoodName":1,"isShowMarketPrice":1,"isShowGoodSaleNum":1,"isShowGoodSubTitle":0,"goodsTag":"default","tagImg":{"imageUrl":""},"addon_name":"","type":"GOODS_LIST","name":"商品列表","controller":"GoodsList","is_delete":"0"}]}', 'public/diy_view/style3/img/cover.png'),
(4, '母婴生活馆', '牛之云网络科技专注模板设计与开发，智能装修，操作简单，助您提升店铺装修视觉体验，提高店铺转化！售后有保障，牛之云网络科技愿竭诚为您服务！', 'motherandbaby_template', 'DIY_VIEW_INDEX', '{"global":{"title":"母婴生活馆","bgColor":"#ffffff","topNavColor":"#ffffff","topNavbg":false,"textNavColor":"#333333","topNavImg":"","moreLink":{"name":""},"openBottomNav":true,"navStyle":1,"textImgStyleLink":"1","textImgPosLink":"center","popWindow":{"imageUrl":"public\\/diy_view\\/style4\\/img\\/adv_supernatant.png","count":1,"link":{"name":""},"imgWidth":"362","imgHeight":"502"},"bgUrl":"public\\/diy_view\\/style4\\/img\\/bg_img.png","mpCollect":false},"value":[{"title":"搜索","textColor":"#999999","textAlign":"left","backgroundColor":"","bgColor":"#ffffff","defaultTextColor":"#999999","borderType":2,"searchType":1,"searchImg":"","searchStyle":1,"addon_name":"","type":"SEARCH","name":"商品搜索","controller":"Search","is_delete":"0"},{"selectedTemplate":"carousel-posters","imageClearance":0,"imageRadius":"fillet","carouselChangeStyle":"circle","marginTop":0,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style4\\/img\\/banner1.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"348"},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/banner2.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"349"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"textColor":"#666666","defaultTextColor":"#666666","backgroundColor":"","selectedTemplate":"imageNavigation","showType":5,"scrollSetting":"fixed","padding":20,"marginTop":5,"list":[{"imageUrl":"public\\/diy_view\\/style4\\/img\\/icon1.png","title":"爆款特卖","link":{"name":"GROUPBUY_PREFECTURE","menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","type":1,"wap_url":"\\/promotionpages\\/groupbuy\\/list\\/list","title":"团购专区"},"imgWidth":"127","imgHeight":"127"},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/icon2.png","title":"积分商城","link":{"name":"BARGAIN_PREFECTURE","menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","type":1,"wap_url":"\\/promotionpages\\/bargain\\/list\\/list","title":"砍价专区"},"imgWidth":"127","imgHeight":"127"},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/icon3.png","title":"儿童玩具","link":{"name":"MY_GIFT","menuOne":"MALL_PAGE","menuTwo":"MARKETING_LINK","type":1,"wap_url":"\\/otherpages\\/member\\/gift\\/gift","title":"我的礼品"},"imgWidth":"127","imgHeight":"127"},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/icon4.png","title":"签到积分","link":{"name":"MEMBER_INTEGRAL","menuOne":"MALL_PAGE","menuTwo":"MALL_LINK","type":1,"wap_url":"\\/otherpages\\/member\\/point\\/point","title":"我的积分"},"imgWidth":"127","imgHeight":"127"},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/icon5.png","title":"商品分类","link":{"name":"GOODS_CATEGORY","menuOne":"MALL_PAGE","menuTwo":"MALL_LINK","type":1,"wap_url":"\\/pages\\/goods\\/category\\/category","title":"商品分类"},"imgWidth":"127","imgHeight":"127"}],"addon_name":"","type":"GRAPHIC_NAV","name":"图文导航","navRadius":"fillet","controller":"GraphicNav","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":5,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style4\\/img\\/adv.png","title":"","link":{"name":""},"imgWidth":"732","imgHeight":"166"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"height":10,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-lt-of2-rt","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style4\\/img\\/adv1.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/adv2.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style4\\/img\\/adv3.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":10,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":30,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style4\\/img\\/title.png","title":"","link":{"name":""},"imgWidth":"750","imgHeight":"82"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","categoryId":0,"categoryName":"请选择","goodsCount":"6","goodsId":[],"style":"2","backgroundColor":"","marginTop":0,"paddingLeftRight":0,"isShowCart":0,"cartStyle":1,"isShowGoodName":1,"isShowMarketPrice":1,"isShowGoodSaleNum":1,"isShowGoodSubTitle":0,"goodsTag":"default","tagImg":{"imageUrl":""},"addon_name":"","type":"GOODS_LIST","name":"商品列表","controller":"GoodsList","is_delete":"0"}]}', 'public/diy_view/style4/img/cover.png'),
(5, '精品家居商城', '牛之云网络科技专注模板设计与开发，智能装修，操作简单，助您提升店铺装修视觉体验，提高店铺转化！售后有保障，牛之云网络科技愿竭诚为您服务！', 'furniture_template', 'DIY_VIEW_INDEX', '{"global":{"title":"精品家居商城","bgColor":"#ffffff","topNavColor":"#ffffff","topNavbg":false,"textNavColor":"#333333","topNavImg":"","moreLink":{"name":""},"openBottomNav":true,"navStyle":1,"textImgStyleLink":"1","textImgPosLink":"center","popWindow":{"imageUrl":"public\\/diy_view\\/style5\\/img\\/adv_supernatant.png","count":1,"link":{"name":""},"imgWidth":"362","imgHeight":"502"},"bgUrl":"public\\/diy_view\\/style5\\/img\\/bg_img.png","mpCollect":false},"value":[{"selectedTemplate":"carousel-posters","imageClearance":0,"imageRadius":"fillet","carouselChangeStyle":"circle","marginTop":0,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style5\\/img\\/banner1.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"348"},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/banner2.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"348"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"textColor":"#666666","defaultTextColor":"#666666","backgroundColor":"","selectedTemplate":"imageNavigation","showType":5,"scrollSetting":"fixed","padding":20,"marginTop":10,"list":[{"imageUrl":"public\\/diy_view\\/style5\\/img\\/icon1.png","title":"沙发","link":{"name":""},"imgWidth":"100","imgHeight":"100"},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/icon2.png","title":"床品","link":{"name":""},"imgWidth":"100","imgHeight":"100"},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/icon3.png","title":"柜子","link":{"name":""},"imgWidth":"100","imgHeight":"100"},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/icon4.png","title":"灯具","link":{"name":""},"imgWidth":"100","imgHeight":"100"},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/icon5.png","title":"更多","link":{"name":""},"imgWidth":"100","imgHeight":"100"}],"addon_name":"","type":"GRAPHIC_NAV","name":"图文导航","navRadius":"fillet","controller":"GraphicNav","is_delete":"0"},{"height":10,"backgroundColor":"","marginLeftRight":0,"addon_name":"","type":"HORZ_BLANK","name":"辅助空白","controller":"HorzBlank","is_delete":"0"},{"selectedTemplate":"row1-of3","backgroundColor":"","list":[{"imageUrl":"public\\/diy_view\\/style5\\/img\\/adv1.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/adv2.png","link":{"name":""}},{"imageUrl":"public\\/diy_view\\/style5\\/img\\/adv3.png","link":{"name":""}}],"selectedRubikCubeArray":[],"diyHtml":"","customRubikCube":4,"heightArray":["74.25px","59px","48.83px","41.56px"],"imageGap":15,"addon_name":"","type":"RUBIK_CUBE","name":"魔方","controller":"RubikCube","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":15,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style5\\/img\\/adv.png","title":"","link":{"name":""},"imgWidth":"702","imgHeight":"306"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"selectedTemplate":"single-graph","imageClearance":0,"imageRadius":"right-angle","carouselChangeStyle":"circle","marginTop":30,"padding":0,"height":0,"list":[{"imageUrl":"public\\/diy_view\\/style5\\/img\\/title.png","title":"","link":{"name":""},"imgWidth":"750","imgHeight":"82"}],"addon_name":"","type":"IMAGE_ADS","name":"图片广告","controller":"ImageAds","is_delete":"0"},{"sources":"default","categoryId":0,"categoryName":"请选择","goodsCount":"6","goodsId":[],"style":1,"backgroundColor":"","marginTop":0,"paddingLeftRight":0,"isShowCart":0,"cartStyle":1,"isShowGoodName":1,"isShowMarketPrice":1,"isShowGoodSaleNum":1,"isShowGoodSubTitle":0,"goodsTag":"default","tagImg":{"imageUrl":""},"addon_name":"","type":"GOODS_LIST","name":"商品列表","controller":"GoodsList","is_delete":"0"}]}', 'public/diy_view/style5/img/cover.png');
