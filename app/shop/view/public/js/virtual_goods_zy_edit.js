...
$(function () {
	...
	layui.use(['element', 'laytpl', 'form', 'laydate'], function () {
		...
		form.verify({
			...
			cash_pledge: function (value) {
				if (!$("input[name='cash_pledge']").is(":checked")) {
		...
		form.on('submit(save)', function (data) {
			...
			var url = ns.url("shop/goods/addzyGoods");
			if (data.field.goods_id) url = ns.url("shop/goods/editzyGoods");
	...
	if ($("input[name='spec_type']").is(":checked")) {
		...
		$(".js-edit-sku-list>div").each(function () {
			var item = {
				...
				cash_pledge:$(this).children("input[name='edit_cash_pledge']").val(),
