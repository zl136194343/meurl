...
Evaluate.prototype.getList = function(d) {
	...
	var is_image = d.is_image;
	var is_reply = d.is_reply;
	$.ajax({
		...
		success: function (res) {
			...
			for (var i in d) {
				...
				// if ((d[i].content != "" && d[i].explain_first == "") || (d[i].again_content != "" && d[i].again_explain == "")) {
				// 	html +=	'<a class="default layui-btn" lay-event="reply" onclick="replay(this)">回复</a>';
				// }
