...
return [
    ...
    //商品
    'REQUEST_GOODS_ATTRIBUTE_ID' => '缺少必须参数商品属性id',
    //会员相关
    ...
    "ORDER_STATUS_NOT_DELIVERY" => '订单当前不处于待发货状态' ,
    //店铺
    ...
    "SHOP_IS_CLOSE" => '店铺已关闭,如需正常营业，请订购店铺套餐或联系管理员重新开启',
    //基础系统
    ...
    'NOT_LOGIN' => '当前未登录',
    'USERNAME_EXISTED_REGISTERED'=>'当前用户已注册商户',
    ...
    'IS_VERIFYED' => '核销码已被使用',
    'EMPTY_BIND_MEMBER' => '绑定核销员时,会员不可为空',

    //满减
    'GOODS_EXIST_MANJIAN' => '当前活动商品已存在满减送',
