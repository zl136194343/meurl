...
Vue.component("text-font-size", {
	...
	created: function () {
		...
		if (this.data.max == 12) {
			this.list = [{label: "小", value: "12", src: textResourcePath + "/text/img/font_12.png", selectedSrc: textResourcePath + "/text/img/font_12_1"+url+".png"}];
		} else if (this.data.max == 14) {
			this.list = [
				{label: "小", value: "12", src: textResourcePath + "/text/img/font_12.png", selectedSrc: textResourcePath + "/text/img/font_12_1"+url+".png"},
				{label: "中", value: "14", src: textResourcePath + "/text/img/font_14.png", selectedSrc: textResourcePath + "/text/img/font_14_1"+url+".png"}
			]
		} else {
			this.list = [
				{label: "小", value: "12", src: textResourcePath + "/text/img/font_12.png", selectedSrc: textResourcePath + "/text/img/font_12_1"+url+".png"},
				{label: "中", value: "14", src: textResourcePath + "/text/img/font_14.png", selectedSrc: textResourcePath + "/text/img/font_14_1"+url+".png"},
				{label: "大", value: "16", src: textResourcePath + "/text/img/font_16.png", selectedSrc: textResourcePath + "/text/img/font_16_1"+url+".png"}
			];
		}
	},
	watch: {
