			...
			imgAdsRadius: [
				{
					...
					selectedSrc: imageAdsResourcePath + "/image_ads/img/right-angle_1"+url+".png"
				},
				{
					text: "圆角",
					value: "fillet",
					src: imageAdsResourcePath + "/image_ads/img/fillet.png",
					selectedSrc: imageAdsResourcePath + "/image_ads/img/fillet_1"+url+".png"
				}
			],
		}
	},
			...
			imgAdsCarousel: [
				{
					...
					selectedSrc: imageAdsResourcePath + "/image_ads/img/circle_1"+url+".png"
				},
				{
					text: "直线",
					value: "line",
					src: imageAdsResourcePath + "/image_ads/img/line.png",
					selectedSrc: imageAdsResourcePath + "/image_ads/img/line_1"+url+".png"
				}
			],
		}
	},
