	...
	data : function(){
		...
		return {
			...
			selectedTemplateList : [{
				...
				selectedSrc: graphicNavResourcePath + "/graphic_nav/img/img_1"+url+".png"
			},{
				name : '文字导航',
				value : 'textNavigation',
				src : graphicNavResourcePath + "/graphic_nav/img/font.png",
				selectedSrc: graphicNavResourcePath + "/graphic_nav/img/font_1"+url+".png"
			}],
			showTypeList: [{
				name : '一行三个',
				value : '3',
				src : graphicNavResourcePath + "/graphic_nav/img/three.png",
				selectedSrc: graphicNavResourcePath + "/graphic_nav/img/three_1"+url+".png"
			}, {
				name : '一行四个',
				value : '4',
				src : graphicNavResourcePath + "/graphic_nav/img/four.png",
				selectedSrc: graphicNavResourcePath + "/graphic_nav/img/four_1"+url+".png"
			}, {
				name : '一行五个',
				value : '5',
				src : graphicNavResourcePath + "/graphic_nav/img/five.png",
				selectedSrc: graphicNavResourcePath + "/graphic_nav/img/five_1"+url+".png"
			}]
		};
	},
			...
			navRadius: [
				{
					...
					selectedSrc: graphicNavResourcePath + "/graphic_nav/img/right-angle_1"+url+".png"
				},
				{
					text: "圆角",
					value: "fillet",
					src: graphicNavResourcePath + "/graphic_nav/img/fillet.png",
					selectedSrc: graphicNavResourcePath + "/graphic_nav/img/fillet_1"+url+".png"
				}
			],
		}
	},
