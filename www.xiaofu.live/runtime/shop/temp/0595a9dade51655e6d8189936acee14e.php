<?php /*a:2:{s:70:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\shop\view\promotion\index.html";i:1671499746;s:59:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\shop\view\base.html";i:1671499744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-card ns-card-common ns-card-brief" id="promotion">
	...
	<div class="layui-card-body">
		<div class="ns-item-block-parent ns-item-five" id="promotion-item">
			...
			<?php endif; ?>
			<?php endif; ?>
			<?php endforeach; foreach($promotion as $list_k => $list_v): if($list_v['show_type'] == 'admin'): if(empty($list_v['is_developing']) || (($list_v['is_developing'] instanceof \think\Collection || $list_v['is_developing'] instanceof \think\Paginator ) && $list_v['is_developing']->isEmpty())): ?>
			<a class="ns-item-block ns-item-block-hover-a" href="<?php echo addon_url($list_v['url']); ?>">
				<div class="ns-item-block-wrap">
					<div class="ns-item-pic">
						<img src="<?php echo img($list_v['icon']); ?>" />
...
<div class="layui-card ns-card-common ns-card-brief" id="interaction">
	<div class="layui-card-header">
		<span class="ns-card-title">会员营销</span>
	</div>
