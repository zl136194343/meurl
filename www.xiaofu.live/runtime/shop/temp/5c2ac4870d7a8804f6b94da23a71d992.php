<?php /*a:2:{s:59:"/www/wwwroot/www.hunqin.com/app/shop/view/member/grouplists.html";i:1668561894;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/html" id="action">
	<div class="ns-table-btn">
		<a class="layui-btn" lay-event="setReminders">添加提醒</a>
	</div>
</script>
...
layui.use(['form', 'laydate','laytpl'], function () {
    ...
    function setReminders(data){
		...
		location.href = ns.url('shop/member/tixingAdd?id='+data);
    }
