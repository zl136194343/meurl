<?php /*a:2:{s:69:"D:\phpstudy_pro\WWW\www.hunqin.com\app\shop\view\goods\add_goods.html";i:1671499743;s:58:"D:\phpstudy_pro\WWW\www.hunqin.com\app\shop\view\base.html";i:1671499743;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="http://www.xmp.com/public/static/img/shop_bitbug_favicon.ico" />
	<link rel="stylesheet" type="text/css" href="http://www.xmp.com/public/static/css/iconfont.css" />
	<link rel="stylesheet" type="text/css" href="http://www.xmp.com/public/static/ext/layui/css/layui.css" />
	<link rel="stylesheet" type="text/css" href="http://www.xmp.com/app/shop/view/public/css/common.css" />
	<script src="http://www.xmp.com/public/static/js/jquery-3.1.1.js"></script>
	<script src="http://www.xmp.com/public/static/ext/layui/layui.js"></script>
	<script src="http://www.xmp.com/public/static/js/jquery.cookie.js"></script> 
	<script src="https://cdn.jsdelivr.net/npm/js-cookie@2/src/js.cookie.min.js"></script>
	<script>
		layui.use(['layer', 'upload', 'element'], function() {});
		var nsColor = '#FF6A00';
		window.ns_url = {
			baseUrl: "http://www.xmp.com/",
			route: ['<?php echo request()->module(); ?>', '<?php echo request()->controller(); ?>', '<?php echo request()->action(); ?>'],
			IMGPATH:"http://www.xmp.com/app/shop/view/public/img/",
			site_id:"<?php echo isset($site_id) ? htmlentities($site_id) : 0; ?>"
		};
	</script>
	<script src="http://www.xmp.com/public/static/js/common.js"></script>
	<script src="http://www.xmp.com/app/shop/view/public/js/common.js"></script>
	<style>
		.ns-calendar{background: url("http://www.xmp.com/public/static/img/ns_calendar.png") no-repeat center / 16px 16px;}
...
<link rel="stylesheet" href="http://www.xmp.com/public/static/ext/video/video.css">
<link rel="stylesheet" type="text/css" href="http://www.xmp.com/public/static/ext/searchable_select/searchable_select.css" />
<link rel="stylesheet" type="text/css" href="http://www.xmp.com/public/static/css/common.css" />
<link rel="stylesheet" type="text/css" href="http://www.xmp.com/public/static/css/main.css" />
<link rel="stylesheet" type="text/css" href="http://www.xmp.com/app/shop/view/public/css/goods_edit.css" />
		...
		<div class="layui-header">
			<div class="layui-logo">
				<a href="">
					...
					<img src="<?php echo img($shop_info['logo']); ?>" onerror=src="http://www.xmp.com/app/shop/view/public/img/shop_logo.png">
					<!-- <h1>开源商城</h1> -->
					<?php else: ?>
					<img src="http://www.xmp.com/app/shop/view/public/img/shop_logo.png">
					<?php endif; ?>
				</a>
			</div>
					...
					<li class="layui-nav-item <?php if($menu_second_v['selected']): ?>layui-this layui-nav-itemed<?php endif; ?>">
						<a href="<?php if(empty($menu_second_v['child_list']) || (($menu_second_v['child_list'] instanceof \think\Collection || $menu_second_v['child_list'] instanceof \think\Paginator ) && $menu_second_v['child_list']->isEmpty())): ?><?php echo htmlentities($menu_second_v['url']); else: ?>javascript:;<?php endif; ?>" class="layui-menu-tips">
							<div class="stair-menu<?php if($menu_v['selected']): ?> ative<?php endif; ?>">
								<img src="http://www.xmp.com/<?php echo htmlentities($menu_second_v['icon']); ?>" alt="">
							</div>
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-card ns-card-common">
					...
					<div class="layui-card-body commodity-type-box" >
						...
						<?php if($shop_info['group_id'] != 2): ?>
						<div class="commodity-type-item" onclick="location.href = ns.url('shop/goods/addzyGoods')">
							<span>租赁商品</span>
							<span>(无需物流)</span>
						</div>
						<?php endif; ?>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="video-thumb">
									<video id="goods_video" class="video-js vjs-big-play-centered" controls="" poster="http://www.xmp.com/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
									<video id="temp_goods_video" class="video-js vjs-big-play-centered" controls="" poster="http://www.xmp.com/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
...
<!--						</div>-->
						...
						<div class="layui-form-item yajin" style="display: none" >
							<label class="layui-form-label">押金：</label>
							<div class="layui-input-block" >
								<input type="text" name="cash_pledge" placeholder="请输入押金" autocomplete="off" class="layui-input ns-len-short">
							</div>

						</div>
						<!--<div class="layui-form-item">
							<label class="layui-form-label">是否为租赁：</label>
							<div class="layui-input-block" >
								<input type="radio" name="is_lease" class="getis_lease" value="1" title="是"  lay-filter="is_lease">
								<input type="radio" name="is_lease" class="getis_lease" value="0" title="不是" checked lay-filter="is_lease">
							</div>
			...
			<div class="layui-tab-item">
				...
				<script type="text/javascript" charset="utf-8" src="http://www.xmp.com/public/static/ext/ueditor/ueditor.config.js"></script>
				<script type="text/javascript" charset="utf-8" src="http://www.xmp.com/public/static/ext/ueditor/ueditor.all.js"> </script>
				<script type="text/javascript" charset="utf-8" src="http://www.xmp.com/public/static/ext/ueditor/lang/zh-cn/zh-cn.js"></script>
			</div>
					...
					<ul>
						...
						<li data-index="{{j}}" data-parent-index="{{i}}" >
							...
							<div class="img-wrap">
								...
								{{# }else{ }}
								<img src="http://www.xmp.com/app/shop/view/public/img/goods_spec_value_empty.png" alt="">
								{{# } }}
							</div>
							{{# } }}
...
<!--					<a href="#"><img style="-webkit-filter: grayscale(100%);-moz-filter: grayscale(100%);-ms-filter: grayscale(100%);-o-filter: grayscale(100%);filter: grayscale(100%);filter: gray;" src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>http://www.xmp.com/public/static/img/copyright_logo.png<?php endif; ?>" /></a>-->
<!--				</div>-->
<!--			</div>-->

			<!--<div class="ns-footer">-->
			<!--	-->
			<!--	<a class="ns-footer-img" href="#"><img src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>http://www.xmp.com/public/static/img/copyright_logo.png<?php endif; ?>" /></a>-->
			<!--	-->
			<!--</div>-->
...
<script src="http://www.xmp.com/public/static/ext/drag-arrange.js"></script>
<script src="http://www.xmp.com/public/static/ext/video/videojs-ie8.min.js"></script>
<script src="http://www.xmp.com/public/static/ext/video/video.min.js"></script>
<script src="http://www.xmp.com/public/static/ext/searchable_select/searchable_select.js"></script>
<script src="http://www.xmp.com/app/shop/view/public/js/goods_edit.js"></script>
<script src="http://www.xmp.com/app/shop/view/public/js/category_select.js"></script>
<script>
	function insRow()
	{
