<?php /*a:2:{s:66:"/www/wwwroot/ls.chnssl.com/app/shop/view/express/add_template.html";i:1614516192;s:50:"/www/wwwroot/ls.chnssl.com/app/shop/view/base.html";i:1660100996;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form" >
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="template_name" type="text" placeholder="请输入模版名称" lay-verify="required" class="layui-input ns-len-long" autocomplete="off">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<?php foreach($fee_type_obj as $fee_type_k => $fee_type_v): ?>
			<input type="radio" lay-filter="fee_type"  name="json" value="<?php echo htmlentities($fee_type_k); ?>" title="<?php echo htmlentities($fee_type_v['name']); ?>" <?php if($fee_type_k == 1): ?> checked <?php endif; ?>>
			<?php endforeach; ?>
		</div>
	</div>
	<div class="layui-form-item">
...
<input type="hidden" value='<?php echo htmlentities($area_level); ?>' id="area_level"/><!-- 配送地区等级 -->
<input type="hidden" value='<?php echo htmlentities($fee_type_json); ?>' id="fee_type_json"/><!-- 计费方式相关数据 -->
...
<script type='text/javascript' src='https://ls.chnssl.com/app/shop/view/public/js/express_add_template.js'></script>
