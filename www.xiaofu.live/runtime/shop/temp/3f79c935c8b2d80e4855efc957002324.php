<?php /*a:2:{s:62:"/www/wwwroot/www.hunqin.com/app/shop/view/verify/add_user.html";i:1614516282;s:51:"/www/wwwroot/www.hunqin.com/app/shop/view/base.html";i:1654828558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
	...
	.ns-check-member .layui-btn{position:absolute;top:1px;border-color:#e5e5e5;padding:0 10px;border-right:0;border-top:0;border-bottom:0;left:207px;height:32px}
	.ns-check-admin .layui-btn{position:absolute;top:2px;border-color:#e5e5e5;padding:0 10px;border-right:0;border-top:0;border-bottom:0;left:207px;height:31px}
...
<div class="layui-form ns-form">
    ...
    <div class="layui-form-item ns-check-member-box">
        ...
        <div class="layui-input-block ns-check-member">
            ...
            <input class="ns-member-id" type="hidden" name="member_id" lay-verify="required" />
        </div>
