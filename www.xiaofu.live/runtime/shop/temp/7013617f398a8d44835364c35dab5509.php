<?php /*a:2:{s:73:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\shop\view\goods\add_zy_goods.html";i:1671499744;s:59:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\shop\view\base.html";i:1671499744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="icon" type="image/x-icon" href="http://192.168.21.43/public/static/img/shop_bitbug_favicon.ico" />
	...
	<link rel="stylesheet" type="text/css" href="http://192.168.21.43/app/shop/view/public/css/common.css" />
	...
	<script>
		...
		window.ns_url = {
			...
			IMGPATH:"http://192.168.21.43/app/shop/view/public/img/",
			site_id:"<?php echo isset($site_id) ? htmlentities($site_id) : 0; ?>"
		};
	</script>
	<script src="http://192.168.21.43/public/static/js/common.js"></script>
	<script src="http://192.168.21.43/app/shop/view/public/js/common.js"></script>
	<style>
...
<link rel="stylesheet" href="http://192.168.21.43/public/static/ext/video/video.css">
<link rel="stylesheet" type="text/css" href="http://192.168.21.43/public/static/ext/searchable_select/searchable_select.css" />
<link rel="stylesheet" type="text/css" href="http://192.168.21.43/app/shop/view/public/css/goods_edit.css" />
		...
		<div class="layui-header">
			<div class="layui-logo">
				<a href="">
					...
					<img src="<?php echo img($shop_info['logo']); ?>" onerror=src="http://192.168.21.43/app/shop/view/public/img/shop_logo.png">
					<!-- <h1>开源商城</h1> -->
					<?php else: ?>
					<img src="http://192.168.21.43/app/shop/view/public/img/shop_logo.png">
					<?php endif; ?>
				</a>
			</div>
					...
					<li class="layui-nav-item <?php if($menu_second_v['selected']): ?>layui-this layui-nav-itemed<?php endif; ?>">
						<a href="<?php if(empty($menu_second_v['child_list']) || (($menu_second_v['child_list'] instanceof \think\Collection || $menu_second_v['child_list'] instanceof \think\Paginator ) && $menu_second_v['child_list']->isEmpty())): ?><?php echo htmlentities($menu_second_v['url']); else: ?>javascript:;<?php endif; ?>" class="layui-menu-tips">
							<div class="stair-menu<?php if($menu_v['selected']): ?> ative<?php endif; ?>">
								<img src="http://192.168.21.43/<?php echo htmlentities($menu_second_v['icon']); ?>" alt="">
							</div>
			...
			<div class="layui-tab-item layui-show">
				...
				<div class="layui-card ns-card-common">
					...
					<div class="layui-card-body commodity-type-box" >
						...
						<div class="commodity-type-item ns-border-color" onclick="location.href = ns.url('shop/goods/addzyGoods')">
							<span class="ns-text-color">租赁商品</span>
							<span>(无需物流)</span>
						</div>
						<?php endif; ?>
					</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="video-thumb">
									<video id="goods_video" class="video-js vjs-big-play-centered" controls="" poster="http://192.168.21.43/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
									<video id="temp_goods_video" class="video-js vjs-big-play-centered" controls="" poster="http://192.168.21.43/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
					...
					<div class="layui-card-body">
						...
						<div class="js-single-spec">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="cash_pledge" placeholder="0.00" class="layui-input ns-len-short" lay-verify="cash_pledge" autocomplete="off">
									<div class="layui-form-mid">元</div>
								</div>
								<div class="ns-word-aux">成本价将不会对前台会员展示，用于商家统计使用</div>
							</div>
...
<!--						</div>-->
			...
			<div class="layui-tab-item">
				...
				<script type="text/javascript" charset="utf-8" src="http://192.168.21.43/public/static/ext/ueditor/ueditor.config.js"></script>
				<script type="text/javascript" charset="utf-8" src="http://192.168.21.43/public/static/ext/ueditor/ueditor.all.js"> </script>
				<script type="text/javascript" charset="utf-8" src="http://192.168.21.43/public/static/ext/ueditor/lang/zh-cn/zh-cn.js"></script>
			</div>
					...
					<ul>
						...
						<li data-index="{{j}}" data-parent-index="{{i}}" >
							...
							<div class="img-wrap">
								...
								{{# }else{ }}
								<img src="http://192.168.21.43/app/shop/view/public/img/goods_spec_value_empty.png" alt="">
								{{# } }}
							</div>
							{{# } }}
...
<script type="text/html" id="skuTableTemplate">
	...
	<table class="layui-table">
		...
		<tr>
			...
			<td>
				<input type="text" name="cash_pledge" placeholder="押金" value="{{d.skuList[i].stock}}" lay-verify="cash_pledge" class="layui-input ns-len-small" autocomplete="off" data-index="{{i}}">
			</td>
...
<!--					<a href="#"><img style="-webkit-filter: grayscale(100%);-moz-filter: grayscale(100%);-ms-filter: grayscale(100%);-o-filter: grayscale(100%);filter: grayscale(100%);filter: gray;" src="<?php if(!empty($copyright['logo'])): ?> <?php echo img($copyright['logo']); else: ?>http://192.168.21.43/public/static/img/copyright_logo.png<?php endif; ?>" /></a>-->
<!--				</div>-->
<!--			</div>-->
...
<script src="http://192.168.21.43/public/static/ext/drag-arrange.js"></script>
<script src="http://192.168.21.43/public/static/ext/video/videojs-ie8.min.js"></script>
<script src="http://192.168.21.43/public/static/ext/video/video.min.js"></script>
<script src="http://192.168.21.43/public/static/ext/searchable_select/searchable_select.js"></script>
<script src="http://192.168.21.43/app/shop/view/public/js/virtual_goods_zy_edit.js"></script>
<script src="http://192.168.21.43/app/shop/view/public/js/category_zy_select.js"></script>
