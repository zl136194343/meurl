<?php /*a:2:{s:68:"/www/wwwroot/www.hunqin.com/addon/weapp/admin/view/weapp/config.html";i:1671499690;s:24:"app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="text" name="token" readonly id="callback_url" autocomplete="off" class="layui-input ns-len-long" value="<?php echo htmlentities($url); ?>">
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline">
                        <input type="text" name="token" autocomplete="off" id="empowerToken" class="layui-input ns-len-long" value="<?php echo isset($config_info['token']) ? htmlentities($config_info['token']) : ''; ?>">
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-input-inline ns-len-long">
                        <input class="layui-input" type="text" name="encodingaeskey" id="encodingaeskey" autocomplete="off" value="<?php echo isset($config_info['encodingaeskey']) ? htmlentities($config_info['encodingaeskey']) : ''; ?>">
                    </div>
...
<script type="text/javascript">
    layui.use(['form'], function () {
        ...
        form.on('submit(save)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo addon_url('weapp://admin/weapp/config'); ?>",
                dataType: "JSON",
                data: data.field,
    ...
    function back() {
        location.href = "<?php echo addon_url('weapp://admin/weapp/setting'); ?>";
    }
