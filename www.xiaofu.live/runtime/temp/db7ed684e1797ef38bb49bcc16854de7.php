<?php /*a:2:{s:70:"/www/wwwroot/www.hunqin.com/addon/wechatpay/admin/view/pay/config.html";i:1671499696;s:24:"app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="mch_id" type="text" value="<?php echo isset($info['value']['mch_id']) ? htmlentities($info['value']['mch_id']) : ''; ?>" class="layui-input ns-len-long">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<textarea name="pay_signkey" class="layui-textarea ns-len-long"><?php echo isset($info['value']['pay_signkey']) ? htmlentities($info['value']['pay_signkey']) : ''; ?></textarea>
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="apiclient_cert" class="layui-input ns-len-long" value="<?php echo isset($info['value']['apiclient_cert']) ? htmlentities($info['value']['apiclient_cert']) : ''; ?>">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="apiclient_key" class="layui-input ns-len-long" value="<?php echo isset($info['value']['apiclient_key']) ? htmlentities($info['value']['apiclient_key']) : ''; ?>">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="ns-input-text">
			<?php foreach($app_type as $app_type_k => $app_type_v): if($app_type_v['name'] !='支付宝小程序'): ?>
