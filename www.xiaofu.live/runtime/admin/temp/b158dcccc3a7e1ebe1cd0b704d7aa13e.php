<?php /*a:2:{s:78:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/config/lianxi.html";i:1675474568;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box <?php if(!(empty($info['default_shop_img']) || (($info['default_shop_img'] instanceof \think\Collection || $info['default_shop_img'] instanceof \think\Paginator ) && $info['default_shop_img']->isEmpty()))): ?>hover<?php endif; ?>">
					<div class="ns-upload-default" id="imgUploadShop">
						<?php if($info['default_shop_img']): ?>
						<div id="preview_imgUploadShop" class="preview_img">
							<img layer-src src="<?php echo img($info['default_shop_img']); ?>" class="img_prev"/>
						</div>
						<?php else: ?>
						<div class="upload">
					...
					<input type="hidden" name="default_shop_img" value="<?php echo htmlentities($info['default_shop_img']); ?>">
				</div>
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box <?php if(!(empty($info['default_gzh_img']) || (($info['default_gzh_img'] instanceof \think\Collection || $info['default_gzh_img'] instanceof \think\Paginator ) && $info['default_gzh_img']->isEmpty()))): ?>hover<?php endif; ?>">
					<div class="ns-upload-default" id="imgUploadGoods">
						<?php if($info['default_gzh_img']): ?>
						<div id="preview_imgUploadGzh" class="preview_img">
							<img layer-src src="<?php echo img($info['default_gzh_img']); ?>" class="img_prev"/>
						</div>
						<?php else: ?>
						<div class="upload">
							<img src="https://www.xiaofu.live/app/admin/view/public/img/upload_img.png"/>
					...
					<input type="hidden" name="default_gzh_img" value="<?php echo htmlentities($info['default_gzh_img']); ?>">
				</div>
			</div>
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">已加入群人数：</label>
		<div class="layui-input-block">
		<div class="layui-input-inline">
			<input type="number" name="ylsc" value="<?php echo htmlentities($info['ylsc']); ?>" lay-verify="positiv" autocomplete="off" class="layui-input ns-len-short">
		</div>
			<span class="layui-form-mid">人</span>
		</div>
...
<script>
	layui.use(['form'], function() {
        ...
        form.on('submit(save)', function(data) {
            ...
            $.ajax({
                type: "POST",
                url: ns.url("admin/config/lianxi"),
                data: data.field,
                dataType: 'JSON',
                success: function(res) {
                    repeat_flag = false;
