<?php /*a:2:{s:83:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\goodscategory\edit_category.html";i:1679462884;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!--	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="checkbox" name="is_jifen" lay-skin="switch" value="1" <?php if($goods_category_info['is_jifen']==1): ?>checked<?php endif; ?> >
		</div>
		<div class="ns-word-aux">
			<p>用于积分分类展示与选择</p>
		</div>
...
<script src="http://192.168.21.43/app/admin/view/public/js/goods_edit_category.js"></script>
