<?php /*a:2:{s:74:"/www/wwwroot/www.hunqin.com/app/admin/view/dtgl/memberlabel/add_label.html";i:1671504200;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1671499700;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div  class="layui-form ns-form">
	...
	<div class="ns-form-row">
		...
		<button class="layui-btn layui-btn-primary" onclick="window.location.href='<?php echo addon_url("admin/card/biaoqian"); ?>'">返回</button>
	</div>
</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/card/addLabel"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST', 
				success: function(res) {
					...
					if (res.code == 0) {
						layer.confirm('添加成功', {
							...
							btn: ['返回列表', '继续添加'],
							yes: function(){
								location.href = ns.url("admin/card/biaoqian")
							},
							btn2: function() {
								location.href = ns.url("admin/card/addLabel")
							}
						});
					}else{
						layer.msg(res.message);
