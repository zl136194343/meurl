<?php /*a:2:{s:73:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\notice\add_notice.html";i:1679620252;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!--	<div class="layui-form-item">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
				<input type="radio" name="type" value="0" title="平台" autocomplete="off" class="layui-input ns-len-long" checked>
			<input type="radio" name="type" value="1" title="企业公告" autocomplete="off" class="layui-input ns-len-long">
			<input type="radio" name="type" value="2" title="产品公告" autocomplete="off" class="layui-input ns-len-long">
			<input type="radio" name="type" value="3" title="信息公告" autocomplete="off" class="layui-input ns-len-long">
...
<script type="text/javascript">
	...
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			/* var url = ns.url("admin/notice/addNotice");
			if (data.field.id != undefined) url = ns.url("admin/notice/editNotice"); */
			
			if (repeat_flag) return;
			repeat_flag = true;
			
			$.ajax({
				url: ns.url("admin/notice/addNotice"),
				data: data.field,
				type: "POST",
				dataType: "JSON",
				success: function(res) {
