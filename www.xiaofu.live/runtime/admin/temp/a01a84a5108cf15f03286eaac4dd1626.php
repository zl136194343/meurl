<?php /*a:2:{s:75:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\dtgl\category\lists.html";i:1680767768;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<style>
	...
	.js-switch{display: inline-block;height:30px;text-align: center;}
	.table_move{
...
<div class="ns-single-filter-box">
	<button class="layui-btn ns-bg-color" onclick="addCategory()">添加动态分类</button>
</div>
	...
	<div class="table_div" >
		...
		<div  class="table_body">
			...
			<div class="table_one" data-index="<?php echo htmlentities($index); ?>" data-sort="<?php echo htmlentities($vo['sort']); ?>" data-cateid="<?php echo htmlentities($vo['id']); ?>" >
				<div class="table_tr" style="padding-left:45px">
					<div class="table_td" style="flex:6">
						<div class="table_move iconfont icontuodong"></div>

						<span class="switch ns-text-color js-switch"  data-open="0">
					...
					<div class="table_td" style="flex:2">
						...
						<div class="ns-img-box">
							<img layer-src src="<?php echo img($vo['img']); ?>"/>
						</div>
						<?php endif; ?>
					</div>
					 <div class="table_td" style="flex:2">
						<input type="number" class="layui-input ns-len-short" value="<?php echo htmlentities($vo['sort']); ?>" onchange="editSort('<?php echo htmlentities($vo['id']); ?>')" id="category_sort<?php echo htmlentities($vo['id']); ?>">
					</div>

					<div class="table_td" style="flex:2">
						<div class="ns-table-btn">
							<a class="layui-btn" href="<?php echo addon_url('admin/dtgl/editcategory',['category_id'=>$vo['id']]); ?>">编辑</a>
...
<script src="http://www.xiaofuaaa.com/public/static/ext/drag-arrange.js"></script>
<script src="http://www.xiaofuaaa.com/public/static/ext/diyview/js/ddsort.js"></script>
<script>
...
function deleteCategory(category_id,level) {
	...
	layer.confirm('确定要删除吗?', function() {
		$.ajax({
			url: ns.url("admin/dtgl/deleteCategory"),
...
function addCategory() {
	location.href = ns.url("admin/dtgl/addcategory");
}
...
function editSort(category_id) {
    ...
    $.ajax({
        type: 'POST',
        url: ns.url("admin/dtgl/modifySort"),
        data: {
            sort: sort,
