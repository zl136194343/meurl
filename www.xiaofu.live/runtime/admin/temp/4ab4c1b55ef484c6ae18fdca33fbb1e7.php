<?php /*a:2:{s:72:"/www/wwwroot/ls.chnssl.com/app/admin/view/community/goodsattr/grouplists.html";i:1657517005;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1654841781;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script>
	...
	layui.use(['form', 'laytpl'], function() {
		...
		table = new Table({
			...
			url: ns.url("admin/comsattr/lists"),
			cols: [
				[ {
					field: 'class_name',
					title: '商品参数名称',
		...
		table.tool(function(obj) {
			...
			switch (obj.event) {
				case 'edit':
					location.href = ns.url("admin/comsattr/editattr?class_id=" + data.class_id);
					break;
				case 'delete':
		...
		function deleteAttr(class_id) {
			layer.confirm('删除类型后将会删除对应关联关系，移除后数据会发生不可逆转的行为，请谨慎操作', function() {
				$.ajax({
					url: ns.url("admin/comsattr/deleteAttr"),
					data: {
						class_id: class_id
					},
					dataType: 'JSON',
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: '<?php echo addon_url("admin/comsattr/addAttr"); ?>',
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
	...
	function editSort(id, event) {
		...
		$.ajax({
			type: 'POST',
			url: ns.url("admin/comsattr/modifySort"),
			data: {
				sort: data,
				class_id: id
			},
