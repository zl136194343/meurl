<?php /*a:2:{s:68:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\order\config.html";i:1671499712;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	<div class="layui-card ns-card-common ns-card-brief">
		...
		<div class="layui-card ns-card-common ns-card-brief">
			...
			<div class="layui-card ns-card-common ns-card-brief">
    			<div class="layui-card-header">
    				<span class="ns-card-title">佣金比例</span>
    			</div>
    		<!--	<div class="layui-card-body">
    				<div class="layui-form-item">
    					<label class="layui-form-label">会员充值佣金比例：</label>
    					<div class="layui-input-block">
    						<div class="layui-input-inline">
    							<input type="number" name="check_rate" value="<?php echo htmlentities($CheckRate['check_rate']); ?>" lay-verify="positivEinteger" autocomplete="off" class="layui-input ns-len-short">
    						</div>
    			...
    			<div class="layui-card-body">
    				<div class="layui-form-item">
    					<label class="layui-form-label">会员购买商品佣金比例：</label>
    					<div class="layui-input-block">
    						<div class="layui-input-inline">
    							<input type="number" name="check_good_rate" value="<?php echo htmlentities($GoodsRate['check_goods_rate']); ?>" lay-verify="positivEinteger" autocomplete="off" class="layui-input ns-len-short">
    						</div>
    						<span class="layui-form-mid">%</span>
    					</div>
    					<div class="ns-word-aux">比率必须为0-100的整数</div>
