<?php /*a:2:{s:77:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/system/addon.html";i:1671499722;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="layui-body<?php if(empty($second_menu) || (($second_menu instanceof \think\Collection || $second_menu instanceof \think\Paginator ) && $second_menu->isEmpty())): ?> child_no_exit<?php endif; ?>">
		...
		<div class="ns-body-content <?php if(count($second_menu) < 1): ?> crumbs_no_exit<?php endif; ?>">
			<div class="ns-body">
				...
				<?php endif; if(!(empty($uninstall) || (($uninstall instanceof \think\Collection || $uninstall instanceof \think\Paginator ) && $uninstall->isEmpty()))): ?>
				...
				<div class="ns-item-float-wrap">
					<div class="ns-item-float">
						<div class="ns-item-float-con">
							...
							<span><?php if($list_v['download'] == 1): ?>未下载<?php else: ?>未安装<?php endif; ?></span>
						</div>
						<?php if($list_v['download'] == 0): ?>
						<div class="ns-item-float-con" onclick="manage('<?php echo htmlentities($list_v['name']); ?>', 'install')">
							<span>安装</span>
						</div>
						<?php endif; ?>
					</div>
		...
		<div class="site_list ns-item-block-parent ns-item-five">
			...
			<a class="ns-item-block ns-item-block-hover" href="#">
				<div class="ns-item-block-wrap">
					...
					<div class="ns-item-con">
						<div class="ns-item-content-title"><?php echo htmlentities($list_v['title']); ?>
						</div>
						<p class="ns-item-content-desc ns-line-hiding" title="<?php echo htmlentities($list_v['description']); ?>"><?php echo htmlentities($list_v['description']); ?></p>
					</div>
				</div>
				<div class="ns-item-float-wrap">
					<div class="ns-item-float">
						...
						<div class="ns-item-float-con" onclick="manage('<?php echo htmlentities($list_v['name']); ?>', 'uninstall')">
							<span>卸载</span>
						</div>
					</div>
				</div>
