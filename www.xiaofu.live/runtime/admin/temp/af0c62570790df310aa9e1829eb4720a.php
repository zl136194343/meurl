<?php /*a:2:{s:71:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\help\edit_class.html";i:1671499710;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form" >
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input name="class_name" type="text" placeholder="请输入类型名称" value="<?php echo htmlentities($class_info['data']['class_name']); ?>" lay-verify="required" class="layui-input ns-len-mid">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input name="sort" type="number" placeholder="请输入排序值" value="<?php echo htmlentities($class_info['data']['sort']); ?>" lay-verify="num" class="layui-input ns-len-short">
		</div>
	...
	<input type="hidden" name="class_id" value="<?php echo htmlentities($class_info['data']['class_id']); ?>" />
</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/help/editClass"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res){
