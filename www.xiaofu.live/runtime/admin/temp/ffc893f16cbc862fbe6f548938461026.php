<?php /*a:2:{s:60:"/www/wwwroot/ls.chnssl.com/app/admin/view/h5/refresh_h5.html";i:1616032150;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1660099950;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="radio" name="deploy_way" value="default" lay-filter="deploy_way" title="默认部署" data-desc="无需下载，一键刷新，API接口请求地址为当前域名，编译代码存放到h5文件夹中" <?php if($config['deploy_way'] == 'default'): ?>checked<?php endif; ?> />
			<input type="radio" name="deploy_way" value="indep" lay-filter="deploy_way" title="独立部署" data-desc="可下载编译包或源码包进行独立部署" <?php if($config['deploy_way'] == 'indep'): ?>checked<?php endif; ?>/>
		</div>
    ...
    <div class="deploy-way default <?php if($config['deploy_way'] != 'default'): ?>layui-hide<?php endif; ?>">
        <div class="layui-form-item web-url">
            ...
            <div class="layui-input-block">
                <a href="<?php echo htmlentities($root_url); ?>/h5" target="_blank" class="ns-text-color"><?php echo htmlentities($root_url); ?>/h5</a>
            </div>
        </div>
    ...
    <div class="deploy-way indep <?php if($config['deploy_way'] != 'indep'): ?>layui-hide<?php endif; ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">手机端域名：</label>
            <div class="layui-input-block">
                <input type="text" name="domain" lay-verify="domain" <?php if($config['deploy_way'] == 'indep'): ?>value="<?php echo isset($config['domain_name_h5']) ? htmlentities($config['domain_name_h5']) : ''; ?>"<?php endif; ?> autocomplete="off" class="layui-input ns-len-long">
            </div>
