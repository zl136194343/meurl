<?php /*a:2:{s:88:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/dtgl/dtgl/evaluate_list.html";i:1671499708;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="https://www.xiaofu.live/app/admin/view/public/css/evaluate.css" />
<style>
	.ns-table-bottom{
		align-items: center;
	}
...
<!--			<div class="layui-input-inline">
			...
			<!--<div class="layui-input-inline">
				<select name="search_type">
					...
					<option value="sku_name">动态标题</option>
					<option value="member_name">评价人名称</option>
				</select>
			</div>-->
			
			<div class="layui-inline">
				<input type="text" name="search_text" placeholder="请输入动态标题/评价人名称" class="layui-input ns-len-mid">
...
<script>
	var ADMINIMG = "https://www.xiaofu.live/app/admin/view/public/img";
</script>
<script src="https://www.xiaofu.live/app/admin/view/public/js/dtgl_evaluate.js"></script>
<script>
	...
	function deleteContent(e, isFirst) {
		...
		layer.confirm('确定要删除回复内容吗?', function() {
			$.ajax({
				url: ns.url("admin/dtgl/deleteContent"),
				data: {
					evaluate_id: evaluate_id,
					is_first: isFirst
				},
	...
	function modifyAuditEvaluate(evaluate_ids,is_audit) {
		$.ajax({
			url: ns.url("admin/dtgl/modifyAuditEvaluate"),
			data: {
