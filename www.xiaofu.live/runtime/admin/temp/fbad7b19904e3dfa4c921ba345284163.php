<?php /*a:2:{s:78:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/config/renmai.html";i:1675402061;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form">
	...
	<div class="layui-card ns-card-common ns-card-brief">
		<div class="layui-card-header">
			<span class="ns-card-title">人脉权益设置(开启表示在vip页进行展示,默认vip享受的权益)</span>
		</div>
		<div class="layui-card-body">
			<div class="layui-form-item">
				<label class="layui-form-label">人脉信息查看：</label>
				<div class="layui-input-block">
				<div class="layui-input-inline">
					
				    
				    <input type="checkbox" name="is_zsbs" value="1" lay-skin="switch" <?php if($info['zsbs']['is_status']== 1): ?> checked <?php endif; ?> />
			...
			<div class="layui-form-item">
				<label class="layui-form-label">访客雷达轨迹：</label>
				<div class="layui-input-block">
				<div class="layui-input-inline">
					<input type="checkbox" name="is_mpmb" value="1" lay-skin="switch"  <?php if($info['mpmb']['is_status']== 1): ?> checked <?php endif; ?> >
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
				<div class="layui-input-inline">
					<input type="checkbox" name="is_dzmp" value="1" lay-skin="switch"  <?php if($info['dzmp']['is_status']== 1): ?> checked <?php endif; ?> >
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
				<div class="layui-input-inline">
					<input type="checkbox" name="is_spyejs" value="1" lay-skin="switch" <?php if($info['spyejs']['is_status']== 1): ?> checked <?php endif; ?> >
					
				</div>
				
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">同步到手机：</label>
				<div class="layui-input-block">
				<div class="layui-input-inline">
					<input type="checkbox" name="is_dtxx" value="1" lay-skin="switch" <?php if($info['dtxx']['is_status']== 1): ?> checked <?php endif; ?> >
					
				</div>
				
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">嵌入公众号：</label>
				<div class="layui-input-block">
				<div class="layui-input-inline">
					<input type="checkbox" name="is_zhzs" value="1" lay-skin="switch" <?php if($info['zhzs']['is_status']== 1): ?> checked <?php endif; ?> >
					
				</div>
				
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">下载名片码：</label>
				<div class="layui-input-block">
				<div class="layui-input-inline">
					
					<input type="checkbox" name="fks" value="1" lay-skin="switch" <?php if($info['fks']['is_status']== 1): ?> checked <?php endif; ?> >
				</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				type: 'POST',
				url: ns.url("admin/config/renmai"),
				data: data.field,
				dataType: 'JSON',
				success: function(res) {
					repeat_flag = false;
