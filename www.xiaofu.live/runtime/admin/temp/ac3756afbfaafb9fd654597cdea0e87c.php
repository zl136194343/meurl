<?php /*a:2:{s:71:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\dtgl\dtgl\lists.html";i:1680771973;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="http://www.xiaofuaaa.com/app/admin/view/public/css/goods_lists.css">
<style>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="search_text_type">
                            <option value="goods_name" selected>标题</option>
                            <!--<option value="site_name">店铺名称</option>-->
                        </select>
                    </div>
                    <div class="layui-input-inline">
                        <input type="text" name="search_text" autocomplete="off" class="layui-input" placeholder="标题" />
                    </div>
                </div>
            </div>
...
<script type="text/html" id="action">
    <div class="operation-wrap" data-goods-id="{{d.goods_id}}">
        <div class="popup-qrcode-wrap"><img class="popup-qrcode-loadimg" src="http://www.xiaofuaaa.com/public/static/loading/loading.gif" /></div>
...
<script src="http://www.xiaofuaaa.com/app/admin/view/public/js/dtgl_list.js"></script>
