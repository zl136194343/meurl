<?php /*a:2:{s:66:"/www/wwwroot/www.hunqin.com/app/admin/view/dtgl/company/lists.html";i:1675131188;s:52:"/www/wwwroot/www.hunqin.com/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="goods-category-list layui-table-view">
	<div class="table_div" >
		<ul class="table_head">
			...
			<li style="flex:6">名称</li>
			<li style="flex:2">ID</li>
			<li style="flex:2">上级ID</li>
			<li style="flex:2">公司地址</li>
			<!--<li style="flex:2">平台抽成比率</li>-->
			 <li style="flex:2">排序</li>
			<li style="flex:2">是否认证</li>
			<li style="flex:2">是否开通转介绍</li>
			...
			<div class="table_one" data-index="<?php echo htmlentities($index); ?>" data-sort="<?php echo htmlentities($vo['sort']); ?>" data-cateid="<?php echo htmlentities($vo['id']); ?>">
				<div class="table_tr">
					<div class="table_td" style="width:60px">
						...
						<span class="switch ns-text-color js-switch" data-category-id="<?php echo htmlentities($vo['id']); ?>" data-level="<?php echo htmlentities($vo['level']); ?>" data-open="0">
							+
						</span>
					...
					<div class="table_td" style="flex:6"><?php echo htmlentities($vo['name']); ?></div>
					<div class="table_td" style="flex:2"><?php echo htmlentities($vo['id']); ?></div>
					<div class="table_td" style="flex:2"><?php echo htmlentities($vo['pid']); ?></div>

					<div class="table_td" style="flex:2">
						<?php echo htmlentities($vo['full_address']); ?>
					</div>
					<div class="table_td" style="flex:2">
						<?php echo htmlentities($vo['sort']); ?>
					</div>
					<div class="table_td" style="flex:2">
						<?php if($vo['is_qyrz'] == 1): ?>是<?php else: ?>否<?php endif; ?>
					</div>
					<div class="table_td" style="flex:2">
						<?php if($vo['is_vip'] == 1): ?>是<?php else: ?>否<?php endif; ?>
					</div>

					<div class="table_td" style="flex:2">
						<div class="ns-table-btn">
						    <?php if($vo['is_vip'] == 0): ?>
                            <a class="layui-btn" href="javascript:zjsktCategory(<?php echo htmlentities($vo['id']); ?>);">开通转介绍</a>
                            <?php endif; ?>
				...
				<div class="table_two_div">
					...
					<div class="table_two" data-index="<?php echo htmlentities($index); ?>" data-sort="<?php echo htmlentities($second['sort']); ?>" data-cateid="<?php echo htmlentities($second['id']); ?>">
						<div class="table_tr">
							...
							<div class="table_td" style="flex:6.2">
								...
								<span class="switch ns-text-color js-switch" data-category-id="<?php echo htmlentities($second['id']); ?>" data-level="<?php echo htmlentities($second['level']); ?>" data-open="0" style="padding-right: 15px;">
								+
							</span>
								<?php else: ?>
							...
							<div class="table_td" style="flex:2"><?php echo htmlentities($second['id']); ?></div>
							<div class="table_td" style="flex:2"><?php echo htmlentities($second['pid']); ?></div>



							<div class="table_td" style="flex:2">
								<?php echo htmlentities($second['full_address']); ?>
							</div>

							<div class="table_td" style="flex:2">
								<?php echo htmlentities($second['sort']); ?>
							</div>
							<div class="table_td" style="flex:2">
							...
							<div class="table_td" style="flex:2">
								<div class="ns-table-btn">
									<a class="layui-btn" href="javascript:deleteCategory(<?php echo htmlentities($second['id']); ?>);">删除</a>
								</div>
							</div>
						</div>
...
<div id="label_change" company_id="" style="margin-top:100px;position: relative;display:none">
    <div class="layui-form member-form" id="reset_label" lay-filter="form" style="position: absolute;top:-350px; left:400px; background-color:#F0F0F0;width:450px;padding:50px 0 50px 0">
		<div class="layui-form-item" >
			<label class="layui-form-label sm">标签：</label>
			<div class="layui-input-block layui_input_block" >
				
				<input type="radio" name="zjs" value="1" title="个人版" lay-skin="primary">
				<input type="radio" name="zjs" value="2" title="标准版" lay-skin="primary">
				<input type="radio" name="zjs" value="3" title="旗舰版" lay-skin="primary">
			</div>
		</div>
		
		<div class="ns-form-row sm">
			<button class="layui-btn ns-bg-color" lay-submit onclick="addLabel()">确定</button>
...
<script>
	...
	function zjsktCategory(category_id) {

		    $("#label_change").show();
		    $("#label_change").attr('company_id',category_id);
	}
	...
	function closeLabel() {
		$("#label_change").hide();
		 $("#label_change").attr('company_id','')
	}
	
	function addLabel () {
	    var ktzjs = $("input[type='radio']").val();
        $.ajax({
        	url: ns.url("admin/company/ktzjs"),
        	data: {id : $("#label_change").attr('company_id'),name:ktzjs },
        	dataType: 'JSON',
        	type: 'POST',
        	async: false,
        	success: function (res) {
