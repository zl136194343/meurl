<?php /*a:2:{s:79:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/config/sysmadd.html";i:1671531590;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://www.xiaofu.live/public/static/ext/video/video.css">
<link rel="stylesheet" type="text/css" href="https://www.xiaofu.live/public/static/ext/searchable_select/searchable_select.css" />
<link rel="stylesheet" type="text/css" href="https://www.xiaofu.live/public/static/css/common.css" />
<link rel="stylesheet" type="text/css" href="https://www.xiaofu.live/public/static/css/main.css" />
<link rel="stylesheet" type="text/css" href="https://www.xiaofu.live/app/shop/view/public/css/goods_edit.css" />
				...
				<div class="layui-card ns-card-common">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="title" placeholder="标题" autocomplete="off" class="layui-input ns-len-long">
						</div>
					</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<div class="video-thumb">
									<video id="goods_video" class="video-js vjs-big-play-centered" controls="" poster="https://www.xiaofu.live/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
										<video id="temp_goods_video" class="video-js vjs-big-play-centered" controls="" poster="https://www.xiaofu.live/app/shop/view/public/img/goods_video_preview.png" preload="auto"></video>
										<span class="delete-video hide" onclick="deleteVideo()"></span>
									</div>
									<div id="videoUpload" title="帮助视频" style="position: absolute;left: 0;width: 250px;height: 90px;opacity: 0;cursor: pointer;z-index:10;"></div>
								</div>
							<div>
                         ...
                         &lt;!&ndash;<input class="layui-input" type="hidden" name="video_url" value="">&ndash;&gt;
...
<script src="https://www.xiaofu.live/public/static/ext/drag-arrange.js"></script>
<script src="https://www.xiaofu.live/public/static/ext/video/videojs-ie8.min.js"></script>
<script src="https://www.xiaofu.live/public/static/ext/video/video.min.js"></script>
<script src="https://www.xiaofu.live/public/static/ext/searchable_select/searchable_select.js"></script>
<script src="https://www.xiaofu.live/app/admin/view/public/js/sysm.js"></script>
	<script src="https://www.xiaofu.live/app/shop/view/public/js/smsycategory_select.js"></script>
	<!--选择商品分类-->
		...
		<div class="category-list">
			...
			<div class="item">
				...
				<ul>
					...
					<li data-category-id="<?php echo htmlentities($vo['id']); ?>"  data-level="<?php echo htmlentities($vo['level']); ?>" class="selected">
						<span class="category-name"><?php echo htmlentities($vo['group_name']); ?></span>
