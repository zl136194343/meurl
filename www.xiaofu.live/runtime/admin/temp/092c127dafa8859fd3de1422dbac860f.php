<?php /*a:2:{s:73:"/www/wwwroot/ls.chnssl.com/app/admin/view/shopcategory/edit_category.html";i:1614516002;s:51:"/www/wwwroot/ls.chnssl.com/app/admin/view/base.html";i:1661854360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class=" layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="category_name" lay-verify="required" value="<?php echo htmlentities($category_info['data']['category_name']); ?>" class="layui-input ns-len-long" autocomplete="off">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="number" name="sort" class="layui-input ns-len-short" lay-verify="sorts" value="<?php echo htmlentities($category_info['data']['sort']); ?>" autocomplete="off">
		</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-input-inline">
				<input type="number" name="baozheng_money" lay-verify="flo" class="layui-input ns-len-short" value="<?php echo htmlentities($category_info['data']['baozheng_money']); ?>" autocomplete="off">
			</div>
	...
	<input type="text" name="category_id" lay-verify="required" value="<?php echo htmlentities($category_info['data']['category_id']); ?>" class="layui-input layui-hide">
</div>
...
<script>
	layui.use('form', function() {
		...
		form.on('submit(save)', function(data) {
			...
			$.ajax({
				url: ns.url("admin/shopcategory/editCategory"),
				data: data.field,
				dataType: 'JSON',
				type: 'POST',
				success: function(res) {
					...
					if (res.code == 0) {
						layer.confirm('编辑成功', {
							...
							btn: ['返回列表', '继续操作'],
							yes: function(){
								location.href = ns.url("admin/shopcategory/lists")
							},
							btn2: function() {
								location.reload();
							}
