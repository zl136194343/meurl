<?php /*a:2:{s:82:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/config/sysmconfig.html";i:1672109125;s:69:"/www/wwwroot/www.xiaofu.live/www.xiaofu.live/app/admin/view/base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		<label class="layui-form-label">在线客服二维码：</label>
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box <?php if(!(empty($info['zaixiankefu']) || (($info['zaixiankefu'] instanceof \think\Collection || $info['zaixiankefu'] instanceof \think\Paginator ) && $info['zaixiankefu']->isEmpty()))): ?>hover<?php endif; ?>">
					<div class="ns-upload-default" id="imgUploadShop">
						<?php if($info['zaixiankefu']): ?>
						<div id="preview_imgUploadShop" class="preview_img">
							<img layer-src src="<?php echo img($info['zaixiankefu']); ?>" class="img_prev"/>
						</div>
						<?php else: ?>
						<div class="upload">
							<img src="https://www.xiaofu.live/app/admin/view/public/img/upload_img.png"/>
							<p>点击上传</p>
						</div>
						<?php endif; ?>
					</div>
					...
					<input type="hidden" name="zaixiankefu" value="<?php echo htmlentities($info['zaixiankefu']); ?>">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layui-form-item">
		<label class="layui-form-label">交流群二维码：</label>
		<div class="layui-input-block">
			<div class="upload-img-block img-upload">
				<div class="upload-img-box <?php if(!(empty($info['jiaoliuqun']) || (($info['jiaoliuqun'] instanceof \think\Collection || $info['jiaoliuqun'] instanceof \think\Paginator ) && $info['jiaoliuqun']->isEmpty()))): ?>hover<?php endif; ?>">
					<div class="ns-upload-default" id="imgUploadGoods">
						<?php if($info['jiaoliuqun']): ?>
						<div id="preview_imgUploadGoods" class="preview_img">
							<img layer-src src="<?php echo img($info['jiaoliuqun']); ?>" class="img_prev"/>
						</div>
						<?php else: ?>
						<div class="upload">
							<img src="https://www.xiaofu.live/app/admin/view/public/img/upload_img.png"/>
					...
					<input type="hidden" name="jiaoliuqun" value="<?php echo htmlentities($info['jiaoliuqun']); ?>">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="kefurexian" value="<?php echo htmlentities($info['kefurexian']); ?>" autocomplete="off" class="layui-input ns-len-long" lay-verify="required">
		</div>
		<!--<div class="ns-word-aux">请根据需要谨慎填写websocket链接, 若变动后需重新刷新 <a href="https://ls.chnssl.com/pc://admin/pc/deploy.html" class="ns-text-color" target="_blank">web端部署</a> 和 <a href="https://ls.chnssl.com/admin/system/refreshh5.html" class="ns-text-color" target="_blank">H5端部署</a> 才能应用</div>-->
	</div>

	<div class="layui-form-item">
		<label class="layui-form-label">在线时间：</label>
		<div class="layui-input-block">
			<input type="text" name="zaixinashijian" value="<?php echo htmlentities($info['zaixinashijian']); ?>" autocomplete="off" class="layui-input ns-len-long" lay-verify="required">
		</div>
		<!--<div class="ns-word-aux">请根据需要谨慎填写websocket链接, 若变动后需重新刷新 <a href="https://ls.chnssl.com/pc://admin/pc/deploy.html" class="ns-text-color" target="_blank">web端部署</a> 和 <a href="https://ls.chnssl.com/admin/system/refreshh5.html" class="ns-text-color" target="_blank">H5端部署</a> 才能应用</div>-->
	</div>
...
<script>
	layui.use(['form'], function() {
        ...
        form.on('submit(save)', function(data) {
            ...
            $.ajax({
                type: "POST",
                url: ns.url("admin/config/sysmconfig"),
                data: data.field,
                dataType: 'JSON',
                success: function(res) {
                    repeat_flag = false;
