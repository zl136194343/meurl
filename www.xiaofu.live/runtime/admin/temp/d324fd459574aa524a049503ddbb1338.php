<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\shopjoin\shop_agreement.html";i:1675934092;s:60:"D:\phpstudy_pro\WWW\www.xiaofu.live\app\admin\view\base.html";i:1673488049;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="layui-form ns-form">
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="title" value="<?php echo htmlentities($shop_apply_agreement['data']['title']); ?>" autocomplete="off" class="layui-input ns-len-long">
		</div>
	</div>
	...
	<input type="hidden" name="content" id="setContent" value="<?php echo htmlentities($shop_apply_agreement['data']['content']); ?>" />
</div>
