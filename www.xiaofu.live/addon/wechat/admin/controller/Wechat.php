...
class Wechat extends BaseWechat
{
	...
	public function setting()
	{
		$setting_arr = [
			...
			[
				'url' => addon_url('wechat://admin/material/lists'),
				'img' => 'config_material_icon.png',
				'title' => '消息素材',
				'content' => '消息素材',
			],
			[
				'url' => addon_url('wechat://admin/fans/lists'),
				'img' => 'config_material_icon.png',
				'title' => '粉丝列表',
				'content' => '粉丝列表',
			],
			[
				'url' => addon_url('wechat://admin/menu/menu'),
				'img' => 'config_menu_icon.png',
				'title' => '菜单管理',
				'content' => '菜单管理',
			],
//            [
//                'url' => addon_url('wechat://admin/wechat/qrcode'),
//                'img' => 'config_qrcode_icon.png',
//                'title' => '推广二维码',
//                'content' => '推广二维码管理',
//            ],
			[
				'url' => addon_url('wechat://admin/wechat/share'),
				'img' => 'config_share_icon.png',
				'title' => '分享内容设置',
				'content' => '分享内容设置',
			],
			[
				'url' => addon_url('wechat://admin/replay/replay'),
				'img' => 'config_replay_icon.png',
				'title' => '回复设置',
				'content' => '回复设置',
			],
//            [
//                'url' => addon_url('wechat://admin/wechat/mass'),
//                'img' => 'config_mass_icon.png',
//                'title' => '群发设置',
//                'content' => '群发设置',
//            ],
			[
				'url' => addon_url('wechat://admin/message/config'),
	...
	public function config()
	{
		...
		if (request()->isAjax()) {
			...
			$res = $config_model->setWechatConfig($data, $is_use);
			return $res;
		} else {
	...
	public function share()
	{
		...
		if (request()->isAjax()) {
			...
			$res = $config_model->setShareConfig($data, 1);
			return $res;
		} else {
			$config_result = $config_model->getShareConfig();
