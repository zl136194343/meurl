			...
			goodsSources: [
				{
					text: "默认",
					value: "default",
					src: couponResourcePath + "/shop_coupon/img/goods.png",
					selectedSrc: couponResourcePath + "/shop_coupon/img/goods_1"+url+".png"
				},
				{
					text : "手动选择",
					value : "diy",
					src: couponResourcePath + "/shop_coupon/img/manual.png",
					selectedSrc: couponResourcePath + "/shop_coupon/img/manual_1"+url+".png"
				}
			],
			isLoad: false,
			isShow: false,
