 ...
 * 店铺续签
 */
class Shopreopen extends BaseCity
{
	/******************************* 商家续签列表及相关操作 ***************************/
	...
	public function reopen()
	{
		...
		if (request()->isAjax()) {
            ...
            $condition[] = ['r.website_id','=',$this->site_id];
			...
			return $this->fetch('shopreopen/reopen',[],$this->replace);
		}
	}
	...
	public function reopendetail()
	{
		...
		return $this->fetch('shopreopen/reopendetail',[],$this->replace);
	}
