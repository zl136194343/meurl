...
class Customer extends BaseModel
{
    ...
    public function sendClienttMessage($data)
    {
       
            //发消息.
             $wechat_model = new WechatMessage();
                $card = model('card')->getInfo([['id','=',$data['card_id']]],'member_id');
                
                $memberList = model('member')->getInfo([['member_id','=',$card['member_id']]]);
                
                $data["openid"] = $memberList['wx_openid'];
               
                if(empty($data["openid"])){
                         $re = $this->syncWechatFans(0);
                        // code...
                        // code...
                        for($o=1;$o<=$re['data']['page_count'];$o++){
                            $this->syncWechatFans($o);
                        }
                         $ds = model('wechat_fans')->getInfo([['unionid','=',$memberList['wx_unionid']]],'openid');
                         $data["openid"] = $ds['openid'];
                    ...
                    $data["page"] = $this->handleUrl(3, '1254515154545115');      
                    /*$data["page"] = $this->handleUrl(2, 40);*/
                    $data['message_info']['wechat_is_open'] = 1;
                    ...
                    $data['message_info']['wechat_json'] = json_encode([
                            "template_id_short"=>"OPENTM417749055",
                            "template_id"=>"cjE0H1XMUJ7yqIwSOQZyl-wUtT_NkMj7qD0zeV0AHo0",
                            "headtext"=>$data['desc'],"bottomtext"=>'请点击前往查看',"headtextcolor"=>"","bottomtextcolor"=>"","content"=>"\u8bbf\u5ba2\u59d3\u540d{{keyword1.DATA}}\u8bbf\u5ba2\u624b\u673a\u53f7{{keyword2.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword3.DATA}}"
    ...
    public function sendClienttSh($data)
    {
            ...
            //发消息.
                ...
                if(empty($data["openid"])){
                    ...
                    $data['message_info']['wechat_json'] = json_encode([
                            "template_id_short"=>"OPENTM417749055",
                            "template_id"=>"l8-_vKDi-xTXv-zPgxoYvjUGFWKlhyfMRdm1nz27TU0",
                            "headtext"=>'您有新的成员申请加入',"bottomtext"=>'请点击前往查看',"headtextcolor"=>"","bottomtextcolor"=>"","content"=>"\u8bbf\u5ba2\u59d3\u540d{{keyword1.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword2.DATA}}"
    ...
    public function sendHhrSh($data)
    {
            ...
            //发消息.
                ...
                if(empty($data["openid"])){
                    ...
                    $data['message_info']['wechat_json'] = json_encode([
                            "template_id_short"=>"OPENTM417749055",
                            "template_id"=>"l8-_vKDi-xTXv-zPgxoYvjUGFWKlhyfMRdm1nz27TU0",
                            "headtext"=>'你有新的代言人申请',"bottomtext"=>'请点击前往查看',"headtextcolor"=>"","bottomtextcolor"=>"","content"=>"\u8bbf\u5ba2\u59d3\u540d{{keyword1.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword2.DATA}}"
     ...
     public function sendWliao($data)
    {
            ...
            //发消息.
                ...
                if(empty($data["openid"])){
                    ...
                    $data['message_info']['wechat_json'] = json_encode([
                            "template_id_short"=>"OPENTM417749055",
                            "template_id"=>"6gPhh2rtE2hef0118ulygwR2Z_BdMjX6A8H08yfsF3Q",
                            "headtext"=>'客户到访通知',"bottomtext"=>'请点击前往查看',"headtextcolor"=>"","bottomtextcolor"=>"","content"=>"\u8bbf\u5ba2\u59d3\u540d{{keyword1.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword2.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword3.DATA}}"
    ...
    public function sendhhrjl($data)
    {
            ...
            //发消息.
                ...
                if(empty($data["openid"])){
                    ...
                    $data["template_data"] = [
                        'keyword1' => time_to_date(time()),
                        'keyword2' => $data['member_name'],
                        /*'keyword2' => str_sub($order_info['name']),*/
                        /*'keyword2' => $data['wuliao'],*/
                    ...
                    $data['message_info']['wechat_json'] = json_encode([
                            "template_id_short"=>"OPENTM417749055",
                            "template_id"=>"w1pnUA1wPzGV_prESIiHB8oOkahXGKDoopRzYyf-gyI",
                            "headtext"=>'你申请的'.$data['company_name'].'的'.$data['title'].'申请已通过',"bottomtext"=>'对应奖励已发放到账户余额,请前往账户查看',"headtextcolor"=>"","bottomtextcolor"=>"","content"=>"\u8bbf\u5ba2\u59d3\u540d{{keyword1.DATA}}\u8bbf\u95ee\u65f6\u95f4{{keyword2.DATA}}"
...
*/
    ...
    private function handleUrl($order_type, $order_id,$services_available='',$ts_id=0,$member_id=0){
        switch ($order_type) {
            case 2:
               /* return 'pages/order/detail_pickup/detail_pickup?order_id=' . $order_id;
                ...
                break;
            case 3:
                return 'pages/businessCard/businessCard';
                break;
            case 4:
