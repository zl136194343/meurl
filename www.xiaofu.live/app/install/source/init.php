...
return [
    ...
    'document' => [
        ...
        [
            "site_id" => 0,
            "app_module" => "admin",
            "document_key" => "SHOP_JOIN_GUIDE_4",
            "title" => "站点加盟",
            "content" => '<p style="text-align: justify; line-height: 2em;"><span style="font-family: 微软雅黑; font-size: 14px;">平台可开启城市分站功能，多城市站点加盟，不同区域不同站点，各站点可独立运营管理自己城市站点下的业务，真正意义的城市站点加盟。各个站点首页都可以在站点后台自定义独立装修，打造专属的网站样式。避免各大站点样式一致、辨识度低、混乱的状况。</span></p><p><br/></p>',
        ],
        [
            "site_id" => 0,
            "app_module" => "admin",
            "document_key" => "SHOP_APPLY_AGREEMENT",
            "title" => "商家入驻协议",
        ...
        [
            "site_id" => 0,
            "app_module" => "admin",
            "document_key" => "GOODS_AFTER_SALE",
            "title" => "售后保障协议",
            "content" => '<p><span style="color: rgb(255, 0, 0);"><strong>权利声明：</strong></span><br/>商城上的所有商品信息、客户评价、商品咨询、网友讨论等内容，是商城重要的经营资源，未经许可，禁止非法转载使用。</p><p><span style="color: rgb(63, 63, 63);"><strong>注：</strong></span>本站商品信息均来自于合作方，其真实性、准确性和合法性由信息拥有者（合作方）负责。本站不提供任何保证，并不承担任何法律责任。</p><p><br/><span style="color: rgb(255, 0, 0);"><strong>价格说明：</strong></span><br/></p><p><span style="color: rgb(63, 63, 63);"><strong>价格：</strong></span>价格为商品的销售价，是您最终决定是否购买商品的依据。</p><p><span style="color: rgb(63, 63, 63);"><strong>划线价：</strong></span>商品展示的划横线价格为参考价，该价格可能是品牌专柜标价、商品吊牌价或由品牌供应商提供的正品零售价（如厂商指导价、建议零售价等）或该商品在商城平台上曾经展示过的销售价；由于地区、时间的差异性和市场行情波动，品牌专柜标价、商品吊牌价等可能会与您购物时展示的不一致，该价格仅供您参考。</p><p><span style="color: rgb(63, 63, 63);"><strong>折扣：</strong></span>如无特殊说明，折扣指销售商在原价、或划线价（如品牌专柜标价、商品吊牌价、厂商指导价、厂商建议零售价）等某一价格基础上计算出的优惠比例或优惠金额；如有疑问，您可在购买前联系销售商进行咨询。</p><p><span style="color: rgb(63, 63, 63);"><strong>异常问题：</strong></span>商品促销信息以商品详情页“促销”栏中的信息为准；商品的具体售价以订单结算页价格为准；如您发现活动商品售价或促销信息有异常，建议购买前先联系销售商咨询。</p><p><br/></p><p><br/></p>',
        ],
    ],
    //店铺等级
    'shop_category' => [
    ...
    "cron" => [
        ...
        [
            ...
            "period_type" => 3,
            "name" => "店铺周期结算",
            "event" => "ShopWithdrawPeriodCalc",
            "execute_time" => strtotime(date('Y-m-1 00:00:00', strtotime('next month'))),
            "relate_id" => "0",
        ],
        [
            "type" => 2,
            ...
            "period_type" => 0,
            "name" => "会员群体定时刷新",
            "event" => "CronMemberClusterRefresh",
            "execute_time" => time(),
            "relate_id" => "0",
        ],
    ],
        ...
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_carousel_1.png',
                    'background' => '#FF4B29'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_top_carousel_1.png',
                    'background' => '#FF5726'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_left_1.png',
                    'background' => '#FFFFFF'
                ],
                [
                    'adv_title' => '广告二',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_left_2.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_right_1.png',
                    'background' => '#FFFFFF'
                ],
                [
                    'adv_title' => '广告二',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_right_2.png',
                    'background' => '#FFFFFF'
                ],
                [
                    'adv_title' => '广告三',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_right_3.png',
                    'background' => '#FFFFFF'
                ],
                [
                    'adv_title' => '广告四',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_index_mid_right_4.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_brand_carousel_1.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_coupon_carousel_1.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_groupbuy_carousel_1.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_seckill_carousel_1.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_shop_index_carousel_1.png',
                    'background' => '#FFFFFF'
                ]
            ]
        ],
        [
            ...
            'adv' => [
                [
                    'adv_title' => '广告一',
                    'adv_url' => '',
                    'adv_image' => 'upload/default/pc/gg_pc_login_carousel_1.png',
                    'background' => '#F53E45'
                ]
            ]
        ]
    ...
    'floor_block' => [
        [
            'name' => 'floor-style-1',
            'title' => '样式1',
            'value' => '{"goodsList":{"type":"goods","value":{"sku_ids":"","list":[]}},"leftImg":{"type":"img","value":{"url":"","link":""}},"bottomImg":{"type":"img","value":{"url":"","link":""}},"title":{"type":"text","value":{"text":"楼层名称","link":"","color":"#333333"}}}',
            'sort' => 0,
        ],
        [
            'name' => 'floor-style-2',
            'title' => '样式2',
            'value' => '{"goodsList":{"type":"goods","value":{"sku_ids":"","list":[]}},"bottomImg":{"type":"img","value":{"url":"","link":""}},"title":{"type":"text","value":{"text":"楼层标题","link":"","color":"#333"}},"subTitle":{"type":"text","value":{"text":"楼层副标题","link":"","color":"#b0b0b0"}}}',
            'sort' => 1
        ],
        [
            'name' => 'floor-style-3',
            'title' => '样式3',
            'value' => '{"title":{"type":"text","value":{"text":"楼层标题","link":"","color":"#333"}},"rightGoodsList":{"type":"goods","value":{"sku_ids":"","list":[]}},"bottomGoodsList":{"type":"goods","value":{"sku_ids":"","list":[]}},"brandList":{"type":"brand","value":{"brand_ids":"","list":[]}},"categoryList":{"type":"category","value":{"category_ids":"","list":[]}},"leftImg":{"type":"img","value":{"url":"","link":""}}}',
            'sort' => 2
        ]
    ],
    'api' => [
