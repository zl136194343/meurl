...
//        ];
        ...
        $this->merchantId =$config_info["mch_id"];
        $this->merchantPrivateKeyFilePath = $config_info["apiclient_key"];
        $this->merchantPrivateKeyInstance = Rsa::from($this->merchantPrivateKeyFilePath, Rsa::KEY_TYPE_PRIVATE);
        // 「商户API证书」的「证书序列号」
        $this->merchantCertificateSerial ='3775B6A45ACD588826D15E583A95F5DD********';
        // 从本地文件中加载「微信支付平台证书」，用来验证微信支付应答的签名
        $platformCertificateFilePath = $config_info["apiclient_cert"];
