                ...
                'child_list' => [
                    [
                        ...
                        'child_list' => [
                            ...
                            [
                                'name' => 'ADDON_CITY_DELETE',
                                'title' => '分站删除',
                                'url' => 'city://admin/website/delete',
                                'is_show' => 0,
                                'is_control' => 1,
                                'is_icon' => 0,
                            ],
                            [
                                'name' => 'ADDON_CITY_FROZEN',
                                'title' => '分站关闭',
                                'url' => 'city://admin/website/frozen',
                                'is_show' => 0,
                                'is_control' => 1,
                                'is_icon' => 0,
                            ],
                            [
                                'name' => 'ADDON_CITY_UNFROZEN',
                                'title' => '分站开启',
                                'url' => 'city://admin/website/unfrozen',
                                'is_show' => 0,
                                'is_control' => 1,
                                'is_icon' => 0,
                            ],
