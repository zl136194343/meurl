...
class Notice extends BaseCity
{
    ...
    public function lists()
    {
        if(request()->isAjax()){
            ...
            $condition[] = ['receiving_type', 'like', '%website%'];
            ...
            return $this->fetch('notice/lists',[],$this->replace);
        }
    }
    ...
    public function detail()
    {
        ...
        $this->assign("menu_info", [ 'title' => "网站公告" ]);
        return $this->fetch('notice/detail',[],$this->replace);
    }
