...
Order.prototype.cols = [
    ...
    },
    {
        ...
        template: function (orderitem, order) {
            ...
            if (orderitem.refund_status_name != '') {
                html += '<br/><a href="' + ns.url("supply://admin/refund/detail", {order_goods_id: orderitem.order_goods_id}) + '"  target="_blank" class="ns-text-color">' + orderitem.refund_status_name + '</a>&nbsp;&nbsp;';
            }
            return html;
        }
    },
    {
        ...
        template : function(orderitem,order){
            ...
            h += '<div style="margin-top:10px;width:160px;text-align:left;">供应商结算：'+(parseFloat(order.supply_money)-parseFloat(order.refund_supply_money)).toFixed(2)+'</div>';
    ...
    },
    {
        ...
        template : function(orderitem,order){
            ...
            if(order.order_type != 4){
                h += '<p>';
                h += '<span href="javascript:;" class="ns-line-hiding ns-line-color" title="'+ order.name +'">' + order.name + '</span>';
                h += '</p>';
    ...
    },
    {
        ...
        merge : true,
        template : function(orderitem,order){
            var url = "supply://admin/order/detail";
