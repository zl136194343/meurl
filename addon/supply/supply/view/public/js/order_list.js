    ...
    },
    {
        ...
        template: function (orderitem, order) {
            ...
            if (orderitem.refund_status_name != '') {
                html += '<br/><a href="' + ns.url("supply://supply/orderrefund/detail", {order_goods_id: orderitem.order_goods_id}) + '"  target="_blank" class="ns-text-color">' + orderitem.refund_status_name + '</a>&nbsp;&nbsp;';
            }
            return html;
        }
    },
    ...
    },
    {
        ...
        template: function (orderitem, order) {
            ...
            if (order.order_type != 4) {
                h += '<p>';
                h += '<span href="javascript:;" class="ns-line-color">' + order.name + '</span>';
                h += '</p>';
