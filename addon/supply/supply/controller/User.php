...
class User extends BaseSupply
{
    ...
    public function user()
    {
        if (request()->isAjax()) {
            ...
            $condition = [];
            $condition[] = [ "u.site_id", "=", $this->supply_id ];
            ...
            $member_id = model('shop')->getInfo([ 'site_id' => $this->supply_id ], 'member_id')[ 'member_id' ] ?? 0;
    ...
    public function addUser()
    {
        if (request()->isAjax()) {
            ...
            $group_list_result = $group_model->getGroupList([ [ "site_id", "=", $this->supply_id ], [ "app_module", "=", $this->app_module ] ]);
