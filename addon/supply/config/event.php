...
//        ],
        ...
        //供应商关闭
        'SupplyClose' => [
            'addon\supply\event\SupplyClose'
        ],
        //自动事件检测供应商是否过期
        'CronSupplyClose' => [
            'addon\supply\event\CronSupplyClose'
        ],

        //商品上架
        'CronSupplyGoodsTimerOn' => [
            'addon\supply\event\CronSupplyGoodsTimerOn'
        ],

        //商品下架
        'CronSupplyGoodsTimerOff' => [
            'addon\supply\event\CronSupplyGoodsTimerOff'
        ],
    ],
