        ...
        'child_list' => [
                    ...
                    [
                        ...
                        'child_list' => [
                            ...
                            [
                                ...
                                'title' => '删除供应商',
                                'url' => 'supply://admin/supplier/delete',
                                'is_show' => 0,
                            ],
                        ]
                    ],
            ...
            [
                ...
                'child_list' => [
                    ...
                    [
                        'name' => 'SUPPLY_GOODS_CATEGORY',
                        'title' => '分类抽成',
                        'url' => 'supply://admin/goods/category',
                        'is_show' => 1,
                        'sort' => 6,
                        'child_list' => [
                            [
                                'name' => 'SUPPLY_GOODS_CATEGORY_EDIT',
                                'title' => '分类编辑',
                                'url' => 'supply://admin/goods/editcategory',
                                'is_show' => 0
                            ],
                        ]
                    ],
            ...
            [
                ...
                'child_list' => [
                    ...
                    [
                        'name' => 'SUPPLY_WEBSITE_ADV_POSITION_DELETE',
                        'title' => '删除广告位',
                        'url' => 'supply://admin/adv/deleteposition',
                        'is_show' => 0,
                    ],
                    [
