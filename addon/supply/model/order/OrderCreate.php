...
class OrderCreate extends BaseModel
{
    ...
    public function create($data)
    {
        ...
        if ($this->is_exist_free) {
            $free_out_trade_no = $pay->createOutTradeNo($data['buyer_uid']);
            $free_order_name = [];
        }
...
//                }
    ...
    {
        //组装商品列表
        $field = 'price_json, sku_id,sku_name, sku_no, price, cost_price, stock, weight, volume, sku_image, site_id, site_name, website_id, is_own, goods_state, verify_state, is_virtual, is_free_shipping, shipping_template, goods_class, goods_class_name, goods_id';
