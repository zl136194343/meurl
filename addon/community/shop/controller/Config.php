...
use addon\community\model\goods\Config as GoodsConfigModel;
...
class Config extends BaseShop
{
    ...
    public function community()
    {
        if (request()->isAjax()) {
            ...
            $config_model = new \addon\community\model\order\Config();
            $res = $config_model->setTradeConfig($trade_config, $this->site_id, $this->app_module);
            ...
            return $this->fetch('config/community');
        }
    }
}
