...
class OrderMessage extends BaseModel
{
    ...
    public function messageOrderCreate($data)
    {
        ...
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "full_address,address,order_no,mobile,member_id,order_type,create_time,order_name,order_money");
    ...
    public function messageOrderClose($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id,order_name,create_time,order_money,close_time");
    ...
    public function messageOrderComplete($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id,order_name,create_time");
    ...
    public function messageOrderDelivery($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id,order_name,goods_num,order_money,delivery_time");
    ...
    public function messageOrderTakeDelivery($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id,full_address,address,name,order_name,sign_time");
    ...
    public function messageOrderRefundAgree($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id");
    ...
    public function messageOrderVerify($data)
    {
        ...
        $sms_model = new Sms();
        $order_id = $data["order_id"];
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_id]], "order_type,order_no,mobile,member_id,order_name,goods_num,sign_time");
    ...
    public function messageOrderRefundApply($data)
    {
        ...
        $order_info = model("commander_order")->getInfo([["order_id", "=", $order_goods_info['order_id']]], "order_no,mobile,member_id,site_id,name,order_type");
        $var_parse = array(
            "username" => replaceSpecialChar($order_info["name"]),//会员名
            "orderno" => $order_info["order_no"],//订单编号
            "goodsname" => mb_substr(replaceSpecialChar($order_goods_info["sku_name"]), 0,7),//商品名称
            "refundno" => $order_goods_info["refund_no"],//退款编号
            "refundmoney" => $order_goods_info["refund_apply_money"],//退款申请金额
            "refundreason" => replaceSpecialChar($order_goods_info["refund_reason"]) ?? '无',//退款原因
        );
        $data["var_parse"] = $var_parse;
