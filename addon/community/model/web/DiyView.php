        ...
        if (empty($res['data']['value'])) {
            ...
            if ($membersignin_addon_is_exit) {
                $menuList[] = [
                    'tag'      => 'membersignin',
                    "text"     => "签到",
                    "img"      => "upload/uniapp/member/index/menu/default_icon1.png",
                    "link"     => [
                        "name"    => "SIGN_IN",
                        "title"   => "签到",
            ...
            $menuList[] = [
                "text"     => "我的关注",
                "img"      => "upload/uniapp/member/index/menu/default_icon2.png",
                "link"     => [
                    "name"    => "ATTENTION",
                    "title"   => "我的关注",
            ...
            $menuList[] = [
                "text"     => "我的足迹",
                "img"      => "upload/uniapp/member/index/menu/default_icon3.png",
                "link"     => [
                    "name"    => "FOOTPRINT",
                    "title"   => "我的足迹",
            ...
            if ($coupon_addon_is_exit) {
                $menuList[] = [
                    'tag'      => 'coupon',
                    "text"     => "优惠券",
                    "img"      => "upload/uniapp/member/index/menu/default_icon4.png",
                    "link"     => [
                        "name"    => "COUPON",
                        "title"   => "优惠券",
            ...
            if ($memberwithdraw_addon_is_exit) {
                $menuList[] = [
                    'tag'      => 'memberwithdraw',
                    "text"     => "账户列表",
                    "img"      => "upload/uniapp/member/index/menu/default_icon5.png",
                    "link"     => [
                        "name"    => "ACCOUNT",
                        "title"   => "账户列表",
            ...
            $menuList[] = [
                "text"     => "团长中心",
                "img"      => "upload/uniapp/member/index/menu/default_icon6.png",
                "link"     => [
                    "name"    => "COMMUNITYCENTER",
                    "title"   => "团长中心",
                    "wap_url" => "/otherpages/community/community_leader"
                ],
                "isShow"   => "1",
                "isSystem" => "1"
            ];
            ...
            $menuList[] = [
                "text"     => "配送单",
                "img"      => "upload/uniapp/member/index/menu/default_icon7.png",
                "link"     => [
                    "name"    => "DELIVERY",
                    "title"   => "配送单",
                    "wap_url" => "/otherpages/community/clerk_delivery"
                ],
                "isShow"   => "1",
                "isSystem" => "1"
            ];
