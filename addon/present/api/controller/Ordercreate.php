...
use addon\present\model\presentOrderCreate as OrderCreateModel;
...
class Ordercreate extends BaseApi
{
    ...
    public function create()
    {
        ...
        $data = [
            'present_id' => isset($this->params[ 'present_id' ]) ? $this->params[ 'present_id' ] : '',//赠品id
        ...
        if (empty($data[ 'sku_id' ]) || empty($data[ 'present_id' ])) {
