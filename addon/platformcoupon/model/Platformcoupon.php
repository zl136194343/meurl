...
class Platformcoupon extends BaseModel
{
     ...
     * @return \multitype
     */
    public function getPlatformcouponTypePageList($condition, $page = 1, $page_size = PAGE_LIST_ROWS, $order = 'platformcoupon_type_id desc', $field = 'platformcoupon_type_id,platformcoupon_name,money,max_fetch,at_least,end_time,image,validity_type,fixed_term,status,is_show,use_scenario,lead_count,count')
    {
