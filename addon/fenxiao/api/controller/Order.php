...
class Order extends BaseApi
{
    ...
    public function page()
    {
	    ...
	    $MemberRechargeOrderModel = new FenxiaoOrderModel();
	    $re = $MemberRechargeOrderModel->calculate(['order_id'=> '2067','order_no'=>'20221107173723750001','pay_type'=>'','member_id'=>2375,'site_id'=>1,'site_name'=>'测试','name'=>'123','mobile'=>'123','full_address'=>123,'address'=>123,'one_commission'=>10]);
	    dump($re);die;
	}
