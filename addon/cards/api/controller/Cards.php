...
class Cards extends BaseApi
{
    ...
    public function info()
    {
        ...
        $game = new Games();
        $info = $game->getGamesInfo([ [ 'game_id', '=', $game_id ], [ 'game_type', '=', 'cards' ] ], 'game_id,game_name,points,start_time,end_time,status,remark,no_winning_desc,no_winning_img,is_show_winner,level_id,level_name,join_type,join_frequency');
        if (!empty($info[ 'data' ])) {
            // 中奖名单
