...
class BaseStore extends Controller
{
    ...
    private function initBaseInfo()
    {
        ...
        $this->assign("store_info", $this->store_info);
        $shop_model = new Shop();
        $shop_info = $shop_model->getShopInfo([ [ 'site_id', '=', $this->site_id ] ], 'site_name,logo,is_own,level_id,category_id,group_id,seo_keywords,seo_description,expire_time');
    ...
    private function getGroupInfo()
    {
        ...
        $group_info_result = $group_model->getGroupInfo([ [ "group_id", "=", $this->user_info[ "group_id" ] ], [ "site_id", "=", $this->store_id ], [ "app_module", "=", $this->app_module ] ]);
