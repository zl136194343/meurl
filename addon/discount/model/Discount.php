...
class Discount extends BaseModel
{
     ...
     */
    public function closeDiscount($discount_id)
    {
    ...
    {
        $res = model('promotion_discount')->delete([ [ 'discount_id', '=', $discount_id ], [ 'status', '<>', 1 ] ]);
        if ($res) {
     ...
     * 删除限时折扣商品
     */
    public function deleteDiscountGoods($discount_id, $sku_id)
    {
        $discount_info = model('promotion_discount')->getInfo([ [ 'discount_id', '=', $discount_id ] ], 'status');
        if (!empty($discount_info)) {
    ...
    {
        $info = model('promotion_discount')->getInfo([ [ 'discount_id', '=', $discount_id ] ], 'discount_id, site_id, discount_name, status, remark, start_time, end_time, create_time, modify_time');
    ...
    {
        $info = model('promotion_discount')->getInfo([ [ 'discount_id', '=', $discount_id ] ], 'goods_id,discount_id, site_id, discount_name, status, remark, start_time, end_time, create_time, modify_time');
